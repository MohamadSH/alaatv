...
class CreateMajorMajorTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('major_major', function (Blueprint $table) {
            ...
            $table->unsignedInteger('relationtype_id')->comment("نوع رابطه ی این دو رشته با یکدیگر");
            $table->string('majorCode')->nullable()->comment("کد ردیف رشته در دفترچه");
            $table->primary(['major1_id','major2_id' , 'relationtype_id']);
