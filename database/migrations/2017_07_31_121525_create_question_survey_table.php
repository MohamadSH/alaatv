...
class CreateQuestionSurveyTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('question_survey', function (Blueprint $table) {
            ...
            $table->integer("order")->default(0)->comment("ترتیب قرار گرفتن پرسش در مصاحبه");
            $table->tinyInteger("enable")->default(1)->comment("فعال یا غیر فعال بودن پرسش در مصاحبه");
            $table->text("description")->nullable()->comment("توضیح تکمیلی پرسش برای مصاحبه مورد نظر");
