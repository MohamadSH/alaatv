    ...
    public function up()
    {
        Schema::create('orderproduct_userbon', function (Blueprint $table) {
            $table->unsignedInteger('orderproduct_id')
                  ->comment("آی دی آیتم سبدی که بن برای آن استفاده شده");
            $table->unsignedInteger('userbon_id')
                  ->comment("آی دی بن استفاده شده برای این آیتم سبد");
            $table->integer('usageNumber')
                  ->default(0)
                  ->comment("تعداد استفاده شده از بن مشخص شده برای این آیتم سبد");
