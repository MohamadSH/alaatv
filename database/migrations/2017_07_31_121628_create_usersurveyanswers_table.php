    ...
    public function up()
    {
        Schema::create('usersurveyanswers', function (Blueprint $table) {
            ...
            $table->unsignedInteger("user_id")
                  ->comment("آی دی مشخص کننده کاربر پاسخ دهنده");
            $table->unsignedInteger("question_id")
                  ->comment("آی دی مشخص کننده پرسش مربرط به پاسخ");
            $table->unsignedInteger("survey_id")
                  ->comment("آی دی مشخص کننده مصاحبه مربوط به پاسخ");
            $table->unsignedInteger("event_id")
                  ->comment("آی دی مشخص کننده رخداد مربرط به پاسخ");
            $table->text("answer")
                  ->nullable()
                  ->comment("پاسخ کاربر");
            $table->timestamps();
