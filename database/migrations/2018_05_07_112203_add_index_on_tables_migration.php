...
class AddIndexOnTablesMigration extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('educationalcontents', function (Blueprint $table) use ($conn, $dbSchemaManager) {
            if (!$dbSchemaManager->listTableDetails('educationalcontents')
                                 ->hasIndex('educationalcontents_created_at_index'))
                $table->index('created_at');
        });
        Schema::table('contentset_educationalcontent', function (Blueprint $table) use ($conn, $dbSchemaManager) {
            if (!$dbSchemaManager->listTableDetails('contentset_educationalcontent')
                                 ->hasIndex('contentset_educationalcontent_order_index'))
                $table->index('order');
        });
