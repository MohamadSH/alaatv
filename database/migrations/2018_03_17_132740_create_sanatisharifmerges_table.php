...
class CreateSanatisharifmergesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sanatisharifmerges', function (Blueprint $table) {
            ...
            $table->tinyInteger('videoTransferred')->default(0)->comment("فیلم به آلاء منتقل شده یا خیر؟");
            ...
            $table->tinyInteger('pamphletTransferred')->default(0)->comment("جزوه به آلاء منتقل شده یا خیر؟");
            ...
            $table->tinyInteger('lessonTransferred')->default(0)->comment("درس به آلاء منتقل شده یا خیر؟");
            ...
            $table->tinyInteger('departmentTransferred')->default(0)->comment("مقطع به آلاء منتقل شده یا خیر؟");
            ...
            $table->tinyInteger('departmentlessonTransferred')->default(0)->comment("درس دپارتمان به آلاء منتقل شده یا خیر؟");
