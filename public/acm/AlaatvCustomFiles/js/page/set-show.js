var loadItems = function () {
    ...
    function getVideoItem(data) {
        ...
        return '' +
            '<div class="m-widget5__item set_video_item" data-section-id="' + data.section.id + '" data-section-name="' + data.section.name + '" data-item-order="' + data.order + '">\n' +
            '    <div class="m-widget5__content">\n' +
            '        <a href="' + data.link + '" style="display: inherit">\n' +
            '            <div class="m-widget5__pic  a--full-width" style="display: contents" >\n' +
            '                <img class="img-fluid a--full-width lazy-image" width="453" height="254"  src="https://cdn.alaatv.com/loder.jpg?w=1&h=1" data-src="' + data.photo + '" alt="' + data.name + '" data-container="body" data-toggle="m-tooltip" data-placement="top" title="دانلود یا تماشا فیلم">\n' +
            '            </div>\n' +
            '        </a>\n' +
            ...
            '                \n' + badge +
            '                <span>|</span>\n' +
            '                <span class="m-widget5__info-date m--font-info">آخرین به روز رسانی: ' + data.updatedAtJalali + '</span>\n' +
            '                <span>| آلاء</span>\n' +
            '            </div>\n' +
            ...
            '    <div class="m-widget5__content">\n' +
            '        <div>\n' +
            '            <button type="button" class="btn m-btn--pill  btn-primary btn-block"  onclick="window.location = \'' + data.link + '\';" data-container="body" data-toggle="m-tooltip" data-placement="top" title="دانلود یا تماشا فیلم"> <i class="fa fa-eye"></i> / <i class="fa fa-play"></i> </button>\n' +
            '        </div>\n' +
            '    </div>\n' +
            '</div>';
    }
    ...
    function getPamphletsItem(data) {
        return '' +
            '\n' +
            '<div class="m-widget4__item set_pamphlet_item" data-section-id="' + data.section.id + '" data-section-name="' + data.section.name + '" data-item-order="' + data.order + '">\n' +
            ...
            '                <a href="' + data.link + '" class="m-link" title="' + data.name + '">\n' +
            '                    ' + data.name + '\n' +
            '                </a>\n' +
            '            </span>\n' +
            '    </div>\n' +
            '    <div class="m-widget4__ext">\n' +
            '        <a href="' + data.link + '" class="m-widget4__icon" title="' + data.name + '">\n' +
