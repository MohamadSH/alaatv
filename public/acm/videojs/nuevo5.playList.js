...
videojs.IS_NATIVE_ANDROID && (videojs.options.hls.overrideNative = !0, videojs.options.html5.nativeAudioTracks = !1, videojs.options.html5.nativeTextTracks = !1), videojs.options.controlBar = {
    volumePanel: {
        inline: !1,
        vertical: !0
    },
...
vjs_hasClass = function (e, t) {
    ...
    var e = document.location.hostname.toLowerCase(), t = window.location.hostname.toLowerCase(),
        s = ["zbp.yrirqbirha", "gfbuynpby", "rupnp"], i = null;
    i = void 0 === window.videojs && "function" == typeof require ? require("video.js") : window.videojs, function (i, c) {
        ...
        (c = void 0 === i.videojs && "function" == typeof require ? require("video.js") : i.videojs).registerPlugin("nuevo", function (u) {
            ...
            function B() {
                ...
                var n = r(f, ".vjs-settings-div"), d = r(f, ".vjs-menu-speed"), c = r(f, ".vjs-zoom-menu"),
                    u = r(f, ".vjs-settings-home"), v = r(f, ".vjs-menu-quality");
                if (d) {
            ...
            function D() {
                ...
                if (r(f, ".rel-block")) {
                    ...
                    if (d.style.top = i / 2 - h * v / 2 + "px", d.style.left = s / 2 - n / 2 + "px", 1 != c.browser.TOUCH_ENABLED) {
                        var A = r(f, ".vjs-arrow-prev"), x = r(f, ".vjs-arrow-next"),
                            k = parseInt(r(f, ".vjs-prev").offsetWidth + 5);
            ...
            function q() {
                var e = r(f, ".vjs-menu-speed"), t = r(f, ".vjs-zoom-menu"), s = r(f, ".vjs-menu-quality"),
                    i = r(f, ".vjs-settings-div"), n = r(f, ".vjs-control-bar");
                ...
                if (l(d, "vjs-hidden"), o(d, "vjs-invisible"), h.cogMenu = {
                    ...
                    var c = d.getBoundingClientRect(),
                        u = (f.getBoundingClientRect().bottom, c.bottom, r(f, ".vjs-qua-list"));
                    h.qualityMenu = {
                        width: s.offsetWidth,
                        height: s.offsetHeight
                    }, o(u, "vjs-2-column"), h.qualityMenu2 = {
                        width: s.offsetWidth,
                        height: s.offsetHeight
            ...
            if (p.contextMenu) {
                ...
                "" == p.contextText ? (
                    p.contextText = "آموزش مجازی آلاء",
                        ...
                        Q()
                ) : "" != p.contextIcon && ((K = d("img")).src = p.contextIcon, K.onload = function () {
            ...
            v.ready(function () {
                ...
                if (1 == H) {
                    ...
                    v.resetNuevo = function (e) {
                        ...
                        if (s.length > 1) {
                            ...
                            if (j >= p.minResolution) {
                                ...
                                var b, A = new Array, k = new Array, T = new Array, w = "", C = "", L = 0,
                                    M = (h = 0, 0), N = 0, z = 0, H = !1, E = "MediaSource" in i;
                                ...
                                if (z > 1) {
                                    ...
                                    for (q(), p.menutouch = !1, L = 0; L < $.length; L++) {
                                        ...
                                        var ie = function (e) {
                                            ...
                                            v.trigger("resolutionchange", {
                                                label: W[i].label,
                                                res: W[i].res
                                            }), o(r(x, ".vjs-back-res"), "vjs-hidden"), ne(n)
                                        };
                        ...
                        E = "MediaSource" in i, t = ["iPad", "iPhone", "iPod"].indexOf(navigator.platform) >= 0, this.on("loadeddata", function () {
                            ...
                            if (E && 1 != t) try {
                                ...
                                var c = v.dash.mediaPlayer.getBitrateInfoListFor("video"),
                                    h = v.dash.mediaPlayer.getQualityFor("video"), f = 0;
                                ...
                                if (I.length < 2) P(); else {
                                    ...
                                    for (O("auto", "Auto"), B(), p.menutouch = !1, q(), m = 0; m < K.length; m++) {
                                        ...
                                        var Z = function (t) {
                                            ...
                                            var d = t.target, u = d.getAttribute("data-id"),
                                                h = d.getAttribute("data-res"), p = d.getAttribute("data-bit");
                                            if (r(x, ".vjs-quality-button .vjs-menu").style.display = "none", o(r(x, ".vjs-back-res"), "vjs-hidden"), "dash" == e) {
                                                "Autores" == u || "Autores_full" == u ? (v.dash.mediaPlayer.setAutoSwitchQualityFor("video", !0), O("auto", "Auto"), v.trigger("resolutionchange", {
                                                    ...
                                                    label: h + "p",
                                                    res: h
                                                })) : p > 0 && (O(h, p + " kbps"), v.trigger("resolutionchange", {
                                                    label: h + " kB",
                                                    res: h
                                                })));
                                                var f = v.currentTime();
                    ...
                    v.reconnect = function () {
                        ...
                        p.playlistRepeat && v.playlist.repeat(!0),
                            function () {
                            if (!((f = v.playlist.list()).length < 2) || v.playlist.list().length === 0) {
                                ...
                                if (v.playlist.repeat(), 1 != p.playlist) {
                                    ...
                                    if (p.playlistUI) {
                                        ...
                                        var n = d("div");
                                        n.className = "vjs-head", n.innerHTML = "<span>"+ v.localize('PLAYLIST') +"</span>";
                                        var u = d("div");
                                        ...
                                        for (m = 0; m < f.length; m++) {
                                            ...
                                            if(typeof f[m].renderUI === 'function') {
                                                f[m].renderUI(f[m], j);
                                            } else {
                                                var y = d("div");
                                            ...
                                            j.onclick = function (e) {
                                                if(typeof f[m].onclick === 'function') {
                                                    f[m].onclick(f[m], e)
                                                } else {
                                                    e.stopPropagation();
                                                    w(e);
                                            ...
                                            if(typeof f[m].truncateTitle !== 'undefined' && f[m].truncateTitle === true) {
                                                for (
                                                    ; b.offsetHeight > 48;
                                                ) {
                                                    b.textContent = b.textContent.replace(/\W*\s(\S)*$/, "...")
                                                }
                                            } else if(typeof f[m].truncateTitle === 'function') {
                                                f[m].truncateTitle(f[m], j);
                                            }
                        ...
                        capture: !0,
                        passive: !0
                    }), r(x, ".vjs-progress-holder").addEventListener("touchend", function (e) {
                        e.preventDefault(), p.seeking = !1
                    }, {
                        capture: !0,
                        passive: !0
                    }), r(x, ".vjs-progress-holder").addEventListener("mouseup", function (e) {
                        e.preventDefault(), p.seeking = !1
                            ...
                            l.src = p.slideImage, l.onload = function () {
                                ...
                                "horizontal" != p.slideType && (l = t / p.slideHeight), r(x, ".vjs-progress-holder").onmousemove = function (e) {
                                    r(x, ".vjs-progress-slide") && function (e) {
                                        parseInt(v.duration());
                                        var t = r(x, ".vjs-progress-holder").offsetWidth,
                                            o = parseFloat(r(x, ".vjs-mouse-display").style.left);
                                        if ("auto" == o) {
                                            var d = parseFloat(r(x, ".vjs-mouse-display").style.left);
                                            o = parseInt(d)
                                        }
                                        var u = Number(o) / Number(t), h = c.options.skinname,
                                            f = r(r(x, ".vjs-mouse-display"), ".vjs-time-tooltip").innerHTML;
                                        if ("treso" == c.options.skinname) {
                            ...
                            if (p.zoomMenu) {
                                ...
                                function be(e) {
                                    if (e.preventDefault(), isDown) {
                                        ...
                                        var t = r(x, ".vjs-tech"), s = mousePosition.x + offset[0],
                                            i = mousePosition.y + offset[1], n = x.offsetWidth / 2 * (b - 1),
                                            a = x.offsetHeight / 2 * (b - 1);
    ...
    function t(t, s) {
        var a, c, u, v, h, p, f, m, g = new Array, j = !1, y = !1, b = new Array, A = !1, x = !1, k = !1, T = 0, w = 0,
            I = 0, _ = !1, C = !1, L = !1, M = !1, N = !1, z = (new Array, t.$(".vjs-tech"));
            ...
            if (g.length > 0) {
                ...
                t.on("loadeddata", function () {
                    ...
                    if (g.length > 1 && (g = n(g, "offset")), g.length > 0) {
                        ...
                        u.onclick = function () {
                            u.className = "roll-blocker vjs-hidden", null != f.id && t.trigger("midroll", {
                                id: f.id,
                                action: "click"
                            })
                        ...
                        C ? (v.on("ended", function () {
                            ...
                            A && (clearTimeout(T), N = !1, 1 != y && (f.id && t.trigger("vroll", {
                                id: f.id,
                                action: "play"
                            }), y = !0))
