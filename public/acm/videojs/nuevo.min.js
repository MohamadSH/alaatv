...
document.body.removeChild(vjs_skin), "ontouchstart" in document.documentElement || (document.documentElement.className += " no-touch"), nv = null, vjs_hasClass = function (e, s) {
    ...
    for (var t = 0, n = s.length; t < n; t++) if (s[t] === e) return t;
    return -1
}, function () {
    var e, s = !0, t = document.location.hostname.toLowerCase(), n = window.location.hostname.toLowerCase(),
        i = "moc.vtaala", o = "tsohlacol";
    o = o.split("").reverse().join(""), i = i.split("").reverse().join(""), t.indexOf(i) < 0 && t.indexOf(o) < 0 && n.indexOf(i) < 0 && (s = !1), e = null, e = void 0 === window.videojs && "function" == typeof require ? require("video.js") : window.videojs, function (e, t) {
        var n = {}, i, i = function (n) {
            var i, o, a, l, d, r, v, c, u, j, p, h, f, m, _ = {
                    ...
                    overlay: "",
                    overlay_ready: !1
                }, g = "deretsiger ton tcudorP", y = this, b = this.tech_, C = new Array, k = t.mergeOptions(_, n),
                w = y.el(), T = 0, E = 0, x = 0;
            ...
            function L() {
                ...
                if (T < 480) vjs_addClass(vjs_find(w, ".vjs-grid"), "vjs-abs-hidden"), 3 == k.newstate && "related" == k.endAction && vjs_removeClass(o, "vjs-hidden"); else if (vjs_addClass(o, "vjs-hidden"), vjs_removeClass(vjs_find(w, ".vjs-grid"), "vjs-abs-hidden"), s = .8, t = 800, (e = k.related.length) < 5 && (s = .7, t = 700), vjs_find(w, ".rel-block")) {
            ...
            function B() {
                var e, s = vjs_find(w, ".vjs-menu-speed"), t = vjs_find(w, ".vjs-zoom-menu"),
                    n = vjs_find(w, ".vjs-settings-div"), i = vjs_find(w, ".vjs-control-bar");
            ...
            if (i = vjs_find(w, ".vjs-big-play-button"), o = document.createElement("div"), o.className = "vjs-replay-button vjs-hidden", w.appendChild(o), o.innerHTML = y.localize("Replay"), o.onclick = function (e) {
                ...
                if ("", u > 1) {
                    ...
                    function L(s) {
                        var t, n = y.currentTime(), i = y.paused();
                        s.type;
            ...
            1 != k.errordisplay && vjs_addClass(vjs_find(w, ".vjs-error-display"), "vjs-abs-hidden"), 1 != k.timetooltip && (f = vjs_find(w, ".vjs-play-progress"), m = vjs_find(f, ".vjs-time-tooltip"), vjs_addClass(m, "vjs-abs-hidden")), 1 != k.mousedisplay && vjs_addClass(vjs_find(w, ".vjs-mouse-display"), "vjs-abs-hidden vjs-out"), y.ready(function () {
                var s, n, a, l, d, r, j, p, h, f, m, _, g, b, w, I, D, W, R, F, U, Y, Q, K, Z, X, $, G, V, J, ee, se,
                    te, ne, ie, oe, ae, le, de, re;
                ...
                k.isAddon = !1, k.newstate = 4, k.oldstate = 4, k.events = {}, s = y.id(), n = y.el(), a = !1, l = y.$(".vjs-tech"), d = !1, r = this, j = !1, p = !1, h = new Array, f = new Array, m = new Array, _ = "height", g = new Array, b = new Array, I = !1, D = vjs_touch_device(), 1 == y.options_.sources.length ? (W = checkUndefined(W), R = W.type, -1 !== R.indexOf("dash") && (y.reset(), y.src(W))) : (W = checkUndefined(W), R = checkUndefined(W.type), F = "MediaSource" in e, -1 !== R.indexOf("dash") && F && (y.reset(), y.src(W))), k.logocontrolbar && (U = vjs_El("img"), Y = !1, U.src = k.logocontrolbar, U.onload = function () {
                    var e, s;
                    ...
                    (f.length > 1 || m.length > 1) && (z(), T = f.length, j = !0, p = !0, m > f ? (_ = "bandwidth", h = m) : (_ = "height", h = f), ve(_, w))
                }), e.onclick = function (e) {
                    var s, t;
                    ...
                    if (k.newstate = 3, k.resume && "" != k.video_id && A("vjs_resume", k.video_id + ",0"), "" != k.endAction) if ("share" == k.endAction && k.shareMenu) vjs_addClass(vjs_find(n, ".vjs-menu-settings"), "vjs-hidden"), vjs_removeClass(vjs_find(n, ".vjs-sharing-overlay"), "vjs-hidden"), vjs_addClass(i, "vjs-hidden"), k.isAddon = !0; else if ("related" == k.endAction && k.relatedMenu && k.related.length > 1) {
                    ...
                    } else vjs_addClass(i, "vjs-hidden"), vjs_removeClass(o, "vjs-hidden"); else vjs_addClass(i, "vjs-hidden"), vjs_removeClass(o, "vjs-hidden")
                ...
                k.newstate = 4, ce(n, "STATE"), y.on("useractive", function () {
                    ...
                    k.resume && "" != k.video_id && (localStorage && localStorage.vjs_resume && 2 == (e = localStorage.vjs_resume.split(",")).length && e[0] == k.video_id && Number(e[1]) > 3 && (e[1], y.currentTime(e[1])), A("vjs_resume", k.video_id + ",0")), vjs_find(n, "video").controls = !1, k.limit > 0 && ("" != k.limiturl || "" != k.shareUrl) && (s = !1, y.on("timeupdate", function () {
                        ...
                        var e, s, i, o, a = vjs_find(n, ".vjs-play-progress"), c = vjs_find(a, ".vjs-time-tooltip");
                    ...
                    var s, o, l, d, v, c, u, j, p, h, f, m, _, g, b, C, w, T, z, I, N, A, W, R, F, U, Y, Q, K, Z, X, $,
                        G, V, J, ee, se, te, ne, ie, oe, ae, le, de, re, ve, ce;
                    if (!a) {
                        if (a = !0, localStorage && localStorage.volume && y.volume(localStorage.volume), vjs_addClass(vjs_find(n, ".vjs-poster"), "vjs-hidden"), s = "", o = "", l = !1, d = !1, k.shareMenu && (s = s + '<li class="vjs-settings-item vjs-share-button">' + y.localize("Share") + '<span class="vjs-share-icon"></span></li>'), k.relatedMenu && k.related.length > 1 && (s = s + '<li class="vjs-settings-item vjs-related-button">' + y.localize("Related") + '<span class="vjs-related-icon"></span></li>'), k.zoomMenu && (s = s + '<li class="vjs-settings-item vjs-extend-zoom vjs-menu-forward">' + y.localize("Zoom") + '<span class="zoom-label">100%</span></li>', (d = vjs_El("div")).className = "vjs-submenu vjs-zoom-menu vjs-hidden", d.innerHTML = '<div class="vjs-settings-back vjs-zoom-return"><span>' + y.localize("Zoom") + '</span></div><div class="vjs-zoom-slider"><div class="vjs-zoom-back"></div><div class="vjs-zoom-level"></div></div><div class="vjs-zoom-reset">' + y.localize("ZOOM RESET") + '</div>'), k.rateMenu && (s = s + '<li class="vjs-settings-item vjs-extend-speed vjs-menu-forward">' + y.localize("Speed") + "<span>" + y.localize("Normal") + "</span></li>", (l = vjs_El("div")).className = "vjs-submenu vjs-menu-speed vjs-hidden", l.innerHTML = '<ul class="vjs-menu-content"><li class="vjs-settings-back">' + y.localize("Speed") + '</li><li class="vjs-speed">0.5x</li><li class="vjs-speed vjs-checked">1x</li><li class="vjs-speed">1.5x</li><li class="vjs-speed">2x</li></ul>'), v = vjs_find(n, ".vjs-settings-list"), "" != s) for (s += o, v.innerHTML = s + v.innerHTML, l && vjs_find(n, ".vjs-settings-div").appendChild(l), d && vjs_find(n, ".vjs-settings-div").appendChild(d), vjs_removeClass(vjs_find(n, ".vjs-cog-menu-button"), "vjs-hidden"), M(), B(), c = function (e) {
                            var s, t, i, o;
                        ...
                        if (k.zoomMenu) {
                            function je(e) {
                                var s, i, o, a = vjs_find(n, ".vjs-zoom-slider"), l = !1;
                            ...
                            function pe() {
                                var e = vjs_find(n, ".vjs-tech"), s = parseInt(e.offsetTop), t = parseInt(e.offsetLeft),
                                    i = de;
                            ...
                            ie = !1, oe = !1, de = "", re = 1, k.zoomReset && (this.zoom_panel = vjs_El("div"), this.zoom_panel.className = "vjs-zoom-parent vjs-zoom-hidden", this.zoom_button = vjs_El("div"), this.zoom_button.className = "vjs-reset-zoom", this.zoom_button.innerHTML = y.localize("ZOOM RESET"), this.zoom_panel.appendChild(this.zoom_button), 1 != D && (this.zoom_info = vjs_El("div"), this.zoom_info.className = "vjs-reset-info", this.zoom_menu = vjs_El("div"), this.zoom_menu.className = "vjs-reset-menu", ve = (ve = (ve = (ve = (ve = (ve = '<div class="vjs-reset-header">' + y.localize("Keyboard control") + "</div>") + '<div><span class="s1">+/-</span>' + y.localize("zoom area") + "</div>") + '<div><span class="s1">&larr;</span>' + y.localize("scroll left") + "</div>") + '<div><span class="s1">&rarr;</span>' + y.localize("scroll right") + "</div>") + '<div><span class="s1">&uarr;</span>' + y.localize("scroll up") + "</div>") + '<div><span class="s1">&darr;</span>' + y.localize("scroll down") + "</div>", this.zoom_menu.innerHTML = ve, this.zoom_panel.appendChild(this.zoom_info), this.zoom_info.appendChild(this.zoom_menu)), vjs_find(n, ".vjs-control-bar").appendChild(this.zoom_panel)), (ce = y.el()).hasAttribute("tabIndex") || ce.setAttribute("tabIndex", "-1"), ce.style.outline = "none", document.addEventListener("keydown", function (e) {
                                ...
                                if ((107 == i || 109 == i) && 1 == a) {
                                    ...
                                    oe = !0, clearInterval(le), document.addEventListener("keyup", function e() {
                                        ...
                                        107 == i && (re += .1), 109 == i && (re -= .1), re > 5 && (re = 5), re < 1 && (re = 1), function (e) {
                                            y.id();
    ...
    "use strict";
    var t,
        n = {src: "", id: void 0, href: "", target: "_blank", allowSkip: !0, skipTime: 0, repeatAd: !1, adsOptions: {}};
    t = function (t) {
        var i, o = s.mergeOptions(n, t), a = this, l = !1;
        a.ready(function () {
            ...
            if ("" != o.src) {
                (s = vjs_El("div")).className = "vjs-preroll vjs-hidden", t = vjs_El("video"), s.appendChild(t), o.src.src ? t.src = o.src.src : t.src = o.src, o.src.type && (t.type = o.src.type), (n = vjs_El("a")).className = "preroll-blocker", n.href = o.href, n.target = "_blank", n.onclick = function () {
                    null != o.id ? player_.trigger("adclick", {id: o.id}) : a.trigger("adclick")
                ...
                i = setInterval(function () {
                    var e, s, n, i, l, r, c;
                    if (!t.paused && (s = t.duration - (e = (e = t.currentTime) > 0 ? e : 0), n = Math.floor(s / 60), (i = Math.floor(s % 60)).toString().length < 2 && (i = "0" + i), vjs_find(d, ".pre-countdown").innerHTML = a.localize("Advertisement") + " " + n + ":" + i, o.skipTime > 0)) if (r = "", (l = Math.ceil(o.skipTime - e)) > 0) {
                        c = "";
                        try {
