...
$(document).on("click", "#assignment-portlet .reload", function (){
    $("#assignment-portlet-loading").removeClass("hidden");
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#assignment-portlet-loading").addClass("hidden");
        },
        error: function (result) {
            console.log(result);
            console.log(result.responseText);
...
$(document).on("click", "#consultation-portlet .reload", function (){
    $("#consultation-portlet-loading").removeClass("hidden");
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#consultation-portlet-loading").addClass("hidden");
        },
        error: function (result) {
            // console.log(result);
            // console.log(result.responseText);
...
$(document).on("click", "#question-portlet .reload", function (){
    $("#question-portlet-loading").removeClass("hidden");
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#question-portlet-loading").addClass("hidden");
        },
        error: function (result) {
            console.log(result);
            console.log(result.responseText);
...
$(document).on("click", "#article-portlet .reload", function (){
    $("#article-portlet-loading").removeClass("hidden");
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#article-portlet-loading").addClass("hidden");
        },
        error: function (result) {
            console.log(result);
            console.log(result.responseText);
...
$(document).on("click", "#articlecategory-portlet .reload", function (){
    $("#articlecategory-portlet-loading").removeClass("hidden");
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#articlecategory-portlet-loading").addClass("hidden");
        },
        error: function (result) {
            console.log(result);
            console.log(result.responseText);
...
$(document).on("click", "#mbtiAnswer-portlet .reload", function (){
    $("#mbtiAnswer-portlet-loading").removeClass("hidden");
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#mbtiAnswer-portlet-loading").addClass("hidden");
        },
        error: function (result) {
            console.log(result);
            console.log(result.responseText);
