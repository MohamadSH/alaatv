...
$(document).on("click", "#report-portlet .reload", function (){
    $("#report-portlet-loading").removeClass("hidden");
    ...
    reportAjax = $.ajax({
        ...
        statusCode: {
            200:function (response) {
                ...
                $("#report-portlet-loading").addClass("hidden");
...
$(document).on("click", "#bookSellingReport-portlet .reload", function (){
    $("#bookSellingReport-portlet-loading").removeClass("hidden");
    ...
    bookSellingReportAjax = $.ajax({
        ...
        statusCode: {
            200:function (response) {
                ...
                $("#bookSellingReport-portlet-loading").addClass("hidden");
                $(".filter").each(function () {
                    if($(this).val() !== "" && $(this).val() !== null) {
                        $(this).addClass("font-red");
                    }
