...
var mapGeoJSON = {
  ...
  "features": [{
    ...
    "geometry": {
      "type": "Polygon",
      "coordinates": [[[1500, 3000], [1500, 1], [-1000, -1], [-1000, 3000]]]
    }
  }, {
    "type": "Feature",
    "id": "IR.5428",
...
(function (Q, K) {
  "object" === (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? (K["default"] = K, module.exports = Q.document ? K(Q) : K) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function () {
    return K(Q);
  ...
  K(G, "parts/Utilities.js", [G["parts/Globals.js"]], function (a) {
    ...
    a.Fx.prototype = {
      ...
      run: function run(k, e, q) {
        ...
        k !== e || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date(), this.start = k, this.end = e, this.unit = q, this.now = this.start, this.pos = 0, v.elem = this.elem, v.prop = this.prop, v() && 1 === a.timers.push(v) && p(h)) : (delete u.curAnim[this.prop], u.complete && 0 === Object.keys(u.curAnim).length && u.complete.call(this.elem));
      },
      step: function step(k) {
        ...
        u.attr && !u.element ? k = !1 : k || e >= p + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), q = h[this.prop] = !0, a.objectEach(h, function (a) {
          !0 !== a && (q = !1);
        }), q && v && v.call(u), k = !1) : (this.pos = t.easing((e - this.startTime) / p), this.now = this.start + (this.end - this.start) * this.pos, this.update(), k = !0);
        return k;
      },
      initPath: function initPath(k, e, q) {
        function t(a) {
          var b, g;
        ...
        function v(a, c) {
          for (var d = (g - a.length) / b; 0 < d && d--;) {
            l = a.slice().splice(a.length / z - b, b * z), l[0] = c[g - b - d * b], m && (l[b - 6] = l[b - 2], l[b - 5] = l[b - 1]), [].splice.apply(a, [a.length / z, 0].concat(l)), w && d--;
          }
        }
    ...
    a.isObject = function (k, e) {
      return !!k && "object" === _typeof(k) && (!e || !a.isArray(k));
    };
    ...
    a.numberFormat = function (k, e, q, t) {
      ...
      h = (Math.abs(d[1] ? d[0] : k) + Math.pow(10, -Math.max(e, v) - 1)).toFixed(e);
      v = String(a.pInt(h));
    ...
    a.getStyle = function (k, e, q) {
      if ("width" === e) return Math.max(0, Math.min(k.offsetWidth, k.scrollWidth, k.getBoundingClientRect && "none" === a.getStyle(k, "transform", !1) ? Math.floor(k.getBoundingClientRect().width) : Infinity) - a.getStyle(k, "padding-left") - a.getStyle(k, "padding-right"));
    ...
    a.objectEach = function (a, e, q) {
      for (var k in a) {
        a.hasOwnProperty(k) && e.call(q || a[k], a[k], k, a);
      }
    };
    ...
    a.addEvent = function (k, e, q, t) {
      var u,
          v = k.addEventListener || a.addEventListenerPolyfill;
    ...
    a.removeEvent = function (k, e, q) {
      ...
      ["protoEvents", "hcEvents"].forEach(function (a) {
        var d = k[a];
        d && (e ? (v = d[e] || [], q ? (p = v.indexOf(q), -1 < p && (v.splice(p, 1), d[e] = v), t(e, q)) : (u(d), d[e] = [])) : (u(d), k[a] = {}));
      });
    };
    ...
    a.fireEvent = function (k, e, q, t) {
      ...
      I.createEvent && (k.dispatchEvent || k.fireEvent) ? (u = I.createEvent("Events"), u.initEvent(e, !0, !0), a.extend(u, q), k.dispatchEvent ? k.dispatchEvent(u) : k.fireEvent(e, u)) : ["protoEvents", "hcEvents"].forEach(function (m) {
        if (k[m]) for (v = k[m][e] || [], p = v.length, q.target || a.extend(q, {
          ...
          (d = v[h]) && !1 === d.call(k, q) && q.preventDefault();
        }
      });
  ...
  K(G, "parts/Color.js", [G["parts/Globals.js"]], function (a) {
    ...
    a.Color.prototype = {
      ...
      init: function init(k) {
        ...
        });else if (k && k.charAt && "#" === k.charAt() && (e = k.length, k = parseInt(k.substr(1), 16), 7 === e ? q = [(k & 16711680) >> 16, (k & 65280) >> 8, k & 255, 1] : 4 === e && (q = [(k & 3840) >> 4 | (k & 3840) >> 8, (k & 240) >> 4 | k & 240, (k & 15) << 4 | k & 15, 1])), !q) for (t = this.parsers.length; t-- && !q;) {
      ...
      tweenTo: function tweenTo(a, e) {
        var k = this.rgba,
            t = a.rgba;
        t.length && k && k.length ? (a = 1 !== t[3] || 1 !== k[3], e = (a ? "rgba(" : "rgb(") + Math.round(t[0] + (k[0] - t[0]) * (1 - e)) + "," + Math.round(t[1] + (k[1] - t[1]) * (1 - e)) + "," + Math.round(t[2] + (k[2] - t[2]) * (1 - e)) + (a ? "," + (t[3] + (k[3] - t[3]) * (1 - e)) : "") + ")") : e = a.input || "none";
        return e;
      }
    };
  ...
  K(G, "parts/SvgRenderer.js", [G["parts/Globals.js"]], function (a) {
    ...
    b(C.prototype, {
      ...
      removeTextOutline: function removeTextOutline(a) {
        for (var y = a.length, f; y--;) {
          f = a[y], "highcharts-text-outline" === f.getAttribute("class") && g(a, this.element.removeChild(f));
        }
      },
      ...
      attr: function attr(y, f, b, c) {
        ...
        "string" === typeof y ? l = (this[y + "Getter"] || this._defaultGetter).call(this, y, d) : (B(y, function (f, b) {
          ...
          n || (h = this[b + "Setter"] || this._defaultSetter, h.call(this, f, b, d), !this.styledMode && this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(b) && this.updateShadows(b, f, h));
      ...
      css: function css(a) {
        ...
        l && (y && (a = b(y, f)), a && (null === a.width || "auto" === a.width ? delete this.textWidth : "text" === c.nodeName.toLowerCase() && a.width && (r = this.textWidth = H(a.width))), this.styles = a, r && !M && this.renderer.forExport && delete a.width, c.namespaceURI === this.SVG_NS ? (g = function g(a, y) {
      ...
      shadow: function shadow(a, f, b) {
        ...
        if (!a) this.destroyShadows();else if (!this.shadows) {
          ...
          for (c = 1; c <= g; c++) {
            r = d.cloneNode(0), l = 2 * g + 1 - 2 * c, e(r, {
              stroke: a.color || "#000000",
              "stroke-opacity": n * c,
              "stroke-width": l,
              transform: "translate" + h,
              fill: "none"
            }), r.setAttribute("class", (r.getAttribute("class") || "") + " highcharts-shadow"), b && (e(r, "height", Math.max(e(r, "height") - l, 0)), r.cutHeight = l), f ? f.element.appendChild(r) : d.parentNode && d.parentNode.insertBefore(r, d), y.push(r);
          }
      ...
      setTextPath: function setTextPath(f, b) {
        ...
        if (f && b && b.enabled) {
          ...
          g || (this.textPathWrapper = g = this.renderer.createElement("textPath"), d = !0);
          l = g.element;
          (b = f.element.getAttribute("id")) || f.element.setAttribute("id", b = a.uniqueKey());
          if (h) for (f = y.getElementsByTagName("tspan"); f.length;) {
      ...
      zIndexSetter: function zIndexSetter(a, f) {
        ...
        if (r) {
          ...
          for (n = f.length - 1; 0 <= n && !l; n--) {
            if (y = f[n], r = y.getAttribute("data-z-index"), g = !p(r), y !== d) if (0 > a && g && !b && !n) c.insertBefore(d, f[n]), l = !0;else if (H(r) <= a || g && (!p(a) || 0 <= a)) c.insertBefore(d, f[n + 1] || null), l = !0;
          }
    ...
    C.prototype.translateXSetter = C.prototype.translateYSetter = C.prototype.rotationSetter = C.prototype.verticalAlignSetter = C.prototype.rotationOriginXSetter = C.prototype.rotationOriginYSetter = C.prototype.scaleXSetter = C.prototype.scaleYSetter = C.prototype.matrixSetter = function (a, f) {
      this[f] = a;
      this.doTransform = !0;
    };
    ...
    C.prototype["stroke-widthSetter"] = C.prototype.strokeSetter = function (a, f, b) {
      this[f] = a;
      this.stroke && this["stroke-width"] ? (C.prototype.fillSetter.call(this, this.stroke, "stroke", b), b.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0) : "stroke-width" === f && 0 === a && this.hasStroke && (b.removeAttribute("stroke"), this.hasStroke = !1);
    };
    ...
    b(I.prototype, {
      Element: C,
      SVG_NS: L,
      init: function init(a, f, b, c, r, d, l) {
        var y;
        ...
        this.setSize(f, b, !1);
        var g;
        w && a.getBoundingClientRect && (f = function f() {
          u(a, {
            left: 0,
            top: 0
          });
      ...
      truncate: function truncate(a, f, b, c, r, d, l) {
        var y = this,
            g = a.rotation,
            n,
            h = c ? 1 : 0,
        ...
        if (z = r + e > d) {
          for (; h <= L;) {
            w = Math.ceil((h + L) / 2), c && (n = l(c, w)), e = p(w, n && n.length - 1), h === L ? h = L + 1 : e > d ? L = w - 1 : h = w;
          }
      ...
      buildText: function buildText(a) {
        ...
        if (P !== a.textCache) {
          ...
          y || x || p || h || -1 !== r.indexOf(" ") ? (n && n.appendChild(f), y ? (r = b.styledMode ? r.replace(/<(b|strong)>/g, '\x3cspan class\x3d"highcharts-strong"\x3e').replace(/<(i|em)>/g, '\x3cspan class\x3d"highcharts-emphasized"\x3e') : r.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e'), r = r.replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g)) : r = [r], r = r.filter(function (a) {
            ...
            d.forEach(function (r) {
              if ("" !== r || 1 === d.length) {
                ...
                if (P = O(r, "style")) P = P.replace(/(;| |^)color([ :])/, "$1fill$2"), e(B, "style", P);
                ...
                if (" " !== r) {
                  ...
                  if (h) {
                    ...
                    E = 0;
                    var H = k(B);
                    if (p) g = b.truncate(a, B, r, void 0, 0, Math.max(0, h - parseInt(N || 12, 10)), function (a, f) {
                      return a.substring(0, f) + "\u2026";
                    });else if (x) for (; D.length;) {
                      D.length && !z && 0 < E && (B = m.createElementNS(L, "tspan"), e(B, {
                        dy: H,
                        x: l
          ...
          }), p && g && a.attr("title", J(a.textStr, ["\x26lt;", "\x26gt;"])), n && n.removeChild(f), x && a.applyTextOutline && a.applyTextOutline(x)) : f.appendChild(m.createTextNode(J(r)));
        }
      },
      ...
      button: function button(a, f, r, c, d, g, l, h, L, w) {
      ...
      rect: function rect(a, f, b, r, c, d) {
        c = J(a) ? a.r : c;
      ...
      image: function image(a, f, r, c, d, g) {
        var l = {
      ...
      symbol: function symbol(a, f, r, c, d, g) {
        var l = this,
            n,
            y = /^url\((.*?)\)$/,
            h = y.test(a),
            ...
            w = L && this.symbols[L],
            B = p(f) && w && w.call(this.symbols, Math.round(f), Math.round(r), c, d, g),
            x,
            e;
        w ? (n = this.path(B), l.styledMode || n.attr("fill", "none"), b(n, {
          ...
          width: c,
          height: d
        }), g && b(n, g)) : h && (x = a.match(y)[1], n = this.image(x), n.imgwidth = E(P[x] && P[x].width, g && g.width), n.imgheight = E(P[x] && P[x].height, g && g.height), e = function e() {
          n.attr({
            width: n.width,
            height: n.height
          });
          ...
          n[a + "Setter"] = function (a, f) {
            ...
            this[f] = a;
            p(r) && (g && "within" === g.backgroundSize && this.width && this.height && (r = Math.round(r * Math.min(this.width / this.imgwidth, this.height / this.imgheight))), this.element && this.element.setAttribute(f, r), this.alignByTranslate || (b[c] = ((this[f] || 0) - r) / 2, this.attr(b)));
          };
        }), p(f) && n.attr({
          x: f,
          y: r
      ...
      symbols: {
        circle: function circle(a, f, b, r) {
        ...
        square: function square(a, f, b, r) {
          return ["M", a, f, "L", a + b, f, a + b, f + r, a, f + r, "Z"];
        },
        triangle: function triangle(a, f, b, r) {
          return ["M", a + b / 2, f, "L", a + b, f + r, a, f + r, "Z"];
        },
        "triangle-down": function triangleDown(a, f, b, r) {
          return ["M", a, f, "L", a + b, f, a + b / 2, f + r, "Z"];
        },
        diamond: function diamond(a, f, b, r) {
          return ["M", a + b / 2, f, "L", a + b, f + r / 2, a + b / 2, f + r, a, f + r / 2, "Z"];
        },
        arc: function arc(a, f, b, r, c) {
          var d = c.start,
              g = c.r || b,
              l = c.r || r || b,
              n = c.end - .001;
        ...
        callout: function callout(a, f, b, r, c) {
          var d = Math.min(c && c.r || 0, b, r),
              g = d + 6,
              l = c && c.anchorX;
          c = c && c.anchorY;
          var n;
          ...
          l && l > b ? c > f + g && c < f + r - g ? n.splice(13, 3, "L", a + b, c - 6, a + b + 6, c, a + b, c + 6, a + b, f + r - d) : n.splice(13, 3, "L", a + b, r / 2, l, c, a + b, r / 2, a + b, f + r - d) : l && 0 > l ? c > f + g && c < f + r - g ? n.splice(33, 3, "L", a, c + 6, a - 6, c, a, c - 6, a, f + d) : n.splice(33, 3, "L", a, r / 2, l, c, a, r / 2, a, f + d) : c && c > r && l > a + g && l < a + b - g ? n.splice(23, 3, "L", l + 6, f + r, l, f + r + 6, l - 6, f + r, a + d, f + r) : c && 0 > c && l > a + g && l < a + b - g && n.splice(3, 3, "L", l - 6, f, l, f - 6, l + 6, f, b - d, f);
          return n;
        }
      },
      clipRect: function clipRect(f, b, r, c) {
        var d = a.uniqueKey() + "-",
      ...
      text: function text(a, f, b, r) {
        ...
        r || (a.xSetter = function (a, f, b) {
          ...
          for (g = 0; g < r.length; g++) {
            c = r[g], c.getAttribute(f) === d && c.setAttribute(f, a);
          }
      ...
      rotCorr: function rotCorr(a, f, b) {
        var r = a;
        f && b && (r = Math.max(r * Math.cos(f * h), 4));
        return {
          x: -a / 3 * Math.sin(f * h),
          y: r
        };
      },
      label: function label(r, c, d, g, l, h, L, w, m) {
        var y = this,
            B = y.styledMode,
        ...
        R = function R() {
          ...
          if (a !== e.x || f !== e.y) e.attr("x", a), e.hasBoxWidthChanged && (M = e.getBBox(!0), U()), void 0 !== f && e.attr("y", f);
          e.x = a;
          e.y = f;
        };
  ...
  K(G, "parts/Html.js", [G["parts/Globals.js"]], function (a) {
    ...
    e(h.prototype, {
      ...
      htmlUpdateTransform: function htmlUpdateTransform() {
        if (this.added) {
          ...
          if ("SPAN" === d.tagName) {
            ...
            E && (/[ \-]/.test(d.textContent || d.innerText) || "ellipsis" === d.style.textOverflow) ? (F(d, {
              width: x + "px",
              display: "block",
              whiteSpace: n || "normal"
      ...
      setSpanRotation: function setSpanRotation(a, d, l) {
        var b = {},
      ...
      getSpanCorrection: function getSpanCorrection(a, d, l) {
        this.xCorr = -a * l;
        this.yCorr = -d;
      }
    });
    ...
    a.Time.prototype = {
      ...
      update: function update(a) {
        ...
        (this.variableTimezone = !(e && !a.getTimezoneOffset && !a.timezone)) || this.timezoneOffset ? (this.get = function (a, h) {
          ...
          var m;
          if ("Milliseconds" === a || "Seconds" === a || "Minutes" === a && 0 === h.getTimezoneOffset() % 60) h["set" + a](d);else m = v.getTimezoneOffset(h), m = h.getTime() - m, h.setTime(m), h["setUTC" + a](d), a = v.getTimezoneOffset(h), m = h.getTime() + a, h.setTime(m);
      ...
      makeTime: function makeTime(e, q, v, p, h, d) {
        var m, b, g;
      ...
      dateFormat: function dateFormat(e, k, v) {
      ...
      getTimeTicks: function getTimeTicks(a, q, v, p) {
        var h = this,
            d = [],
            m,
            b = {},
        ...
        if (C(q)) {
          ...
          l >= e.second && h.set("Seconds", m, l >= e.minute ? 0 : c * Math.floor(h.get("Seconds", m) / c));
  ...
  K(G, "parts/Tick.js", [G["parts/Globals.js"]], function (a) {
    ...
    a.Tick.prototype = {
      ...
      handleOverflow: function handleOverflow(a) {
        ...
        n && (this.shortenLabel ? this.shortenLabel() : (x.width = Math.floor(n), (h.style || {}).textOverflow || (x.textOverflow = "ellipsis"), l.css(x)));
      },
      getPosition: function getPosition(e, p, h, d) {
        var m = this.axis,
            b = m.chart,
      ...
      getLabelPosition: function getLabelPosition(a, e, h, d, m, b, g, l) {
        var c = this.axis,
            w = c.transA,
            z = c.reversed,
            p = c.staggerLines,
      ...
      getMarkPath: function getMarkPath(a, e, h, d, m, b) {
        return b.crispLine(["M", a, e, "L", a + (m ? 0 : -h), e + (m ? h : 0)], d);
      },
      renderGridLine: function renderGridLine(a, e, h) {
        var d = this.axis,
            m = d.options,
            b = this.gridLine,
            g = {},
            ...
            A = m[p + "LineColor"],
            m = m[p + "LineDashStyle"];
        b || (d.chart.styledMode || (g.stroke = A, g["stroke-width"] = k, m && (g.dashstyle = m)), c || (g.zIndex = 1), a && (e = 0), this.gridLine = b = z.path().attr(g).addClass("highcharts-" + (c ? c + "-" : "") + "grid-line").add(d.gridGroup));
        if (b && (h = d.getPlotLinePath(l + w, b.strokeWidth() * h, a, "pass"))) b[a || this.isNew ? "attr" : "animate"]({
          d: h,
          opacity: e
        });
      },
      renderMark: function renderMark(a, e, h) {
        var d = this.axis,
            m = d.options,
            b = d.chart.renderer,
            g = this.type,
      ...
      renderLabel: function renderLabel(a, p, h, d) {
        var m = this.axis,
            b = m.horiz,
            g = m.options,
            l = this.label,
            ...
            k = a.x;
        a = a.y;
        l && e(k) && (l.xy = a = this.getLabelPosition(k, a, l, b, c, m, d, w), this.isFirst && !this.isLast && !t(g.showFirstLabel, 1) || this.isLast && !this.isFirst && !t(g.showLastLabel, 1) ? z = !1 : !b || c.step || c.rotation || p || 0 === h || this.handleOverflow(a), w && d % w && (z = !1), z && e(a.y) ? (a.opacity = h, l[this.isNewLabel ? "attr" : "animate"](a), this.isNewLabel = !1) : (l.attr("y", -9999), this.isNewLabel = !0));
      },
      render: function render(e, p, h) {
        var d = this.axis,
            m = d.horiz,
            b = this.pos,
    ...
    a.extend(H.prototype, {
      ...
      defaultLabelFormatter: function defaultLabelFormatter() {
        var f = this.axis,
            ...
            e = n && n.length,
            h,
            x = f.options.labels.format,
            f = f.isLog ? Math.abs(b) : f.tickInterval;
        if (x) h = m(x, this, c);else if (d) h = b;else if (l) h = c.dateFormat(l, b);else if (e && 1E3 <= f) for (; e-- && void 0 === h;) {
      ...
      translate: function translate(a, b, c, d, g, n) {
        var f = this.linkedParent || this,
            r = 1,
            e = 0,
            h = d ? f.oldTransA : f.transA;
        d = d ? f.oldMin : f.min;
      ...
      getPlotLinePath: function getPlotLinePath(a, b, c, g, n) {
        var f = this,
            r = f.chart,
            e = f.left,
            h = f.top,
        ...
        d(this, "getPlotLinePath", A, function (d) {
          ...
          l(n) ? f.horiz ? (m = h, w = L - f.bottom, x = B = E(x, e, e + f.width)) : (x = e, B = z - f.right, m = w = E(m, h, h + f.height)) : (p = !0, g = !1);
      ...
      getMinorTickPositions: function getMinorTickPositions() {
        ...
        });else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval()) g = g.concat(a.getTimeTicks(a.normalizeTimeTickInterval(d), n, l, b.startOfWeek));else for (b = n + (c[0] - n) % d; b <= l && b !== g[0]; b += d) {
          g.push(b);
        }
      ...
      adjustForMinRange: function adjustForMinRange() {
        ...
        c - b < this.minRange && (g = this.dataMax - this.dataMin >= this.minRange, m = this.minRange, d = (m - c + b) / 2, d = [b - d, D(a.min, b - d)], g && (d[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin), b = F(d), c = [b + m, D(a.max, b + m)], g && (c[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax), c = k(c), c - b < m && (d[0] = c - m, d[1] = D(a.min, c - m), b = F(d)));
        this.min = b;
        this.max = c;
      },
      ...
      setAxisTranslation: function setAxisTranslation(a) {
        ...
        if (w || m || g) l = f.getClosest(), x ? (e = x.minPointOffset, h = x.pointRangePadding) : f.series.forEach(function (a) {
          ...
          g = Math.max(g, b);
          if (!f.single || m) a = n.xrange && a instanceof n.xrange ? !w : w, e = Math.max(e, a && c(r) ? 0 : b / 2), h = Math.max(h, a && "on" === r ? 0 : b);
      ...
      setTickInterval: function setTickInterval(f) {
        ...
        v = D(c.userMin, n.min);
        C = D(c.userMax, n.max);
        m ? (c.linkedParent = g[c.coll][n.linkedTo], p = c.linkedParent.getExtremes(), c.min = D(p.min, p.dataMin), c.max = D(p.max, p.dataMax), n.type !== c.linkedParent.options.type && a.error(11, 1, g)) : (!J && u(H) && (c.dataMin >= H ? (p = H, w = 0) : c.dataMax <= H && (t = H, B = 0)), c.min = D(v, p, c.dataMin), c.max = D(C, t, c.dataMax));
        ...
        c.adjustForMinRange();
        !(E || c.axisPointRange || c.usePercentage || m) && u(c.min) && u(c.max) && (g = c.max - c.min) && (!u(v) && w && (c.min -= g * w), !u(C) && B && (c.max += g * B));
        ...
        J && u(c.dataMin) && (H = H || 0, !u(v) && c.min < H && c.dataMin >= H ? c.min = c.options.minRange ? Math.min(H, c.max - c.minRange) : H : !u(C) && c.max > H && c.dataMax <= H && (c.max = c.options.minRange ? Math.max(H, c.min + c.minRange) : H));
      ...
      trimTicks: function trimTicks(a, c, b) {
        ...
        if (!this.isLinked) {
          if (c && -Infinity !== f) this.min = f;else for (; this.min - l > a[0];) {
            a.shift();
          }
          if (b) this.max = g;else for (; this.max + l < a[a.length - 1];) {
            a.pop();
          }
      ...
      setExtremes: function setExtremes(a, c, b, g, l) {
        var f = this,
            n = f.chart;
        b = D(b, !0);
      ...
      autoLabelAlign: function autoLabelAlign(a) {
        var f = (D(a, 0) - 90 * this.side + 720) % 360;
        a = {
          align: "center"
        };
      ...
      renderUnsquish: function renderUnsquish() {
        ...
        if (this.autoRotation) k > x && k > B.h ? m.rotation = this.labelRotation : this.labelRotation = 0;else if (h && (z = x, !w)) for (p = "clip", x = d.length; !e && x--;) {
        ...
        d.forEach(function (a) {
          var f = (a = g[a]) && a.label,
              c = n.width,
              b = {};
          f && (f.attr(m), a.shortenLabel ? a.shortenLabel() : z && !c && "nowrap" !== n.whiteSpace && (z < f.textPxLength || "SPAN" === f.element.tagName) ? (b.width = z, w || (b.textOverflow = f.specificTextOverflow || p), f.css(b)) : f.styles && f.styles.width && !b.width && !c && f.css({
            width: null
      ...
      addTitle: function addTitle(a) {
        ...
        l || d.style.width || this.isRadial || this.axisTitle.css({
          width: this.len
        });
      ...
      getOffset: function getOffset() {
        ...
        a.renderLine();
        a.offset = q * D(g.offset, H[h] ? H[h] + (g.margin || 0) : 0);
      ...
      render: function render() {
        ...
        if (c.hasData() || e) c.minorTickInterval && !c.categories && c.getMinorTickPositions().forEach(function (a) {
          ...
          c.renderTick(a, b);
        }), A && (0 === c.min || c.single) && (m[-1] || (m[-1] = new E(c, -1, null, !0)), m[-1].render(-1))), k && h.forEach(function (f, d) {
  ...
  K(G, "parts/LogarithmicAxis.js", [G["parts/Globals.js"]], function (a) {
    ...
    C.prototype.getLogTickPositions = function (a, q, t, u) {
      ...
      if (.5 <= a) a = Math.round(a), h = this.getLinearTickPositions(a, q, t);else if (.08 <= a) for (var p = Math.floor(q), d, m, b, g, l, e = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; p < t + 1 && !l; p++) {
        for (m = e.length, d = 0; d < m && !l; d++) {
          b = this.log2lin(this.lin2log(p) * e[d]), b > q && (!u || g <= t) && void 0 !== g && h.push(g), g > t && (l = !0), g = b;
        }
  ...
  K(G, "parts/PlotLineOrBand.js", [G["parts/Globals.js"], G["parts/Axis.js"]], function (a, C) {
    ...
    a.PlotLineOrBand.prototype = {
      ...
      renderLabel: function renderLabel(a, e, h, d) {
        var m = this.label,
    ...
    a.extend(C.prototype, {
      getPlotBandPath: function getPlotBandPath(a, e) {
        ...
        if (d && h) for (a && (l = d.toString() === h.toString(), g = 0), a = 0; a < d.length; a += 6) {
          b && h[a + 1] === d[a + 1] ? (h[a + 1] += g, h[a + 4] += g) : b || h[a + 2] !== d[a + 2] || (h[a + 2] += g, h[a + 5] += g), m.push("M", d[a + 1], d[a + 2], "L", d[a + 4], d[a + 5], h[a + 4], h[a + 5], h[a + 1], h[a + 2], "z"), m.isFlat = l;
        }
        return m;
      },
      ...
      addPlotBandOrLine: function addPlotBandOrLine(e, p) {
    ...
    a.Tooltip.prototype = {
      ...
      getPosition: function getPosition(a, e, d) {
        var h = this.chart,
            ...
            k = w ? Math.max(C.body.scrollHeight, C.documentElement.scrollHeight, C.body.offsetHeight, C.documentElement.offsetHeight, C.documentElement.clientHeight) : h.chartHeight,
      ...
      refresh: function refresh(e, h) {
        ...
        m.enabled && (a.clearTimeout(this.hideTimer), this.followPointer = t(g)[0].series.tooltipOptions.followPointer, l = this.getAnchor(g, h), h = l[0], b = l[1], !c || g.series && g.series.noSharedTooltip ? c = g.getLabelConfig() : (p = d.pointer.getActiveSeries(g), d.series.forEach(function (a) {
          ...
          stroke: m.borderColor || g.color || c.color || "#666666"
        }), this.updatePosition({
          plotX: h,
          plotY: b,
          negative: g.negative,
        ...
        e.slice(0, h.length + 1).forEach(function (a, n) {
          if (!1 !== a && "" !== a) {
            ...
            var e = n.series || d,
                B = e.tt,
                A = n.series || {},
                H = "highcharts-color-" + q(n.colorIndex, A.colorIndex, "none");
            B || (B = {
              padding: c.padding,
              r: c.borderRadius
            ...
            n.isHeader ? (w = a.height, b.xAxis[0].opposite && (z = !0, p -= w), A = Math.max(0, Math.min(n.plotX + b.plotLeft - A / 2, b.chartWidth + (b.scrollablePixels ? b.scrollablePixels - b.marginRight : 0) - A))) : A = n.plotX + b.plotLeft - q(c.distance, 16) - A;
            0 > A && (l = !1);
      ...
      getDateFormat: function getDateFormat(a, e, d, m) {
        ...
        for (c in v) {
          if (a === v.week && +b.dateFormat("%w", e) === d && "00:00:00.000" === g.substr(6)) {
            c = "week";
            break;
          }
      ...
      tooltipFooterHeaderFormatter: function tooltipFooterHeaderFormatter(e, h) {
  ...
  K(G, "parts/Pointer.js", [G["parts/Globals.js"]], function (a) {
    ...
    a.Pointer.prototype = {
      ...
      getHoverData: function getHoverData(a, c, b, d, g, e) {
        var l,
            n = [];
        d = !(!d || !a);
        ...
        l && (g && !c.noSharedTooltip ? (x = b.filter(function (a) {
      ...
      runPointActions: function runPointActions(b, c) {
        var d = this.chart,
            ...
            h = this.getHoverData(l, h, d.series, "touchmove" !== b.type && (!!c || h && h.directTouch && this.isDirectTouch), e, b),
            n = [],
            x,
            l = h.hoverPoint;
        x = h.hoverPoints;
      ...
      reset: function reset(a, c) {
        ...
        if (a) h && n && b(n).length && (h.refresh(n), h.shared && l ? l.forEach(function (a) {
      ...
      drag: function drag(a) {
        ...
        f && f.touch || (d < n ? d = n : d > n + m && (d = n + m), g < h ? g = h : g > h + E && (g = h + E), this.hasDragged = Math.sqrt(Math.pow(r - d, 2) + Math.pow(q - g, 2)), 10 < this.hasDragged && (p = c.isInsidePlot(r - n, q - h), c.hasCartesianSeries && (this.zoomX || this.zoomY) && p && !t && !f && (this.selectionMarker = f = c.renderer.rect(n, h, e ? 1 : m, l ? 1 : E, 0).attr({
  ...
  K(G, "parts/TouchPointer.js", [G["parts/Globals.js"]], function (a) {
    ...
    I(a.Pointer.prototype, {
      pinchTranslate: function pinchTranslate(a, k, t, u, v, p) {
        this.zoomHor && this.pinchTranslateDirection(!0, a, k, t, u, v, p);
        this.zoomVert && this.pinchTranslateDirection(!1, a, k, t, u, v, p);
      },
      pinchTranslateDirection: function pinchTranslateDirection(a, k, t, u, v, p, h, d) {
        var e = this.chart,
            b = a ? "x" : "y",
            g = a ? "X" : "Y",
            l = "chart" + g,
      ...
      pinch: function pinch(a) {
        var e = this,
            ...
            l = {};
        1 < p && (e.initiated = !0);
        d && e.initiated && !g && a.preventDefault();
      ...
      touch: function touch(e, q) {
        ...
        1 === e.touches.length ? (e = this.normalize(e), (v = t.isInsidePlot(e.chartX - t.plotLeft, e.chartY - t.plotTop)) && !t.openMenu ? (q && this.runPointActions(e), "touchmove" === e.type && (q = this.pinchDown, u = q[0] ? 4 <= Math.sqrt(Math.pow(q[0].chartX - e.chartX, 2) + Math.pow(q[0].chartY - e.chartY, 2)) : !1), k(u, !0) && this.pinch(e)) : q && this.reset()) : 2 === e.touches.length && this.pinch(e);
      },
  ...
  K(G, "parts/MSPointer.js", [G["parts/Globals.js"]], function (a) {
    ...
    if (!a.hasTouch && (v.PointerEvent || v.MSPointerEvent)) {
      var h = {},
        ...
        "touch" !== _b.pointerType && _b.pointerType !== _b.MSPOINTER_TYPE_TOUCH || !I[a.hoverChartIndex] || (e(_b), e = I[a.hoverChartIndex].pointer, e[d]({
          type: c,
    ...
    a.Legend.prototype = {
      ...
      renderItem: function renderItem(a) {
        ...
        x || (a.legendGroup = d.g("legend-item").addClass("highcharts-" + E.type + "-series highcharts-color-" + a.colorIndex + (r ? " " + r : "") + (B ? " highcharts-series-" + a.index : "")).attr({
          zIndex: 1
        }).add(this.scrollGroup), a.legendItem = x = d.text("", n ? e + h : -h, this.baseline || 0, f), b.styledMode || x.css(u(a.visible ? m : k)), x.attr({
          align: n ? "left" : "right",
          zIndex: 2
      ...
      proximatePositions: function proximatePositions() {
        ...
        this.allItems.forEach(function (c) {
          ...
          h = e;
          var l;
          c.yAxis && c.points && (c.xAxis.options.reversed && (h = !h), g = a.find(h ? c.points : c.points.slice(0).reverse(), function (b) {
      ...
      handleOverflow: function handleOverflow(a) {
        ...
        a > h && !1 !== x.enabled ? (this.clipHeight = p = Math.max(h - 20 - this.titleHeight - m, 0), this.currentPage = v(this.currentPage, 1), this.fullHeight = a, q.forEach(function (a, b) {
          ...
          b.scroll(-1, B);
        }), this.pager = c.text("", 15, 10).addClass("highcharts-legend-navigation"), d.styledMode || this.pager.css(x.style), this.pager.add(H), this.down = c.symbol("triangle-down", 0, 0, E, E).add(H), L("downTracker").on("click", function () {
          b.scroll(1, B);
      ...
      scroll: function scroll(a, d) {
        ...
        0 < e && (void 0 !== d && p(d, this.chart), this.nav.attr({
          ...
          fill: e === c ? g.inactiveColor : g.activeColor
    ...
    a.LegendSymbolMixin = {
      ...
      drawLineMarker: function drawLineMarker(a) {
        ...
        d && !1 !== d.enabled && c && (b = Math.min(v(d.radius, h), h), 0 === this.symbol.indexOf("url") && (d = u(d, {
          width: e,
          height: e
        }), b = 0), this.legendSymbol = d = m.symbol(this.symbol, c / 2 - b, a - b, 2 * b, 2 * b, d).addClass("highcharts-point").add(k), d.isMarker = !0);
      }
    };
  ...
  K(G, "parts/Chart.js", [G["parts/Globals.js"]], function (a) {
    ...
    m(M.prototype, {
      ...
      getContainer: function getContainer() {
        ...
        if (this.styledMode) for (E in c.defs) {
      ...
      reflow: function reflow(b) {
        var c = this,
            ...
            f = f.height || a.getStyle(g, "height"),
            g = b ? b.target : N;
      ...
      drawChartBox: function drawChartBox() {
        ...
        if (l) h = k = d.strokeWidth();else {
          ...
          if (h || d["stroke-width"]) x.stroke = a.borderColor, x["stroke-width"] = h;
      ...
      propFromSeries: function propFromSeries() {
        ...
        ["inverted", "angular", "polar"].forEach(function (g) {
          ...
          for (d = f && f.length; !e && d--;) {
            (c = H[f[d].type]) && c.prototype[g] && (e = !0);
          }
  ...
  K(G, "parts/ScrollablePlotArea.js", [G["parts/Globals.js"]], function (a) {
    ...
    I.prototype.moveFixedElements = function () {
      ...
      [this.inverted ? ".highcharts-xaxis" : ".highcharts-yaxis", this.inverted ? ".highcharts-xaxis-labels" : ".highcharts-yaxis-labels", ".highcharts-contextbutton", ".highcharts-credits", ".highcharts-legend", ".highcharts-reset-zoom", ".highcharts-subtitle", ".highcharts-title", ".highcharts-legend-checkbox"].forEach(function (e) {
    ...
    I.prototype.applyFixed = function () {
      ...
      k && (this.fixedDiv = a.createElement("div", {
        ...
        pointerEvents: "none",
        zIndex: 2
      }, null, !0), this.renderTo.insertBefore(this.fixedDiv, this.renderTo.firstChild), this.renderTo.style.overflow = "visible", this.fixedRenderer = F = new a.Renderer(this.fixedDiv, 0, 0), this.scrollableMask = F.path().attr({
      ...
      this.scrollableMask.attr({
        d: this.scrollablePixels ? ["M", 0, k, "L", this.plotLeft - 1, k, "L", this.plotLeft - 1, e, "L", 0, e, "Z", "M", F, k, "L", this.chartWidth, k, "L", this.chartWidth, e, "L", F, e, "Z"] : ["M", 0, 0]
      });
    };
  });
  K(G, "parts/Point.js", [G["parts/Globals.js"]], function (a) {
    ...
    a.Point.prototype = {
      ...
      setNestedProperty: function setNestedProperty(d, e, b) {
        b.split(".").reduce(function (b, d, c, h) {
      ...
      optionsToObject: function optionsToObject(d) {
        var e = {},
            ...
            k = 0,
            p = 0;
        if (t(d) || null === d) e[h[0]] = d;else if (q(d)) for (!g && d.length > c && (b = _typeof(d[0]), "string" === b ? e.name = d[0] : "number" === b && (e.x = d[0]), k++); p < c;) {
          g && void 0 === d[k] || (0 < h[p].indexOf(".") ? a.Point.prototype.setNestedProperty(e, d[k], h[p]) : e[h[p]] = d[k]), k++, p++;
        } else "object" === _typeof(d) && (e = d, d.dataLabels && (b._hasPointLabels = !0), d.marker && (b._hasPointMarkers = !0));
        return e;
      },
      ...
      firePointEvent: function firePointEvent(a, e, b) {
        ...
        "click" === a && h.allowPointSelect && (b = function b(a) {
  ...
  K(G, "parts/Series.js", [G["parts/Globals.js"]], function (a) {
    ...
    a.Series = a.seriesType("line", null, {
      ...
      setOptions: function setOptions(a) {
        ...
        }, a || (e.color = b.negativeColor, e.fillColor = b.negativeFillColor), d.push(e));
      ...
      updateData: function updateData(b) {
        ...
        b.forEach(function (b, f) {
          ...
          r = k.x;
          if (k.id || m(r)) if (r = this.findPointIndex(k, h), -1 === r || void 0 === r ? e.push(b) : d[r] && b !== c.data[r] ? (d[r].update(b, !1, null, !1), d[r].touched = !0, n && (h = r + 1)) : d[r] && (d[r].touched = !0), !l || f !== r || this.hasDerivedData) g = !0;
        }, this);
        if (g) for (b = d.length; b--;) {
      ...
      setData: function setData(e, g, h, l) {
        var n = this,
            f = n.points,
            r = f && f.length || 0,
            k,
        ...
        if (!v) {
          ...
          if (z && k > z) {
            ...
            if (m(B)) for (h = 0; h < k; h++) {
              E[h] = this.autoIncrement(), A[h] = e[h];
            } else if (d(B)) {
              if (q) for (h = 0; h < k; h++) {
                B = e[h], E[h] = B[0], A[h] = B.slice(1, q + 1);
              } else for (t && (D = t.indexOf("x"), u = t.indexOf("y"), D = 0 <= D ? D : 0, u = 0 <= u ? u : 1), h = 0; h < k; h++) {
      ...
      processData: function processData(b) {
        ...
        p && this.sorted && !k && (!l || e > l || this.forceCrop) && (c[e - 1] < A || c[0] > q ? (c = [], d = []) : this.yData && (c[0] < A || c[e - 1] > q) && (g = this.cropData(this.xData, this.yData, A, q), c = g.xData, d = g.yData, g = g.start, f = !0));
      ...
      generatePoints: function generatePoints() {
        ...
        for (t = 0; t < l; t++) {
          k = m + t, w ? (A = new g().init(this, [e[t]].concat(z(f[t]))), A.dataGroup = this.groupMap[t], A.dataGroup.options && (A.options = A.dataGroup.options, p(A, A.dataGroup.options), delete A.dataLabels)) : (A = c[k]) || void 0 === b[k] || (c[k] = A = new g().init(this, b[k], e[t])), A && (A.index = k, q[t] = A);
        }

        this.options.keys = a;
        if (c && (l !== (d = c.length) || w)) for (t = 0; t < d; t++) {
      ...
      getExtremes: function getExtremes(a) {
        ...
        var n = e.min,
            ...
            p,
            w,
            A = this.requireSorting ? this.cropShoulder : 0,
            z,
            q;
        ...
        for (q = 0; q < e; q++) {
          if (w = c[q], z = a[q], p = (m(z, !0) || d(z)) && (!b.positiveValuesOnly || z.length || 0 < z), w = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[q + A] || w) >= n && (c[q - A] || w) <= l, p && w) if (p = z.length) for (; p--;) {
      ...
      setClip: function setClip(a) {
        ...
        !1 !== c.clip && (this.group.clip(a || f ? n : b.clipRect), this.markerGroup.clip(l), this.sharedClipKey = h);
      ...
      drawGraph: function drawGraph() {
        ...
        e.forEach(function (f, e) {
          ...
          }, f[3] ? g.dashstyle = f[3] : "square" !== b.linecap && (g["stroke-linecap"] = g["stroke-linejoin"] = "round"), h[n](g).shadow(2 > e && b.shadow));
      ...
      searchKDTree: function searchKDTree(a, b, c) {
        function d(a, b, c, l) {
          ...
          b[r] && Math.sqrt(m * m) < p[h] && (a = d(a, b[r], c + 1, l), p = a[h] < p[h] ? a : p);
          return p;
        }
  ...
  K(G, "parts/Stacking.js", [G["parts/Globals.js"]], function (a) {
    ...
    a.StackItem.prototype = {
      ...
      getStackBox: function getStackBox(a, e, d, m, b, g, l) {
    ...
    v.prototype.modifyStacks = function () {
      var a = this,
          ...
          m = a.processedXData,
          b,
          g = a.options.stacking;
      a[g + "Stacker"] && [e, "-" + e].forEach(function (e) {
        for (var c = m.length, h, l; c--;) {
          if (h = m[c], b = a.getStackIndicator(b, h, a.index, e), l = (h = d[e] && d[e][h]) && h.points[b.key]) a[g + "Stacker"](l, h, c);
        }
      });
    };
  ...
  K(G, "parts/Dynamics.js", [G["parts/Globals.js"]], function (a) {
    ...
    v(k.prototype, {
      ...
      update: function update(c, d, e, m) {
        ...
        g(c, function (a, b) {
          ...
          "chart" !== b && -1 !== k.propsRequireUpdateSeries.indexOf(b) && (w = !0);
        });
    ...
    v(w.prototype, {
      addPoint: function addPoint(a, b, c, d, e) {
        ...
        x = n.x;
        q = z.length;
        if (this.requireSorting && x < z[q - 1]) for (w = !0; q && z[q - 1] > x;) {
          q--;
        }
      ...
      update: function update(c, d) {
        ...
        var e = this,
          ...
          animation: !1
            ...
            u = {};
        n && (A.push("data", "isDirtyData", "points", "processedXData", "processedYData", "xIncrement"), !1 !== c.visible && A.push("area", "graph"), e.parallelArrays.forEach(function (a) {
          A.push(a + "Data");
        ...
        e.init(g, c);
        n && this.points && (k = e.options, !1 === k.visible ? (u.graphic = 1, u.dataLabel = 1) : (k.marker && !1 === k.marker.enabled && (u.graphic = 1), k.dataLabels && !1 === k.dataLabels.enabled && (u.dataLabel = 1)), this.points.forEach(function (a) {
    ...
    k("area", "line", {
      ...
      getStackPoints: function getStackPoints(e) {
        var k = [],
            ...
            b = m.length,
            g,
            l = I(v.options.reversedStacks, !0) ? 1 : -1,
            c;
        e = e || this.points;
      ...
      getGraphPath: function getGraphPath(a) {
        ...
        for (p = 0; p < a.length; p++) {
          if (h = a[p].isNull, g = I(a[p].rectPlotX, a[p].plotX), z = I(a[p].yBottom, w), !h || k) k || J(p, p - 1, "left"), h && !u && k || (m.push(a[p]), d.push({
            x: p,
            plotX: g,
            plotY: z
          })), k || J(p, p + 1, "right");
      ...
      drawGraph: function drawGraph() {
        ...
        this.zones.forEach(function (e, k) {
          u.push(["zone-area-" + k, "highcharts-area highcharts-zone-area-" + k + " " + e.className, e.color || a.color, e.fillColor || t.fillColor]);
        });
  ...
  K(G, "parts/SplineSeries.js", [G["parts/Globals.js"]], function (a) {
    ...
    a = a.seriesType;
    a("spline", "line", {}, {
      getPointSpline: function getPointSpline(a, F, k) {
        var e = F.plotX,
            q = F.plotY,
            t = a[k - 1];
        k = a[k + 1];
        ...
        if (t && !t.isNull && !1 !== t.doCurve && !F.isCliff && k && !k.isNull && !1 !== k.doCurve && !F.isCliff) {
          ...
          v += d;
          h += d;
          v > a && v > q ? (v = Math.max(a, q), h = 2 * q - v) : v < a && v < q && (v = Math.min(a, q), h = 2 * q - v);
  ...
  K(G, "parts/ColumnSeries.js", [G["parts/Globals.js"]], function (a) {
    ...
    v("column", "line", {
      ...
      getColumnMetrics: function getColumnMetrics() {
        ...
        a.columnMetrics = {
          width: d,
          offset: (u - d) / 2 + (q + ((a.columnIndex || 0) + (g ? 1 : 0)) * u - z / 2) * (g ? -1 : 1)
        };
      ...
      translate: function translate() {
        ...
        a.points.forEach(function (b) {
          var e = t(b.yBottom, c),
              ...
              z,
              w = Math.max(h, e) - r;
          p && Math.abs(w) < p && (w = p, z = !g.reversed && !b.negative || g.reversed && b.negative, b.y === l && a.dataMax <= l && g.min < l && (z = !z), r = Math.abs(r - c) > p ? e - p : c - (z ? p : 0));
      ...
      pointAttribs: function pointAttribs(a, d) {
        ...
        d && (a = q(e.states[d], a.options.states && a.options.states[d] || {}), d = a.brightness, c = a.color || void 0 !== d && I(c).brighten(a.brightness).get() || c, k = a[b] || k, p = a[h] || p, g = a.dashStyle || g, u = t(a.opacity, u));
        b = {
          fill: c,
          stroke: k,
          "stroke-width": p,
      ...
      drawPoints: function drawPoints() {
        ...
        a.points.forEach(function (c) {
          ...
          if (e(c.plotY) && null !== c.y) {
            ...
            if (h) h[m](q(l));else c.graphic = h = b[c.shapeType](l).add(c.group || a.group);
      ...
      animate: function animate(a) {
        var d = this,
            ...
            k;
        p && (a ? (h.scaleY = .001, a = Math.min(e.pos + e.len, Math.max(e.pos, e.toPixels(b.threshold))), g ? h.translateX = a - e.len : h.translateY = a, d.clipBox && d.setClip(), d.group.attr(h)) : (k = d.group.attr(c), d.group.animate({
          scaleY: 1
  ...
  K(G, "mixins/centered-series.js", [G["parts/Globals.js"]], function (a) {
    ...
    a.CenteredSeriesMixin = {
      getCenter: function getCenter() {
        ...
        for (h = 0; 4 > h; ++h) {
          d = v[h], a = 2 > h || 2 === h && /%$/.test(d), v[h] = k(d, [u, q, p, v[2]][h]) + (a ? t : 0);
        }
  ...
  K(G, "parts/DataLabels.js", [G["parts/Globals.js"]], function (a) {
    ...
    v.prototype.drawDataLabels = function () {
      ...
      var h = this,
          ...
          A = h.hasRendered || 0,
          n,
          x = a.animObject(p.animation).duration,
          v = Math.min(x, 200),
          E = t(q.defer, 0 < v),
          H = c.renderer,
      ...
      if (d(q) || q.enabled || h._hasPointLabels) n = h.plotGroup("dataLabelsGroup", "data-labels", E && !A ? "hidden" : "inherit", q.zIndex || 6), E && (n.attr({
        opacity: +A
    ...
    v.prototype.alignDataLabel = function (a, d, e, c, h) {
      var b = this.chart,
          ...
          k = t(a.dlBox && a.dlBox.centerX, a.plotX, -9999),
          l = t(a.plotY, -9999),
          n = d.getBBox(),
          m,
          p = e.rotation,
    ...
    v.prototype.justifyDataLabel = function (a, d, e, c, h, k) {
      ...
      n = e.y + c.height - p;
      n > b.plotHeight && ("top" === l ? d.verticalAlign = "bottom" : d.y = b.plotHeight - n, m = !0);
    ...
    p.pie && (p.pie.prototype.dataLabelPositioners = {
      ...
      b.visible && (k.enabled || b._hasPointLabels) && (d.forEach(function (a) {
        ...
        var g,
            ...
            z = [],
            x;
        if (p) for (b.sortByAngle(d, e - .5), 0 < b.maxLabelDistance && (g = Math.max(0, f - H - b.maxLabelDistance), l = Math.min(f + H + b.maxLabelDistance, c.plotHeight), d.forEach(function (a) {
      ...
      var b = this.center,
          ...
          h,
          k = null !== d.size;
      k || (null !== c[0] ? h = Math.max(b[2] - Math.max(a[1], a[3]), e) : (h = Math.max(b[2] - a[1] - a[3], e), b[0] += (a[3] - a[1]) / 2), null !== c[1] ? h = Math.max(Math.min(h, b[2] - Math.max(a[0], a[2])), e) : (h = Math.max(Math.min(h, b[2] - a[0] - a[2]), e), b[1] += (a[0] - a[2]) / 2), h < b[2] ? (b[2] = h, b[3] = Math.min(u(d.innerSize || 0, h), h), this.translate(b), this.drawDataLabels && this.drawDataLabels()) : k = !0);
      return k;
    });
    p.column && (p.column.prototype.alignDataLabel = function (a, d, h, c, k) {
      var b = this.chart.inverted,
          ...
          m = t(a.below, a.plotY > t(this.translatedThreshold, g.yAxis.len)),
  ...
  K(G, "modules/overlapping-datalabels.src.js", [G["parts/Globals.js"]], function (a) {
    ...
    C.prototype.hideOverlappingLabels = function (a) {
      var e = this,
          ...
          g,
          l,
          c = function c(a, b, _c, d, e, g, h, k) {
        return !(e > a + _c || e + h < a || g > b + d || g + k < b);
      };
      ...
      for (d = 0; d < k; d++) {
        for (l = (m = a[d]) && m.absoluteBox, h = d + 1; h < k; ++h) {
          if (g = (b = a[h]) && b.absoluteBox, l && g && m !== b && 0 !== m.newOpacity && 0 !== b.newOpacity && (g = c(l.x, l.y, l.width, l.height, g.x, g.y, g.width, g.height))) (m.labelrank < b.labelrank ? m : b).newOpacity = 0;
        }
      }
    ...
    t(G.prototype, {
      ...
      zoom: function zoom(b) {
        ...
        !b || b.resetSelection ? (c.axes.forEach(function (a) {
          ...
          e[m ? "zoomX" : "zoomY"] && n && (d = k.zoom(b.min, b.max), k.displayBtn && (h = !0));
        });
        k = c.resetZoomButton;
      ...
      setState: function setState(a, b) {
        ...
        if (!(a === this.state && !b || this.selected && "select" !== a || !1 === g.enabled || a && (p || l && !1 === f.enabled) || a && z.states && z.states[a] && !1 === z.states[a].enabled)) {
          ...
          if (this.graphic) h && this.graphic.removeClass("highcharts-point-" + h), a && this.graphic.addClass("highcharts-point-" + a), w.styledMode || (y = e.pointAttribs(this, a), G = m(w.options.chart.animation, g.animation), e.options.inactiveOtherPoints && ((this.dataLabels || []).forEach(function (a) {
            ...
            opacity: y.opacity
          }, G)), this.graphic.animate(y, G)), F && this.graphic.animate(F, m(w.options.chart.animation, f.animation, k.animation)), v && v.hide();else {
            if (a && f) {
              h = z.symbol || e.symbol;
    ...
    t(g.prototype, {
      ...
      setState: function setState(a, b) {
        var c = this,
            ...
            k = d.lineWidth,
            l = d.opacity,
            f = m(g[a || "normal"] && g[a || "normal"].animation, c.chart.options.chart.animation),
            d = 0;
        a = a || "";
  ...
  K(G, "parts/Responsive.js", [G["parts/Globals.js"]], function (a) {
    ...
    C.prototype.matchResponsiveRule = function (a, e) {
      var q = a.condition;
      (q.callback || function () {
        return this.chartWidth <= k(q.maxWidth, Number.MAX_VALUE) && this.chartHeight <= k(q.maxHeight, Number.MAX_VALUE) && this.chartWidth >= k(q.minWidth, 0) && this.chartHeight >= k(q.minHeight, 0);
    ...
    C.prototype.currentOptions = function (q) {
      function t(q, p, h, d) {
        ...
        a.objectEach(q, function (a, g) {
          if (!d && -1 < ["series", "xAxis", "yAxis"].indexOf(g)) for (a = e(a), h[g] = [], m = 0; m < a.length; m++) {
...
(function (g) {
  "object" === (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? (g["default"] = g, module.exports = g) : "function" === typeof define && define.amd ? define("highcharts/modules/map", ["highcharts"], function (z) {
    g(z);
    g.Highcharts = z;
    return g;
...
(function (f) {
  "object" === (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? (f["default"] = f, module.exports = f) : "function" === typeof define && define.amd ? define("highcharts/modules/drilldown", ["highcharts"], function (n) {
    f(n);
    f.Highcharts = n;
    return f;
  ...
  n(f, "modules/drilldown.src.js", [f["parts/Globals.js"]], function (d) {
    ...
    m.prototype.addSingleSeriesAsDrilldown = function (a, b) {
      ...
      (f = this.drilldownLevels[this.drilldownLevels.length - 1]) && f.levelNumber !== l && (f = void 0);
      b = q(q({
        _ddSeriesId: B++
      }, m), b);
      ...
      c.type === b.type && (b.animate = b.animateDrilldown || n, b.options.animation = !0);
    };
    ...
    m.prototype.showDrillUpButton = function () {
      ...
      this.drillUpButton ? this.drillUpButton.attr({
        text: b
      }).align() : (e = (g = c.theme) && g.states, this.drillUpButton = this.renderer.button(b, null, null, function () {
        a.drillUp();
    ...
    m.prototype.drillUp = function () {
      if (this.drilldownLevels && 0 !== this.drilldownLevels.length) {
        for (var a = this, b = a.drilldownLevels, c = b[b.length - 1].levelNumber, g = b.length, e = a.series, k, h, d, l, f = function f(b) {
          var c;
          e.forEach(function (a) {
          ...
          if (h = b[g], h.levelNumber === c) {
            b.pop();
            d = h.lowerSeries;
            if (!d.chart) for (k = e.length; k--;) {
              if (e[k].options.id === h.lowerSeriesOptions.id && e[k].options._levelNumber === c + 1) {
                d = e[k];
                break;
              }
            }
      ...
      (this.xAxis || []).forEach(function (a) {
        ...
        a.series.forEach(function (b) {
          ...
          for (c = 0; c < g.length; c++) {
            d = b.options.data[c], "number" !== typeof d && (d = b.pointClass.prototype.optionsToObject.call({
              series: b
            }, d), d.drilldown && (a.ddPoints[g[c]] || (a.ddPoints[g[c]] = []), a.ddPoints[g[c]].push(e ? e[c] : !0)));
          }
        });
    ...
    p.prototype.animateDrilldown = function (a) {
      var b = this,
          ...
          d = c.drilldownLevels,
          e,
          k = f(c.options.drilldown.animation),
          h = this.xAxis,
          r = c.styledMode;
    ...
    p.prototype.animateDrillupFrom = function (a) {
      ...
      this.points.forEach(function (k) {
        ...
        h && (delete k.graphic, e.chart.styledMode || (f.fill = a.color), b.duration ? h.animate(f, d.merge(b, {
          complete: l
        })) : (h.attr(f), l()));
      });
    };
    ...
    d.Point.prototype.doDrilldown = function (a, b, c) {
      ...
      for (; f-- && !h;) {
        e.series[f].id === this.drilldown && -1 === d.ddDupes.indexOf(this.drilldown) && (h = e.series[f], d.ddDupes.push(this.drilldown));
      }
    ...
    A.prototype.drillable = function () {
      ...
      }), f || b.css(c.chart.options.drilldown.activeAxisLabelStyle)) : b && b.drillable && (f || (b.styles = {}, b.css(b.basicStyles)), b.on("click", null), b.removeClass("highcharts-drilldown-axis-label")));
    };
...
(function (h) {
  "object" === (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? (h["default"] = h, module.exports = h) : "function" === typeof define && define.amd ? define("highcharts/modules/networkgraph", ["highcharts"], function (m) {
    h(m);
    h.Highcharts = m;
    return h;
  ...
  m(h, "mixins/nodes.js", [h["parts/Globals.js"]], function (f) {
    var c = f.pick,
        ...
        b = f.Point;
    f.NodesMixin = {
      createNode: function createNode(b) {
        function a(a, e) {
      ...
      setNodeState: function setNodeState() {
        ...
        (this.isNode ? this.linksTo.concat(this.linksFrom) : [this.fromNode, this.toNode]).forEach(function (a) {
          b.prototype.setState.apply(a, c);
          a.isNode || (a.fromNode.graphic && b.prototype.setState.apply(a.fromNode, c), a.toNode.graphic && b.prototype.setState.apply(a.toNode, c));
        });
        b.prototype.setState.apply(this, c);
      }
    };
  });
  m(h, "modules/networkgraph/integrations.js", [h["parts/Globals.js"]], function (f) {
    f.networkgraphIntegrations = {
      verlet: {
        attractiveForceFunction: function attractiveForceFunction(c, d) {
          return (d - c) / c;
        },
        repulsiveForceFunction: function repulsiveForceFunction(c, d) {
        ...
        barycenter: function barycenter() {
          ...
          this.nodes.forEach(function (c) {
            c.fixedPosition || (c.plotX -= d / c.mass / c.degree, c.plotY -= b / c.mass / c.degree);
          });
        },
        repulsive: function repulsive(c, d, b) {
          d = d * this.diffTemperature / c.mass / c.degree;
          c.fixedPosition || (c.plotX += b.x * d, c.plotY += b.y * d);
        },
        attractive: function attractive(c, d, b) {
          var g = c.getMass(),
              a = -b.x * d * this.diffTemperature;
        ...
        integrate: function integrate(c, d) {
          var b = -c.options.friction,
              g = c.options.maxSpeed,
              a = (d.plotX + d.dispX - d.prevX) * b,
              b = (d.plotY + d.dispY - d.prevY) * b,
              e = Math.abs,
              p = e(a) / (a || 1),
              e = e(b) / (b || 1),
              a = p * Math.min(g, Math.abs(a)),
              b = e * Math.min(g, Math.abs(b));
          d.prevX = d.plotX + d.dispX;
          d.prevY = d.plotY + d.dispY;
          d.plotX += a;
          d.plotY += b;
          d.temperature = c.vectorLength({
            x: a,
            y: b
          });
        },
        getK: function getK(c) {
      ...
      euler: {
        ...
        repulsive: function repulsive(c, d, b, g) {
          c.dispX += b.x / g * d / c.degree;
          c.dispY += b.y / g * d / c.degree;
        },
        attractive: function attractive(c, d, b, g) {
          var a = c.getMass(),
              e = b.x / g * d;
          d *= b.y / g;
          c.fromNode.fixedPosition || (c.fromNode.dispX -= e * a.fromNode / c.fromNode.degree, c.fromNode.dispY -= d * a.fromNode / c.fromNode.degree);
        ...
        integrate: function integrate(c, d) {
          ...
          b = d.temperature = c.vectorLength({
            x: d.dispX,
            y: d.dispY
          });
  ...
  m(h, "modules/networkgraph/QuadTree.js", [h["parts/Globals.js"]], function (f) {
    ...
    f.extend(c.prototype, {
      insert: function insert(b, c) {
        this.isInternal ? this.nodes[this.getBoxPosition(b)].insert(b, c - 1) : (this.isEmpty = !1, this.body ? c ? (this.isInternal = !0, this.divideBox(), !0 !== this.body && (this.nodes[this.getBoxPosition(this.body)].insert(this.body, c - 1), this.body = !0), this.nodes[this.getBoxPosition(b)].insert(b, c - 1)) : this.nodes.push(b) : (this.isInternal = !1, this.body = b));
      },
      ...
      getBoxPosition: function getBoxPosition(b) {
    ...
    f.extend(d.prototype, {
      insertNodes: function insertNodes(b) {
        b.forEach(function (b) {
          this.root.insert(b, this.maxDepth);
        }, this);
      },
      visitNodeRecursive: function visitNodeRecursive(b, c, a, e, d) {
        var l;
        b || (b = this.root);
        b === this.root && c && (l = c(b));
      ...
      renderBox: function renderBox(b, c, a) {
        b.graphic || a ? a && (b.graphic && (b.graphic = b.graphic.destroy()), b.graphic2 && (b.graphic2 = b.graphic2.destroy()), b.label && (b.label = b.label.destroy())) : (b.graphic = c.renderer.rect(b.box.left + c.plotLeft, b.box.top + c.plotTop, b.box.width, b.box.height).attr({
          ...
          "stroke-width": 2
        }).add(), isNaN(b.plotX) || (b.graphic2 = c.renderer.circle(b.plotX, b.plotY, b.mass / 10).attr({
          fill: "red",
  ...
  m(h, "modules/networkgraph/layouts.js", [h["parts/Globals.js"]], function (f) {
    ...
    f.extend(f.layouts["reingold-fruchterman"].prototype, {
      ...
      setArea: function setArea(a, b, c, d) {
        this.box = {
          left: a,
          top: b,
          width: c,
      ...
      setRandomPositions: function setRandomPositions() {
        ...
        d.forEach(function (e, d) {
          ...
          e.plotY = e.prevY = c(e.plotY, b.height * a(l + d));
          e.dispX = 0;
          e.dispY = 0;
        });
      },
      ...
      barnesHutApproximation: function barnesHutApproximation(a, b) {
        var c = this.getDistXY(a, b),
            ...
            d,
            k;
        a !== b && 0 !== e && (b.isInternal ? b.boxSize / e < this.options.theta && 0 !== e ? (k = this.repulsiveForce(e, this.k), this.force("repulsive", a, k * b.mass, c, e), d = !1) : d = !0 : (k = this.repulsiveForce(e, this.k), this.force("repulsive", a, k * b.mass, c, e)));
        return d;
      },
      repulsiveForces: function repulsiveForces() {
        ...
        "barnes-hut" === a.approximation ? a.nodes.forEach(function (b) {
          ...
          a.nodes.forEach(function (c) {
            var e, d, k;
            b === c || b.fixedPosition || (k = a.getDistXY(b, c), d = a.vectorLength(k), e = a.repulsiveForce(d, a.k), a.force("repulsive", b, e * c.mass, k, d));
          });
        });
      },
      ...
      applyLimitBox: function applyLimitBox(a, b) {
        var c = a.marker && a.marker.radius || 0;
    ...
    b(g, "render", function () {
      ...
      if (this.graphLayoutsLookup) {
        ...
        for (this.graphLayoutsLookup.forEach(function (a) {
          ...
          b = !0, this.graphLayoutsLookup.forEach(a);
        }
  ...
  m(h, "modules/networkgraph/draggable-nodes.js", [h["parts/Globals.js"]], function (f) {
    var c = f.Chart,
        d = f.addEvent;
    f.dragNodesMixin = {
      onMouseDown: function onMouseDown(b, c) {
      ...
      onMouseMove: function onMouseMove(b, c) {
        if (b.fixedPosition && b.inDragMode) {
          var a = this.chart,
              d = a.pointer.normalize(c);
          c = b.fixedPosition.chartX - d.chartX;
      ...
      onMouseUp: function onMouseUp(b) {
        b.fixedPosition && (this.layout.enableSimulation ? this.layout.start() : this.chart.redraw(), b.inDragMode = !1, this.options.fixedDraggable || delete b.fixedPosition);
      },
      redrawHalo: function redrawHalo(b) {
        b && this.halo && this.halo.attr({
          d: b.haloPath(this.options.states.hover.halo.size)
        });
      }
    };
    d(c, "load", function () {
      ...
      b.container && (c = d(b.container, "mousedown", function (c) {
        ...
        }), e = d(b.container.ownerDocument, "mouseup", function (b) {
          a();
          e();
  ...
  m(h, "modules/networkgraph/networkgraph.src.js", [h["parts/Globals.js"]], function (f) {
    ...
    b("networkgraph", "line", {
      ...
      dataLabels: {
        ...
        linkFormatter: function linkFormatter() {
      ...
      deferLayout: function deferLayout() {
        var a = this.options.layoutAlgorithm,
            ...
            g;
        this.visible && (b || (this.chart.graphLayoutsStorage = b = {}, this.chart.graphLayoutsLookup = c = []), g = b[a.type], g || (a.enableSimulation = d(e.forExport) ? !e.forExport : a.enableSimulation, b[a.type] = g = new f.layouts[a.type](), g.init(a), c.splice(g.index, 0, g)), this.layout = g, g.setArea(0, 0, this.chart.plotWidth, this.chart.plotHeight), g.addSeries(this), g.addNodes(this.nodes), g.addLinks(this.points));
      },
      render: function render() {
        var a = this.points,
            b = this.chart.hoverPoint,
            c = [];
      ...
      getLinkAttributes: function getLinkAttributes() {
        var b = this.series.options.link,
            c = this.options;
        return {
      ...
      redrawLink: function redrawLink() {
        var a = this.getLinkPath(),
            b;
        this.graphic && (this.shapeArgs = {
          d: a
        }, this.series.chart.styledMode || (b = this.series.pointAttribs(this), this.graphic.attr(b), (this.dataLabels || []).forEach(function (a) {
          a && a.attr({
            opacity: b.opacity
          });
      ...
      getLinkPath: function getLinkPath() {
        var a = this.fromNode,
            b = this.toNode;
...
Highcharts.mapChart('mapContainer', {
  ...
  colorAxis: {
    min: 1,
    minColor: '#f2f3f8',
    maxColor: '#ff9a17' // startOnTick: false,
    // endOnTick: false
...
$(document).ready(function () {
  var highchartsCredits = $('.highcharts-credits').html();
