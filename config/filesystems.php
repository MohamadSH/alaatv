    ...
    */
    ...
    'disks' => [
        ...
        'productImageSFTP'     => [
            ...
            'root'       => env('SFTP_ROOT', '').'/upload/images/product/',
        ...
        'homeSlideShowPicSFTP'     => [
            ...
            'password'   => env('SFTP_PASSWORD', ''),
            'privateKey' => env('SFTP_PRIVATE_KEY_PATH', ''),
            'root'       => env('SFTP_ROOT', '').'/upload/images/slideShow/',
        ...
        'productFileSFTP' => [
            ...
            'password'   => env('SFTP_PASSWORD', ''),
            'privateKey' => env('SFTP_PRIVATE_KEY_PATH', ''),
            'root'       => env('SFTP_ROOT', '').'/paid/private/',
            'prefix'     => null,
            'timeout'    => env('SFTP_TIMEOUT', '10'),
        ...
        'setImageSFTP'     => [
            ...
            'password'   => env('SFTP_PASSWORD', ''),
            'privateKey' => env('SFTP_PRIVATE_KEY_PATH', ''),
            'root'       => env('SFTP_ROOT', '').'/upload/contentset/departmentlesson/',
        ...
        'pamphletSftp' => [
            ...
            'password'   => env('SFTP_PASSWORD', ''),
            'privateKey' => env('SFTP_PRIVATE_KEY_PATH', ''),
            'root'       => env('SFTP_ROOT', '').'/paid/public/c/pamphlet/',
        ...
        'examSftp' => [
            ...
            'password'   => env('SFTP_PASSWORD', ''),
            'privateKey' => env('SFTP_PRIVATE_KEY_PATH', ''),
            'root'       => env('SFTP_ROOT', '').'/paid/public/c/exam/',
        ...
        'bookSftp' => [
            ...
            'password'   => env('SFTP_PASSWORD', ''),
            'privateKey' => env('SFTP_PRIVATE_KEY_PATH', ''),
            'root'       => env('SFTP_ROOT', '').'/paid/public/c/book/',
