            ...
            <div class="col-md-6">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"> اصلاح اطلاعات تراکنش  @if(!isset($transaction->order->user->firstName) && !isset($transaction->order->user->lastName)) کاربر ناشناس @else @if(isset($transaction->order->user->firstName)){{$transaction->order->user->firstName}} @endif @if(isset($transaction->order->user->lastName)) {{$transaction->order->user->lastName}} @endif @endif</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn btn-sm dark dropdown-toggle" href="{{action("HomeController@adminOrder")}}" > بازگشت
                                <i class="fa fa-angle-left"></i>
                            </a>
                        </div>
                    </div>
