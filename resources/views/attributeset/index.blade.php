...
@foreach( $attributesets as $attributeset)
    <tr>
        <th></th>
        <td>@if(isset($attributeset->name) && strlen($attributeset->name)>0 ) {{ $attributeset->name }}  @else
        ...
        <td>
            <div class = "btn-group">
                ...
                <ul class = "dropdown-menu" role = "menu">
                    ...
                    @endpermission @permission((config('constants.REMOVE_ATTRIBUTESET_ACCESS')))
                    <li>
                ...
                <!-- static -->@permission((config('constants.REMOVE_ATTRIBUTESET_ACCESS')))
