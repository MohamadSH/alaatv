                    ...
                    <div class="portlet-body form">
                        <div class="form-horizontal">
                            ...
                            <div class="portlet box yellow-haze" id="attributegroup-portlet">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>گروه صفت ها</div>
                                    <div class="tools">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <a id="sample_editable_1_new" class="btn btn-outline yellow-haze" data-toggle="modal" href="#responsive-attributegroup"><i class="fa fa-plus"></i> افزودن گروه صفت </a>
                                                    <!-- responsive modal -->
                                                    <div id="responsive-attributegroup" class="modal fade" tabindex="-1" data-width="760">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn yellow-haze" id="attributegroupForm-submit">ذخیره</button>
                                                        </div>
                                                    </div>
                                                    @endpermission
                                                </div>
