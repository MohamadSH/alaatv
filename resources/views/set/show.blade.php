            ...
            <div class="m-portlet m-portlet--full-height ">
                    ...
                    <div class="m-portlet__head-tools">
                        <div class="FavoriteAndOrder">
                            <div class="Order">
                                ...
                                @endif
                                    ...
                                    <a href="javascript:" id="btnShowSectionView">
                                        <i class="fa fa-cubes"></i>
                                    </a>

                                    <a href="javascript:" id="btnShowListView">
                        ...
                        <div class="countOfItems">
                            ...
                            @if($videos->isNotEmpty())
                                فیلم ها : {{$videosCount}} @if($pamphlets->isNotEmpty())|@endif
                            @endif
                            @if($pamphlets->isNotEmpty())
                                جزوه ها: {{$pamphletsCount}} @if($articles->isNotEmpty())|@endif
                            @endif
                ...
                <div class="m-portlet__body setVideoPamphletTabs">
                    ...
                    <ul class="nav nav-pills nav-fill" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{($pamphletsCount === 0) ? 'disabled' : ''}}" data-toggle="tab" href="#searchResult_pamphlet" data-state="pamphlet">
                                @if($pamphletsCount > 0)
                                    جزوات
                                    ({{$pamphletsCount}})
                                @else
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="searchResult_video" role="tabpanel">
                            <div class="m-widget5">
                                <div class="setVideo">
                                    <div class="m-accordion m-accordion--default m-accordion--toggle-arrow" id="m_accordion_video" role="tablist">

                                        @foreach($videos as $videoSectionId => $videoSection)
                                            @if ($videoSectionId !== null && $videoSectionId !== '')
                                                <div class="sectionView">
                                                    <!--begin::Item-->
                                                    <div class="m-accordion__item m-accordion__item--focus">
                                                        <div class="m-accordion__item-head collapsed" srole="tab" id="m_accordion_video_item_{{$videoSectionId}}_head" data-toggle="collapse" href="#m_accordion_video_item_{{$videoSectionId}}_body" aria-expanded="false">
                                                            <span class="m-accordion__item-icon"><i class="fa fa-folder-open"></i></span>
                                                            <span class="m-accordion__item-title">{{$videoSection->first()->section->name}}</span>
                                                            <span class="m-accordion__item-mode"></span>
                                                        </div>
                                                        <div class="m-accordion__item-body collapse" id="m_accordion_video_item_{{$videoSectionId}}_body" role="tabpanel" aria-labelledby="m_accordion_video_item_{{$videoSectionId}}_head" data-parent="#m_accordion_video">
                                                            <div class="m-accordion__item-content">
                                                                @foreach($videoSection as $videoItemKey => $video)
                        ...
                        <div class="tab-pane text-center" id="searchResult_pamphlet" role="tabpanel">
                            <div class="setPamphlet m-widget4 text-left">
                                <div class="m-accordion m-accordion--default m-accordion--toggle-arrow" id="m_accordion_pamphlet" role="tablist">
                                    @foreach($pamphlets as $pamphletSectionId => $pamphletSection)
                                        @if ($pamphletSectionId !== null && $pamphletSectionId !== '')
                                            <div class="sectionView">
                                                <!--begin::Item-->
                                                <div class="m-accordion__item m-accordion__item--focus">
                                                    <div class="m-accordion__item-head collapsed" srole="tab" id="m_accordion_pamphlet_item_{{$pamphletSectionId}}_head" data-toggle="collapse" href="#m_accordion_pamphlet_item_{{$pamphletSectionId}}_body" aria-expanded="false">
                                                        <span class="m-accordion__item-icon"><i class="fa fa-folder-open"></i></span>
                                                        <span class="m-accordion__item-title">{{$pamphletSection->first()->section->name}}</span>
                                                        <span class="m-accordion__item-mode"></span>
                                                    </div>
                                                    <div class="m-accordion__item-body collapse" id="m_accordion_pamphlet_item_{{$pamphletSectionId}}_body" role="tabpanel" aria-labelledby="m_accordion_pamphlet_item_{{$pamphletSectionId}}_head" data-parent="#m_accordion_pamphlet">
                                                        <div class="m-accordion__item-content">
                                                            @foreach($pamphletSection as $pamphletItemKey => $pamphlet)
