                            ...
                            <div class="m-widget5">
                                <div class="setVideo">
                                    ...
                                    @foreach($videos as $videoItemKey => $video)
                                        <div class="m-widget5__item set_video_item" data-section-id="{{optional($video->section)->id}}" data-section-name="{{optional($video->section)->name}}" data-item-order="{{$video->order}}">
                        ...
                        <div class="tab-pane text-center" id="searchResult_pamphlet" role="tabpanel">
                            <div class="setPamphlet m-widget4 text-left">
                                ...
                                @foreach($pamphlets as $pamphletItemKey => $pamphlet)
                                    <div class="m-widget4__item set_pamphlet_item" data-section-id="{{optional($pamphlet->section)->id}}" data-section-name="{{optional($pamphlet->section)->name}}" data-item-order="{{$pamphlet->order}}">
