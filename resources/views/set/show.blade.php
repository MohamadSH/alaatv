                                    ...
                                    @foreach($pamphlets->where('session' , $video->session) as $pamphlet)
                                        <div class="m-widget4__item">
                                            <div class="m-widget4__img m-widget4__img--icon">
                                                <a href="{{$pamphlet->file->first()->first()->link}}" title="{{$pamphlet->name}}">
                                            ...
                                            <div class="m-widget4__info">
                                                <span class="m-widget4__text">
                                                    <a href="{{$pamphlet->file->first()->first()->link}}" class="m-link" title="{{$pamphlet->name}}">
                                                        {{$pamphlet->name}}
                                                    </a>
                                                </span>
                                            </div>
                                            <div class="m-widget4__ext">
                                                <a href="{{$pamphlet->file->first()->first()->link}}" class="m-widget4__icon" title="{{$pamphlet->name}}">
