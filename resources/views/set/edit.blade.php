                            ...
                            <div class="col-md-9">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                        <img src="{{ $set->photo }}" @if(strlen($set->name)>0) alt="{{$set->name}}" @else  alt="عکس محصول" @endif/>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <a href="javascript:" class="m-btn--pill m-btn--air btn-danger fileinput-exists" data-dismiss="fileinput"> حذف</a>
                                    </div>
                                </div>
                                @if ($errors->has('image'))
                                    <span class="help-block">
