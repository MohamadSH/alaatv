<div class = "m-portlet m-portlet--mobile">
    <div class = "m-portlet__head">
        ...
        <div class = "m-portlet__head-tools">
            ...
            <div class = "actions">
                <div class = "btn-group">
                    <a target = "_blank" href = "{{action("Web\ProductfileController@create" , ["product"=>$product->id])}}" class = "btn btn-sm blue-dark">
                        <i class = "fa fa-plus-circle"></i>
                        آپلود فایل
                    </a>
                    <a class = "btn btn-sm dark dropdown-toggle" data-toggle = "modal" href = "#createProductFile">
                        <i class = "fa fa-plus-circle"></i>
                        درج فایل با لینک
                    </a>
