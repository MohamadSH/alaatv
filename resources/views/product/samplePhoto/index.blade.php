<div class = "m-portlet m-portlet--mobile">
    <div class = "m-portlet__head">
        ...
        <div class = "m-portlet__head-tools">
            <div class = "actions">
                <div class = "btn-group">
                    <a class = "btn btn-sm dark dropdown-toggle" data-toggle = "modal" href = "#createProductPhoto">
                ...
                @if(!$productPhotos->isEmpty())
                    @foreach($productPhotos as $photo)
                        <tr class = "text-center">
                            <td>@if(isset($photo->order)){{$photo->order}}@else
                            ...
                            <td>
                                ...
                                @endpermission @permission((config('constants.REMOVE_PRODUCT_SAMPLE_PHOTO_ACCESS')))
                                <a class = "btn btn-danger" onclick = "removePhoto('{{action("Web\ProductphotoController@destroy" , $photo)}}')" data-id = "{{$photo->id}}">
