                    ...
                    <div class = "portlet-body">
                        <div class = "tabbable-line">
                            <ul class = "nav nav-tabs ">
                                ...
                                @endif
                                @if(isset($descriptionIframe) && $descriptionIframe)
                                    <a href = "{{action("ProductController@show" , $product)}}" class = "btn green uppercase">
                        ...
                        @if(!isset($descriptionIframe) || !$descriptionIframe)
                            @if($product->enable)
                                ...
                                @else
                                    <button type = "button" id = "orderButton2" class = "btn btn-lg green col-md-12 col-xs-12 col-sm-12">
                                        <i class = "fa fa-cart-plus"></i>
                                        افزودن به سبد
                                    </button>
                                @endif
