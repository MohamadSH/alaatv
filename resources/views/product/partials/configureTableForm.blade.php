        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase">@if($product->producttype->id == Config::get("constants.PRODUCT_TYPE_CONFIGURABLE"))پیکربندی محصول ٬@endif<a href="{{action("ProductController@show" , $product)}}">{{$product->name}}</a></span>
                </div>
                        ...
                        @if($product->hasChildren())
                            @foreach($product->children as $child)
                                ...
                                <tr>
                                    ...
                                    @endif
                                    <td class="col-md-2 text-center"><a class="btn btn-info" href="{{action("ProductController@edit" , $child)}}">اصلاح</a></td>
                                    @endpermission
                                </tr>
                                {!! Form::close() !!}
                            @endforeach
