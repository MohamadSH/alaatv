                    ...
                    <div class="col-md-4">
                        <div class="price-column-container border-active">
                            ...
                            <div class="price-table-pricing">
                                <h3>
                                    <sup class="price-sign">تومان</sup><span style="@if($costCollection[184]["productDiscount"]>0)text-decoration: line-through;@endif">@if(isset($costCollection[184]["cost"])){{number_format($costCollection[184]["cost"])}} @endif</span></h3>
                                @if($costCollection[184]["productDiscount"]>0)<p>@if(isset($costCollection[184]["cost"])){{number_format(((1-($costCollection[184]["productDiscount"]/100))*$costCollection[184]["cost"]))}} @endif</p>@endif
                            </div>
                            ...
                            <div class="price-table-footer">
                                ...
                                <a href="{{action("ProductController@show", 184) }}" class="btn green btn-outline sbold uppercase price-button">اطلاعات اردوی حضوری</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="mt-element-ribbon bg-grey-steel">
                            ...
                            <p class="ribbon-content">
                                اردو طلایی بهترین فرصت سبقت در کورس کنکور
                                در این 10 روز که پیش مایی یاد می گیری که چطور درس بخونی، چی بخونی و چی نخونی
                            </p>
                        </div>
                        <div class="mt-element-ribbon bg-grey-steel">
                            ...
                            <p class="ribbon-content">
                                تو خونه باش! ولی اردوی مطالعاتی عید داشته باش
                                مشاور ما صبح به صبح پی گیری می کنه شما رو که طبق برنامه پیش بری
                            </p>
                        </div>
                        <div class="mt-element-ribbon bg-grey-steel">
                            <div class="ribbon ribbon-vertical-left ribbon-color-warning uppercase">
                            ...
                            <p class="ribbon-content">
                                عید نوبت توعه که جلو بیافتی؛ با نظارت دبیرستان دانشگاه شریف
                                عید با اردو طلایی بهترین و آخرین فرصت برای سبقت از بقیه است.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12 text-center">
                <div class="c-container bg-green">
                    <div class="c-content-title-1 c-inverse">
                        <h3 class="uppercase">درباره اردو سوال داری؟ <a href="https://telegram.me/sanati_sharif"  class="btn blue"><i class="fa fa-telegram fa-lg" aria-hidden="true"></i>تو تلگرام بپرس</a></h3>
