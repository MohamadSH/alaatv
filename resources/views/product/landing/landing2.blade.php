    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="blog-banner blog-container"
                 style="background-image:url(https://takhtekhak.com/image/9/1280/500/Untitled-1_20180213153803.jpg);">
                    ...
                    <div class="col-md-4">
                        <div class="price-column-container border-active">
                            ...
                            <div class="price-table-pricing">
                                <h3>
                                    <sup class="price-sign">تومان</sup><span
                                            style="@if($costCollection[184]["productDiscount"]>0)text-decoration: line-through;@endif">@if(isset($costCollection[184]["cost"])){{number_format($costCollection[184]["cost"])}} @endif</span>
                                </h3>
            ...
            <div class="col-md-12 text-center">
                <div class="c-container bg-green">
                    <div class="c-content-title-1 c-inverse">
                        <h3 class="uppercase">درباره اردو سوال داری؟ <a href="https://telegram.me/sanati_sharif"
                                                                        class="btn blue"><i class="fa fa-telegram fa-lg"
                                                                                            aria-hidden="true"></i>تو
                                تلگرام بپرس</a></h3>
