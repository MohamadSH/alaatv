            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">پیکر بندی محصول <a href="{{action("ProductController@show" , $product)}}">{{$product->name}}</a></span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn btn-sm dark dropdown-toggle" href="{{action("ProductController@edit" , $product)}}" > بازگشت
                                <i class="fa fa-angle-left"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="portlet-body form">
                        ...
                        @foreach($attributeCollection as  $attribute)
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{$attribute["attribute"]->displayName}} ({{$attribute["attributeControl"]}})</label>
                    ...
                    @else
                        <div class="alert alert-info bold"><h3 class="bold" style="text-align: center;">صفتی برای انتخاب وجود ندارد.</h3></div>
                    @endif
                    {!! Form::close() !!}
                </div>
            </div>
