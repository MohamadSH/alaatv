        ...
        <div class="col-md-12">
            ...
            <div class="portlet light ">
                ...
                <div class="portlet-body form">
                                                    ...
                                                    <div class="col-md-2">
                                                        <label class="mt-checkbox">
                                                            <input type="checkbox" value="{{$attributevalue->id}}"
                                                                   name="attributevalues[{{$attribute['attribute']->id}}][]"
                                                                   class="attributevalueCheckbox"
                                                                   id="checkbox_{{$attributevalue->id}}"> {{$attributevalue->name}}
                                                            <span class="bg-grey-cararra"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-md-10">
                                                        <input type="text" name="extraCost[{{$attributevalue->id}}]"
                                                               id="extraCost_{{$attributevalue->id}}"
                                                               placeholder="قیمت افزوده" dir="ltr" size="10" disabled>
                                                        <input type="text" name="order[{{$attributevalue->id}}]"
                                                               id="order_{{$attributevalue->id}}" placeholder="ترتیب"
                                                               dir="ltr" size="5" disabled>
                                                        <input type="text" name="description[{{$attributevalue->id}}]"
                                                               id="description_{{$attributevalue->id}}" size="75"
                    ...
                    @else
                        <div class="alert alert-info bold"><h3 class="bold" style="text-align: center;">صفتی برای انتخاب
                                وجود ندارد.</h3></div>
                    @endif
                    {!! Form::close() !!}
                </div>
