...
@section("pageBar")
    <div class="page-bar">
        ...
        <button type="button" class="btn btn-lg dark" style="float:left"
                onclick="$('#updateAttributevaluesForm').submit()">دخیره
        </button>
    </div>
@endsection
                                    ...
                                    @foreach($attributes["attributes"] as $attribute)
                                        <div class="row">
                                            <h4 class="text-center"
                                                style="background: gray;color: white;padding: 10px 0px 10px;">{{$attribute["name"]}}</h4>
