                ...
                <div class="col-md-12">
                   ...
                   @permission((Config::get('constants.LIST_USER_ACCESS')))
                    ...
                    <div class="portlet box red" id="user-portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-cogs"></i>مدیریت کاربران </div>
                            <div class="tools">
                                    ...
                                    <div class="form-body" style="background: #e7ecf1">
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-12 col-md-12">
                                                ...
                                                <img class="hidden" id="user-portlet-loading" src="{{Config::get("constants.FILTER_LOADING_GIF")}}" alt="loading" width="5%" >
                                            </div>
                                        </div>
                                    {!! Form::close() !!}
                                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="user_table">
                                    ...
                                    طول پیام: (<span style="color: red;"><span id="smsNumber">1</span>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <img class="hidden" id="send-sms-loading" src="{{Config::get('constants.FILTER_LOADING_GIF')}}" alt="loading" height="25px" width="25px">
                                        </div>
                                    </div>
                                    @endpermission
                                    ...
                                    <div id="deleteUserConfirmationModal" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" data-dismiss="modal"  class="btn green" onclick="removeUser()">بله</button>
                                        </div>
                                    </div>
                                    @endpermission
                                    ...
                                    <div id="addBonModal" class="modal fade" tabindex="-1">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" data-dismiss="modal" class="btn btn-outline dark" id="userAttachBonForm-close">بستن</button>
                   ...
                   @permission((Config::get('constants.LIST_PERMISSION_ACCESS')))
                    ...
                    <div class="portlet box blue-hoki" id="permission-portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-cogs"></i>مدیریت دسترسی ها </div>
                            <div class="tools">
                                <img class="hidden" id="permission-portlet-loading" src="{{Config::get('constants.ADMIN_LOADING_BAR_GIF')}}"  style="width: 50px;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            ...
                                            <a class="btn btn-outline blue-hoki" data-toggle="modal" href="#responsive-permission">
                                            ...
                                            <div id="responsive-permission" class="modal fade" tabindex="-1" data-width="760">
                                                ...
                                                {!! Form::close() !!}
                                                <div class="modal-footer">
                                                    <button type="button" data-dismiss="modal" class="btn btn-outline dark" id="permissionForm-close">بستن</button>
                                                    <button type="button" class="btn blue-hoki" id="permissionForm-submit">ذخیره</button>
                                                </div>
                                            </div>
                                            @endpermission
                                        </div>
                   ...
                   @role((Config::get("constants.ROLE_ADMIN")))
                    ...
                    <div class="portlet box blue-dark" id="role-portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-cogs"></i>مدیریت نقش ها</div>
                            <div class="tools">
                                <img class="hidden" id="role-portlet-loading" src="{{Config::get('constants.ADMIN_LOADING_BAR_GIF')}}" alt="loading"  style="width: 50px;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            ...
                                            <div id="responsive-role" class="modal fade" tabindex="-1" data-width="760">
                                                ...
                                                {!! Form::close() !!}
                                                <div class="modal-footer">
                                                    <button type="button" data-dismiss="modal" class="btn btn-outline dark" id="roleForm-close">بستن</button>
                                                    <button type="button" class="btn blue-dark" id="roleForm-submit">ذخیره</button>
                                                </div>
                                            </div>
                                            @endrole
                                        </div>
