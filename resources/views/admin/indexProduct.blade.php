        ...
        <div class="col-md-12">
            ...
            @permission((Config::get('constants.LIST_PRODUCT_ACCESS')))
                ...
                <div class="portlet box dark" id="product-portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-cogs"></i>مدیریت محصولات </div>
                        <div class="tools">
                            <img class="hidden" id="product-portlet-loading" src="{{Config::get('constants.ADMIN_LOADING_BAR_GIF')}}" alt="loading"  style="width: 50px;">
                    ...
                    <div class="portlet-body" style="display: block;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        ...
                                        <a id="sample_editable_4_new" class="btn btn-outline dark" data-toggle="modal" href="#responsive-product">
                                        ...
                                        <div id="responsive-product" class="modal fade" tabindex="-1" data-width="760">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" data-dismiss="modal" class="btn btn-outline dark" id="productForm-close">بستن</button>
                                                <button type="button" class="btn dark" id="productForm-submit">ذخیره</button>
                                            </div>
                                        </div>
                                        @endpermission
                                    </div>
                        ...
                        <div id="copyProductModal" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
                            ...
                            <div class="modal-footer">
                                ...
                                <img class="hidden" id="copy-product-loading-image" src="{{Config::get('constants.FILTER_LOADING_GIF')}}" alt="loading" height="25px" width="25px">
                            </div>
                            {!! Form::close() !!}
                        </div>
                        @endpermission
            ...
            @permission((Config::get('constants.LIST_COUPON_ACCESS')))
                ...
                <div class="portlet box blue-ebonyclay" id="coupon-portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-cogs"></i>مدیریت کپن ها </div>
                        <div class="tools">
                            <img class="hidden" id="coupon-portlet-loading" src="{{Config::get('constants.ADMIN_LOADING_BAR_GIF')}}" alt="loading" style="width: 50px;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        ...
                                        <a id="sample_editable_3_new" class="btn btn-outline blue-ebonyclay" data-toggle="modal" href="#responsive-coupon">
                                        ...
                                        <div id="responsive-coupon" class="modal fade" tabindex="-1" data-width="760">
                                            ...
                                            {!! Form::close() !!}
                                            <div class="modal-footer">
                                                <button type="button" data-dismiss="modal" class="btn btn-outline dark" id="couponForm-close">بستن</button>
                                                <button type="button" class="btn blue-ebonyclay" id="couponForm-submit">ذخیره</button>
                                            </div>
                                        </div>
                                        @endpermission
                                    </div>
            ...
            <!-- BEGIN ASSIGNMENT TABLE PORTLET-->
                <div class="portlet box yellow-mint" id="attribute-portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-cogs"></i>مدیریت صفت ها </div>
                        <div class="tools">
                            <img class="hidden" id="attribute-portlet-loading" src="{{Config::get('constants.ADMIN_LOADING_BAR_GIF')}}" alt="loading" style="width: 50px;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        ...
                                        <a id="sample_editable_1_new" class="btn btn-outline yellow-mint" data-toggle="modal" href="#responsive-attribute"><i class="fa fa-plus"></i> افزودن صفت </a>
                                        <!-- responsive modal -->
                                        <div id="responsive-attribute" class="modal fade" tabindex="-1" data-width="760">
                                            ...
                                            {!! Form::close() !!}
                                            <div class="modal-footer">
                                                <button type="button" data-dismiss="modal" class="btn btn-outline dark" id="attributeForm-close">بستن</button>
                                                <button type="button" class="btn yellow-mint" id="attributeForm-submit">ذخیره</button>
                                            </div>
                                        </div>
                                        @endpermission
                                    </div>
            ...
            <!-- BEGIN ASSIGNMENT TABLE PORTLET-->
                <div class="portlet box yellow-haze" id="attributeset-portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-cogs"></i>مدیریت دسته صفت ها </div>
                        <div class="tools">
                            <img class="hidden" id="attributeset-portlet-loading" src="{{Config::get('constants.ADMIN_LOADING_BAR_GIF')}}" alt="loading" style="width: 50px;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        ...
                                        <a id="sample_editable_1_new" class="btn btn-outline yellow-haze" data-toggle="modal" href="#responsive-attributeset"><i class="fa fa-plus"></i> افزودن صفت </a>
                                        <!-- responsive modal -->
                                        <div id="responsive-attributeset" class="modal fade" tabindex="-1" data-width="760">
                                            ...
                                            {!! Form::close() !!}
                                            <div class="modal-footer">
                                                <button type="button" data-dismiss="modal" class="btn btn-outline dark" id="attributesetForm-close">بستن</button>
                                                <button type="button" class="btn yellow-haze" id="attributesetForm-submit">ذخیره</button>
                                            </div>
                                        </div>
                                        @endpermission
                                    </div>
