    ...
    <!-- /.modal -->
        <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form " style="border-top: #3598dc solid 1px">
                            ...
                            <div class="form-body" style="background: #e7ecf1">
                                ...
                                <div class="form-group">
                                    <div class="col-md-3">
                                        <input type="text" name="minCost" class="form-control filter"
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <img class="hidden" id="report-portlet-loading"
            ...
            <div class="portlet box dark" id="bookSellingReport-portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i>گزارش فروش کتاب ها
                    </div>
                    <div class="tools">
                            ...
                            <div class="form-body" style="background: #e7ecf1">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        @endpermission
                                        <img class="hidden" id="bookSellingReport-portlet-loading"
                                             src="{{Config::get("constants.FILTER_LOADING_GIF")}}" alt="loading"
                                             width="5%">
                                    </div>
                                </div>
