                ...
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            ...
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="fullscreen" class="m-portlet__nav-link m-portlet__nav-link--icon" id="report-expand"><i class="la la-expand"></i></a>
                            </li>
                            <li class="m-portlet__nav-item">
                        ...
                        <div class="portlet-body" style="border-top: #3598dc solid 1px">
                            {!! Form::open(['action' => 'Web\UserController@index' ,'class'=>'form-horizontal form-row-seperated' , 'id' => 'filterReportForm']) !!}
                                <div class="form-body form m--padding-15" style="background: #e7ecf1">
                                        ...
                                        <div class="row">
                                            <label class="control-label" style="float:right">
                                                <label
                                                    ...
                                                    <input type="checkbox" id="userReportLotteryCheckbox" value="1"
                                                           name="lotteryEnable">قرعه کشی:
                                    ...
                                    <div class="form-group">
                                        <div>
                                            <a href="javascript:" class="btn m-btn--pill m-btn--air btn-info btn-lg reload" id="filter"
                                               style="background: #489fff">فیلتر</a>
                                            <img class="d-none" id="report-portlet-loading"
                ...
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            ...
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="fullscreen" class="m-portlet__nav-link m-portlet__nav-link--icon" id="bookSellingReport-expand"><i class="la la-expand"></i></a>
                            </li>
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="remove" class="m-portlet__nav-link m-portlet__nav-link--icon"><i class="la la-close"></i></a>
                            </li>
                                ...
                                <div class="form-body m--padding-15" style="background: #e7ecf1">
                                    ...
                                    <div class="form-group">
                                        <div>
                                            ...
                                            @endpermission
                                            <img class="d-none" id="bookSellingReport-portlet-loading"
                                                 src="{{config("constants.FILTER_LOADING_GIF")}}" alt="loading"
                                                 width="5%">
                                        </div>
                                    </div>
...
@section('page-js')
    ...
    <script src="/acm/AlaatvCustomFiles/js/admin-indexReport.js" type="text/javascript"></script>
