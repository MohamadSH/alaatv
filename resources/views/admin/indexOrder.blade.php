@permission((config('constants.LIST_ORDER_ACCESS')))@extends('app',['pageName'=>$pageName])
        ...
        <div class = "col-md-12">
            ...
            <div class = "m-portlet m-portlet--head-solid-bg m-portlet--info m-portlet--collapsed m-portlet--head-sm" m-portlet = "true" id = "transaction-portlet">
                ...
                <div class = "m-portlet__body">
                    ...
                    @endpermission @permission((config('constants.SHOW_TRANSACTION_TOTAL_FILTERED_COST_ACCESS')))
                    ...
                    <span class = "m-badge m-badge--success m-badge--wide m-badge--rounded">مجموع مبالغ آیتم های اضافه : <span id = "totalFilteredExtraCost"></span> تومان</span>
                    <br>
                    @endpermission
    ...
    <script type = "text/javascript">
        ...
        function makeDataTable_loadWithAjax_orders() {
            ...
            let columns = [
                ...
                {
                    "data": "jalaliUpdatedAt",
                    "title": "تاریخ اصلاح مدیریتی:",
                    "defaultContent": "<span class=\"m-badge m-badge--wide label-sm m-badge--danger\"> درج نشده </span>"
                },
                {
                    "data": "completed_at",
                    "title": "تاریخ ثبت نهایی:",
                    "defaultContent": "<span class=\"m-badge m-badge--wide label-sm m-badge--danger\"> درج نشده </span>"
                },
                ...
                {
                    "data": "jalaliCreatedAt",
                    "title": "تاریخ ایجاد اولیه",
                    "defaultContent": "<span class=\"m-badge m-badge--wide label-sm m-badge--danger\"> درج نشده </span>"
                },
            ];
