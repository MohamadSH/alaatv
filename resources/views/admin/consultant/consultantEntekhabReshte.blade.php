                ...
                <div class="portlet-body">
                    <div class="row">
                        ...
                        <div class="col-md-8 profile-info">
                            <h3 class="font-blue sbold uppercase">@if(isset($user->firstName) || isset($user->lastName)) @if(isset($user->firstName)) {{$user->firstName}} @endif @if(isset($user->lastName)) {{$user->lastName}} @endif @else کاربر ناشناس @endif</h3>
                            ...
                            <ul class="list-inline">
                                <li class="bold">
                                    <i class="fa fa-graduation-cap" aria-hidden="true"></i> دانش آموز رشته  @if(isset($user->major->id)) {{$user->major->name}} @endif </li>
                                {{--<li>--}}
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            ...
                            {{--<label class="btn btn-transparent grey-salsa btn-circle btn-sm">--}}
                                {{--<input type="radio" name="options" class="toggle" id="option2">Returning</label>--}}
                            <button type="submit" class="btn btn-transparent grey-salsa btn-circle btn-sm active">ثبت انتخاب رشته</button>
                        </div>
                    </div>
                </div>
                <div class="portlet-body">
