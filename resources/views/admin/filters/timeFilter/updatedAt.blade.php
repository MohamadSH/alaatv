...
<div class="col-md-3 col-xs-12">
    ...
    <input name="updatedSinceDate" id="{{$id}}UpdatedSinceAlt" type="text" class="form-control d-none" >
</div>
...
<div class="col-md-3 col-xs-12">
    ...
    <input name="updatedTillDate" id="{{$id}}UpdatedTillAlt" type="text" class="form-control d-none" >
</div>
