...
<label class="control-label" style="float: right;"><label class="mt-checkbox mt-checkbox-outline">
        <input type="checkbox" id="{{(isset($id))?$id:""}}{{(isset($enableId))?$enableId:""}}" value="1"
               name="{{(isset($enableId))?$enableId:""}}" @if(isset($default)) checked @endif>
...
<div class="col-md-3 col-xs-12">
    <input id="{{(isset($id))?$id:""}}{{(isset($sinceDateId))?$sinceDateId:""}}" type="text" class="form-control"
...
<div class="col-md-3 col-xs-12">
    <input id="{{(isset($id))?$id:""}}{{(isset($tillDateId))?$tillDateId:""}}" type="text" class="form-control"
           @if(!isset($default)) disabled="disabled" @endif>
