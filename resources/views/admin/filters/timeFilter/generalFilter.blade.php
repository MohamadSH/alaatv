@if(isset($label))
    <label class = "col-md-2 bold control-label">{{$label}} </label> @endif
...
<div class = "col-md-3 col-xs-12">
    ...
    <input name = "{{(isset($sinceDateId))?$sinceDateId:""}}" id = "{{(isset($id))?$id:""}}{{(isset($sinceDateId))?$sinceDateId:""}}Alt" type = "text" class = "form-control d-none">
</div>
...
<div class = "col-md-3 col-xs-12">
    ...
    <input name = "{{(isset($tillDateId))?$tillDateId:""}}" id = "{{(isset($id))?$id:""}}{{(isset($tillDateId))?$tillDateId:""}}Alt" type = "text" class = "form-control d-none">
</div>
