<div class = "row">
    ...
    <div class = "col-md-3 col-xs-12">
        ...
        <input name = "createdSinceDate" id = "{{(isset($id))?$id:""}}CreatedSinceAlt" type = "text" class = "form-control d-none">
    </div>
    ...
    <div class = "col-md-3 col-xs-12">
        ...
        <input name = "createdTillDate" id = "{{(isset($id))?$id:""}}CreatedTillAlt" type = "text" class = "form-control d-none">
    </div>
</div>