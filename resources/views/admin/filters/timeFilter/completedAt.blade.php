...
<label class="control-label" style="float: right;"><label class="mt-checkbox mt-checkbox-outline">
        <input type="checkbox" id="{{$id}}CompletedTimeEnable" value="1" name="completedTimeEnable"
...
<div class="col-md-3 col-xs-12">
    ...
    <input name="completedSinceDate" id="{{$id}}CompletedSinceAlt" type="text" class="form-control hidden">
</div>
...
<div class="col-md-3 col-xs-12">
    ...
    <input name="completedTillDate" id="{{$id}}CompletedTillAlt" type="text" class="form-control hidden">
</div>
