@if(isset($withCheckbox) && $withCheckbox)
    ...
    <div class = "col-md-10">
        ...
        @if(isset($dropdown) && $dropdown)
            ...
            @endif
        @else
            <select class = "mt-multiselect btn btn-default" multiple = "multiple" data-label = "left" data-width = "100%" data-filter = "true" data-height = "200" id = "grades" name = "grades[]" title = "رشته ها" disabled>
