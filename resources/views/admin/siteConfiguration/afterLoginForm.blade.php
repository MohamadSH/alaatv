                                ...
                                <div class="actions">
                                    <div class="btn-group btn-group-devided" data-toggle="buttons">
                                        <label class="btn btn-transparent grey-salsa btn-circle btn-sm active">
                                            <a class="bg-font-dark" data-toggle="modal" href="#addFieldModal"  ><i class="fa fa-plus" aria-hidden="true"></i> افزودن</a></label>
                                    </div>
                                </div>
                                        ...
                                        @else
                                            @foreach($afterLoginFormFields as $afterLoginFormField)
                                                <tr id="{{$afterLoginFormField->id}}">
                                                    ...
                                                    <td> @if($afterLoginFormField->enable) <span class="label label-sm label-success"> فعال </span> @else <span class="label label-sm label-warning"> غیرفعال </span>  @endif</td>
                                                    <td>
                                                        <span class="field_id hidden" id="{{$afterLoginFormField->id}}">ali</span>
                                                        <a class="btn btn-outline btn-circle dark btn-sm red deleteField" data-toggle="modal" href="#removeFieldModal"  ><i class="fa fa-trash-o"></i> حذف</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @endif
                                        ...
                                        <div class="modal fade" id="removeFieldModal" tabindex="-1" role="basic" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                        <h4 class="modal-title">حذف فیلد <span id="deleteFieldTitle"></span></h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <p> آیا مطمئن هستید؟ </p>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" data-dismiss="modal"  class="btn green" onclick="removeField()" >بله</button>
                                                    </div>
                                                    <!-- /.modal-content -->
                                                </div>
                                            </div>
