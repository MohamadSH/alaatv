                        ...
                        <div class="portlet light ">
                            <div class="portlet-title">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-helper"><a target="_blank" href="{{action("HomeController@index")}}">رفتن به صفحه ی اصلی</a></span>
                                </div>
                                <div class="actions">
                                        ...
                                        <div class="modal fade" id="removeSlideModal" tabindex="-1" role="basic" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                        <h4 class="modal-title">حذف اسلاید <span id="deleteSlideTitle"></span></h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <p> آیا مطمئن هستید؟ </p>
