...
@section("pageBar")
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>تولید کپن تخفیف تصادفی</span>
            </li>
        </ul>
    </div>
    ...
    <div class="panel panel-success">
        <div class="panel-body">
            {!! Form::open(['method'=>'POST' , 'action'=>'CouponController@generateRandomCoupon' , 'id'=>'couponGeneratorForm']) !!}
                <input type="hidden"  name="discounttype_id" value="1" >
                <input type="hidden"  name="description" value="تولید شده توسط {{Auth::user()->getfullName()}} برای تقدیر از گزارش خطای سایت" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <input name="validSinceDate" id="validSinceDateAlt" type="text" class="form-control hidden" disabled>
                    </div>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <input name="validTillDate" id="validTillDateAlt" type="text" class="form-control hidden" disabled>
                    </div>
                    <div class="col-md-5">
                ...
                <div class="alert alert-danger" id="dangerMessage" role="alert"><div class="serverMessaage"></div></div>
