        ...
        <div class="col-md-12">
            ...
            <div class="portlet box red" id="content-portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i>مدیریت محتوای آموزشی
                    </div>
                    <div class="tools">
                        <img class="hidden" id="content-portlet-loading"
            ...
            <div class="portlet box purple" id="assignment-portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i>مدیریت تمرین ها
                    </div>
                    <div class="tools">
                        <img class="hidden" id="assignment-portlet-loading"
                             src="{{Config::get('constants.ADMIN_LOADING_BAR_GIF')}}" alt="loading"
                             style="width: 50px;">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="btn-group">
                                    ...
                                    <a id="sample_editable_1_new" class="btn btn-outline purple" data-toggle="modal"
                                       href="#responsive-assignment"><i class="fa fa-plus"></i> افزودن تمرین </a>
                                    <!-- responsive modal -->
                                    <div id="responsive-assignment" class="modal fade" tabindex="-1" data-width="760">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" data-dismiss="modal" class="btn btn-outline dark"
                                                    id="assignmentForm-close">بستن
                                            </button>
                                            <button type="button" class="btn purple" id="assignmentForm-submit">ذخیره
                                            </button>
                                        </div>
                                    </div>
                                    @endpermission
            ...
            <div class="portlet box blue" id="consultation-portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i>مدیریت مشاوره ها
                    </div>
                    <div class="tools">
                        <img class="hidden" id="consultation-portlet-loading"
                             src="{{Config::get('constants.ADMIN_LOADING_BAR_GIF')}}" alt="loading"
                             style="width: 50px;">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group">
                                    ...
                                    <a id="sample_editable_2_new" class="btn btn-outline blue" data-toggle="modal"
                                       href="#responsive-consultation"><i class="fa fa-plus"></i> افزودن مشاوره </a>
                                    <!-- responsive modal -->
                                    <div id="responsive-consultation" class="modal fade" tabindex="-1" data-width="760">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" data-dismiss="modal" class="btn btn-outline dark"
                                                    id="consultationForm-close">بستن
                                            </button>
                                            <button type="button" class="btn blue" id="consultationForm-submit">ذخیره
                                            </button>
                                        </div>
                                    </div>
                                    @endpermission
            ...
            <div class="portlet box yellow-casablanca" id="question-portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i>مدیریت سؤالات مشاوره ای
                    </div>
                    <div class="tools">
                        <img class="hidden" id="question-portlet-loading"
            ...
            <div class="portlet box " style="background-color: #e04ea6" id="mbtiAnswer-portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs bg-font-dark"></i>لیست پاسخنامه های MBTI
                    </div>
                    <div class="tools">
                        <img class="hidden" id="mbtiAnswer-portlet-loading"
                             src="{{Config::get('constants.ADMIN_LOADING_BAR_GIF')}}" style="width: 50px;">
            ...
            <div class="portlet box eventResult-portlet" id="konkur96-portlet" style="background-color: #e04ea6">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs bg-font-dark"></i>لیست نتایج کنکور 96
                    </div>
                    <div class="tools">
                        <img class="hidden" id="konkurResult96-portlet-loading"
                             src="{{Config::get('constants.ADMIN_LOADING_BAR_GIF')}}" style="width: 50px;">
            ...
            <div class="portlet box eventResult-portlet" id="konkur97-portlet" style="background-color: #e04ea6">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs bg-font-dark"></i>لیست نتایج کنکور 97
                    </div>
                    <div class="tools">
                        <img class="hidden" id="konkurResult97-portlet-loading"
                             src="{{Config::get('constants.ADMIN_LOADING_BAR_GIF')}}" style="width: 50px;">
            ...
            <div class="portlet box eventResult-portlet" id="schoolRegister-portlet" style="background-color: #716c6f">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs bg-font-dark"></i>لیست پیش ثبت نام شریف
                    </div>
                    <div class="tools">
                        <img class="hidden" id="sharifRegisterResult-loading"
                             src="{{Config::get('constants.ADMIN_LOADING_BAR_GIF')}}" style="width: 50px;">
