        ...
        <div class="col-12">
            ...
            <div class="m-portlet m-portlet--head-solid-bg m-portlet--accent m-portlet--collapsed m-portlet--head-sm" m-portlet="true" id="content-portlet">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <img class="d-none" id="content-portlet-loading"
                        ...
                        <ul class="m-portlet__nav">
                            ...
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="fullscreen" class="m-portlet__nav-link m-portlet__nav-link--icon" id="content-expand"><i class="la la-expand"></i></a>
                            </li>
                            <li class="m-portlet__nav-item">
            ...
            <div class="m-portlet m-portlet--head-solid-bg m-portlet--info m-portlet--collapsed m-portlet--head-sm" m-portlet="true" id="assignment-portlet">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <img class="d-none" id="assignment-portlet-loading"
                             src="{{config('constants.ADMIN_LOADING_BAR_GIF')}}" alt="loading"
                             style="width: 50px;">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                            ...
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="fullscreen" class="m-portlet__nav-link m-portlet__nav-link--icon" id="assignment-expand"><i class="la la-expand"></i></a>
                            </li>
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="remove" class="m-portlet__nav-link m-portlet__nav-link--icon"><i class="la la-close"></i></a>
                            </li>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="btn-group">
                                    ...
                                    <a id="sample_editable_1_new"
                                       ...
                                       data-toggle="modal"
                                       href="#responsive-assignment"
                                       data-target="#responsive-assignment">
                                        <i class="fa fa-plus"></i> افزودن تمرین
                                    </a>
            ...
            <div class="m-portlet m-portlet--head-solid-bg m-portlet--primary m-portlet--collapsed m-portlet--head-sm" m-portlet="true" id="consultation-portlet">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <img class="d-none" id="consultation-portlet-loading"
                             src="{{config('constants.ADMIN_LOADING_BAR_GIF')}}" alt="loading"
                             style="width: 50px;">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                            ...
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="fullscreen" class="m-portlet__nav-link m-portlet__nav-link--icon" id="consultation-expand"><i class="la la-expand"></i></a>
                            </li>
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="remove" class="m-portlet__nav-link m-portlet__nav-link--icon"><i class="la la-close"></i></a>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    ...
                                    <a id="sample_editable_2_new" class="btn btn-outline blue" data-toggle="modal"
                                       href="#responsive-consultation" data-target="#responsive-consultation"><i class="fa fa-plus"></i> افزودن مشاوره </a>
            ...
            <div class="m-portlet m-portlet--head-solid-bg m-portlet--success m-portlet--collapsed m-portlet--head-sm" m-portlet="true" id="question-portlet">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <img class="d-none" id="question-portlet-loading"
                        ...
                        <ul class="m-portlet__nav">
                            ...
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="fullscreen" class="m-portlet__nav-link m-portlet__nav-link--icon" id="question-expand"><i class="la la-expand"></i></a>
                            </li>
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="remove" class="m-portlet__nav-link m-portlet__nav-link--icon"><i class="la la-close"></i></a>
                            </li>
            ...
            <div class="m-portlet m-portlet--head-solid-bg m-portlet--warning m-portlet--collapsed m-portlet--head-sm" m-portlet="true" id="mbtiAnswer-portlet">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <img class="d-none" id="mbtiAnswer-portlet-loading"
                             src="{{config('constants.ADMIN_LOADING_BAR_GIF')}}" style="width: 50px;">
                        <ul class="m-portlet__nav">
                            @permission((config('constants.LIST_MBTIANSWER_ACCESS')))
                            <li class="m-portlet__nav-item">
                            ...
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="fullscreen" class="m-portlet__nav-link m-portlet__nav-link--icon" id="mbtiAnswer-expand"><i class="la la-expand"></i></a>
                            </li>
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="remove" class="m-portlet__nav-link m-portlet__nav-link--icon"><i class="la la-close"></i></a>
                            </li>
                ...
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        ...
                        <ul class="m-portlet__nav">
                            @permission((config('constants.LIST_EVENTRESULT_ACCESS')))
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="reload" class="m-portlet__nav-link m-portlet__nav-link--icon reload" data-role="konkurResult96"><i class="la la-refresh"></i></a>
                            </li>
                            @endpermission
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="toggle" class="m-portlet__nav-link m-portlet__nav-link--icon"><i class="la la-angle-down"></i></a>
                            ...
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="fullscreen" class="m-portlet__nav-link m-portlet__nav-link--icon" id="konkurResult96-expand"><i class="la la-expand"></i></a>
                            </li>
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="remove" class="m-portlet__nav-link m-portlet__nav-link--icon"><i class="la la-close"></i></a>
                            </li>
            ...
            <div class="m-portlet m-portlet--head-solid-bg m-portlet--brand m-portlet--collapsed m-portlet--head-sm" m-portlet="true" id="konkur97-portlet">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <img class="d-none" id="konkurResult97-portlet-loading"
                             src="{{config('constants.ADMIN_LOADING_BAR_GIF')}}" style="width: 50px;">
                        <ul class="m-portlet__nav">
                            @permission((config('constants.LIST_EVENTRESULT_ACCESS')))
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="reload" class="m-portlet__nav-link m-portlet__nav-link--icon reload" data-role="konkurResult97"><i class="la la-refresh"></i></a>
                            </li>
                            @endpermission
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="toggle" class="m-portlet__nav-link m-portlet__nav-link--icon"><i class="la la-angle-down"></i></a>
                            ...
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="fullscreen" class="m-portlet__nav-link m-portlet__nav-link--icon" id="konkurResult97-expand"><i class="la la-expand"></i></a>
                            </li>
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="remove" class="m-portlet__nav-link m-portlet__nav-link--icon"><i class="la la-close"></i></a>
                            </li>
            ...
            <div class="m-portlet m-portlet--collapsed m-portlet--head-sm" m-portlet="true" id="schoolRegister-portlet">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <img class="d-none" id="sharifRegisterResult-loading"
                             src="{{config('constants.ADMIN_LOADING_BAR_GIF')}}" style="width: 50px;">
                        <ul class="m-portlet__nav">
                            @permission((config('constants.LIST_SHARIF_REGISTER_ACCESS')))
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="reload" class="m-portlet__nav-link m-portlet__nav-link--icon reload" data-role="sharifRegisterResult"><i class="la la-refresh"></i></a>
                            </li>
                            @endpermission
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="toggle" class="m-portlet__nav-link m-portlet__nav-link--icon"><i class="la la-angle-down"></i></a>
                            ...
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="fullscreen" class="m-portlet__nav-link m-portlet__nav-link--icon" id="sharifRegisterResult-expand"><i class="la la-expand"></i></a>
                            </li>
                            <li class="m-portlet__nav-item">
                                <a href="#" m-portlet-tool="remove" class="m-portlet__nav-link m-portlet__nav-link--icon"><i class="la la-close"></i></a>
                            </li>
