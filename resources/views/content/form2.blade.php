                    ...
                    <li class="list-group-item" style="font-size: small">
                        <div class="row margin-bottom-5">
                            <span class="badge badge-danger"
                                  dir="ltr"> {{basename($file->name, "." . pathinfo($file->name, PATHINFO_EXTENSION)) }}
                            </span>
                        </div>
                        <div class="input-group input-group-sm">
                            <span class="input-group-btn">
                                <a target="_blank" href = "{{action("Web\HomeController@download" , ["fileName"=>$file->uuid ])}}"
                                   class="btn blue-dark"><i class="fa fa-download"></i>
                                </a>
                            </span>
                            <span class="input-group-btn">
