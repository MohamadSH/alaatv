        ...
        <div class="portlet-body">
                        ...
                        <div class="widget-thumb text-uppercase margin-bottom-20 " style="background: #EFEFEF;">
                            ...
                            <div class="widget-thumb-wrap ">
                                ...
                                <div class="widget-thumb-body ">
                                    ...
                                    <span class="widget-thumb-body-stat @if($completionPercentage==100) font-green @endif"
                                          data-counter="counterup"
                                          data-value="{{(isset($completionPercentage))?$completionPercentage:0}}">0</span>
                                </div>
                            </div>
                        </div>
                        <!-- END WIDGET THUMB -->
                        ...
                        <ul class="ver-inline-menu tabbable margin-bottom-10">
                            <li class="active">
                                <a data-toggle="tab" href="#tab_1-1">
                                    <img src="/img/extra/person-icon-rs.png"> مشخصات فردی </a>
                                <span class="after"> </span>
                            </li>
                            @if(isset($userHasMedicalQuestions) && $userHasMedicalQuestions)
                                <li>
                                    <a data-toggle="tab" href="#tab_2-2">
                                        <img src="/img/extra/doctor-icon.svg" height="35px" width="35px"> اطلاعات پزشکی
                                    </a>
                                </li>
                            @endif
                            <li>
                                <a data-toggle="tab" href="#tab_3-3">
                                    <img src="/img/extra/education-icon-rs.png"> اطلاعات تحصیلی </a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                        <div class="tab-content">
                            <div id="tab_1-1" class="tab-pane active">
                                <div class="form-body margin-top-30">
                                    <div class="col-lg-6 col-md-6 col-sd-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                ...
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">@if(isset($user)){{$user->firstName}}@else
                                                        - @endif</text>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sd-6 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-lg-3 col-sd-3 col-xs-12">نام
                                                خانوادگی</label>
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                {{--{!! Form::text("lastName" , null , ["class"=>"form-control"]) !!}--}}
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">@if(isset($user)){{$user->lastName}}@else
                                                        - @endif</text>
                                                <span class="help-block"> </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sd-6 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-lg-3 col-sd-3 col-xs-12">کد
                                                ملی</label>
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                {{--                                                {!! Form::text("nationalCode" , null , ["class"=>"form-control" , "dir"=>"ltr"]) !!}--}}
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">@if(isset($user)){{$user->nationalCode}}@else
                                                        - @endif</text>
                                                <span class="help-block">  </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                @if(in_array("gender_id" , $lockedFields) || $completionPercentage == 100)
                                                    <text class="form-control-static"
                                                          style="margin-top:0px !important;">@if(isset($user->gender_id)){{$user->gender->name}}@else
                                                            - @endif</text>
                                                @else
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sd-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                ...
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">@if(isset($user)){{$user->mobile}}@else
                                                        - @endif</text>
                                                <span class="help-block">  </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sd-6 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-lg-3 col-sd-3 col-xs-12">شماره
                                                ثابت</label>
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                @if(in_array("phone" , $lockedFields)  || $completionPercentage == 100)
                                                    <text class="form-control-static"
                                                          style="margin-top:0px !important;">@if(isset($user->phone)){{$user->phone}}@else
                                                            - @endif</text>
                                                @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                @if($completionPercentage == 100)
                                                    <text class="form-control-static"
                                                          style="margin-top:0px !important;">{{(isset($parentsNumber["father"]))?$parentsNumber["father"]:"-"}}</text>
                                                @else
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sd-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                @if($completionPercentage == 100)
                                                    <text class="form-control-static"
                                                          style="margin-top:0px !important;">{{(isset($parentsNumber["mother"]))?$parentsNumber["mother"]:"-"}}</text>
                                                @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                @if(in_array("province" , $lockedFields)  || $completionPercentage == 100)
                                                    <text class="form-control-static"
                                                          style="margin-top:0px !important;">@if(isset($user->province)){{$user->province}}@else
                                                            - @endif</text>
                                                @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sd-9 col-xs-12">
                                                @if(in_array("city" , $lockedFields)  || $completionPercentage == 100)
                                                    <text class="form-control-static"
                                                          style="margin-top:0px !important;">@if(isset($user->city)){{$user->city}}@else
                                                            - @endif</text>
                                                @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                @if(in_array("address" , $lockedFields)  || $completionPercentage == 100)
                                                    <text class="form-control-static"
                                                          style="margin-top:0px !important;">@if(isset($user->address)){{$user->address}}@else
                                                            - @endif</text>
                                                @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sd-9 col-xs-12">
                                                @if(in_array("postalCode" , $lockedFields)  || $completionPercentage == 100)
                                                    <text class="form-control-static"
                                                          style="margin-top:0px !important;">@if(isset($user->postalCode)){{$user->postalCode}}@else
                                                            - @endif</text>
                                                @else
                                        ...
                                        <div class="form-group {{ $errors->has('photo') ? ' has-error' : '' }}">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail"
                                                    ...
                                                    <img @if(isset($user->photo)) src="{{ route('image', ['category'=>'1','w'=>'140' , 'h'=>'140' ,  'filename' =>  $user->photo ]) }}"
                                                         @endif  alt="عکس پروفایل"/>
                                                </div>
                            ...
                            <div id="tab_2-2" class="tab-pane">
                                <div class="form-body margin-top-30">
                                    <p class="bold">لطفا در مواردی که مشکل و یا توضیحی ندارید ، فیلد مربوطه را خالی
                                        بگذارید</p>
                                    <div class="col-lg-3 col-md-3 col-sd-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            @if($completionPercentage == 100)
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">{{(isset($user->bloodtype_id))?$user->bloodtype->name:"-"}}</text>
                                            @else
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sd-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            @if($completionPercentage == 100)
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">{{(isset($user->allergy))?$user->allergy:"-"}}</text>
                                            @else
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sd-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            @if($completionPercentage == 100)
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">{{(isset($user->medicalCondition))?$user->medicalCondition:"-"}}</text>
                                            @else
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sd-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            @if($completionPercentage == 100)
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">{{(isset($user->diet))?$user->diet:"-"}}</text>
                                            @else
                                ...
                                <div class="form-body margin-top-30">
                                    <div class="col-lg-4 col-md-4 col-sd-4 col-xs-12">
                                        <div class="form-group" style="padding: 0px 5px 5px 5px;">
                                            ...
                                            @if(in_array("major_id" , $lockedFields)  || $completionPercentage == 100)
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">@if(isset($user->major_id)){{$user->major->name}}@else
                                                        - @endif</text>
                                            @else
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sd-4 col-xs-12">
                                        <div class="form-group" style="padding: 0px 5px 5px 5px;">
                                            ...
                                            @if($completionPercentage == 100)
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">@if(isset($user->grade_id)){{$user->grade->displayName}}@else
                                                        - @endif</text>
                                            @else
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sd-4 col-xs-12">
                                        <div class="form-group" style="padding: 0px 5px 5px 5px;">
                                            ...
                                            @if(in_array("school" , $lockedFields)  || $completionPercentage == 100)
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">@if(isset($user->school)){{$user->school}}@else
                                                        - @endif</text>
                                            @else
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sd-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            @if($completionPercentage == 100)
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">{{(isset($customerExtraInfo[1]->info))?$customerExtraInfo[1]->info:"-"}}</text>
                                            @else
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sd-12 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label">در چه درس هایی احساس ضعف می کنید ؟ (توضیح
                                                بدید)</label>
                                            {!! Form::hidden('customerExtraInfoQuestion[2]','در چه درس هایی احساس ضعف می کنید ؟ (توضیح بدید)') !!}
                                            @if($completionPercentage == 100)
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">{{(isset($customerExtraInfo[2]->info))?$customerExtraInfo[2]->info:"-"}}</text>
                                            @else
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sd-12 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label" style="text-align: right">ساعت و نحوه مطالعات
                                                شما تا الان چطور بوده؟ (درسهای پیش 1 ، پایه و پیش 2) هر کدوم رو چه مقدار
                                                مطالعه کردید و وضعیت خودتون رو کامل توضیج بدید</label>
                                            ...
                                            @if($completionPercentage == 100)
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">{{(isset($customerExtraInfo[3]->info))?$customerExtraInfo[3]->info:"-"}}</text>
                                            @else
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sd-12 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label">توضیحات تکمیلی که نیازه ما بدونیم(که فکر می
                                                کنید در شناخت وضعیت تحصیلی شما مفیده)</label>
                                            {!! Form::hidden('customerExtraInfoQuestion[4]','توضیحات تکمیلی که نیازه ما بدونیم(که فکر می کنید در شناخت وضعیت تحصیلی شما مفیده)') !!}
                                            @if($completionPercentage == 100)
                                                <text class="form-control-static"
                                                      style="margin-top:0px !important;">{{(isset($customerExtraInfo[4]->info))?$customerExtraInfo[4]->info:"-"}}</text>
                                            @else
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sd-12 col-xs-12">
                                        <p class="text-justify">
                                            شما می توانید کارنامه های آزمون هایی که شرکت نموده اید و یا هر فایل دیگری که
                                            فکر می کنید به مشاورین در هدایت تحصیلی شما کمک می کند را در اینجا آپلود
                                            نمایید
                                            <br>
                                            <span class="bold">                                            لطفا در صورت امکان تمام این فایل ها را به صورت <label
                                                        class="font-yellow-gold bold">zip</label> یا <label
                                                        class="font-yellow-gold bold">rar</label> درآورده و یکجا آپلود نمایید</span>
                                        </p>
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                    @if($completionPercentage == 100)
                        <text class="form-control-static"
                              style="margin-top:0px !important;">{{(isset($customerExtraInfo[0]->info))?$customerExtraInfo[0]->info:"-"}}</text>
                    @else
