...
@section("content")
    ...
    <div class="portlet box blue-hoki">
        <div class="portlet-title" style="background: #404040 !important">
            <div class="caption">
                 شما در {{$userProduct}} ثبت نام نموده اید</div>
            <div class="actions">
                <button type="submit" class="btn btn-sm" style="background: #67BCDB !important;">
                    <i class="fa fa-pencil"></i> ذخیره </button>
            </div>
        </div>
                    ...
                    <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                        <div class="m-heading-1 border-blue m-bordered">
                            <p class="text-justify">
                                کاربر گرامی توجه داشته باشید که پس از تکمیل اطلاعات به میزان ۱۰۰ درصد ، فرم <strong class="font-red">قفل</strong> خواهد شد و قادر به اطلاح اطلاعات نخواهید بود. لذا خواهشمند است اطلاعات را در کمال صحت و دقت وارد نمایید.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            @if(isset($userHasMedicalQuestions) && $userHasMedicalQuestions)
                                <li>
                                    <a data-toggle="tab" href="#tab_2-2">
                                        <img src="/img/extra/doctor-icon.svg" height="35px" width="35px"> اطلاعات پزشکی </a>
                                </li>
                            @endif
                            <li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sd-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                ...
                                                <text class="form-control-static" style="margin-top:0px !important;" >@if(isset($user)){{$user->firstName}}@else - @endif</text>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sd-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                ...
                                                <text class="form-control-static" style="margin-top:0px !important;" >@if(isset($user)){{$user->lastName}}@else - @endif</text>
                                                <span class="help-block"> </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sd-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                ...
                                                <text class="form-control-static" style="margin-top:0px !important;" >@if(isset($user)){{$user->nationalCode}}@else - @endif</text>
                                                <span class="help-block">  </span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                @if(in_array("gender_id" , $lockedFields) || $completionPercentage == 100)
                                                    <text class="form-control-static" style="margin-top:0px !important;" >@if(isset($user->gender_id)){{$user->gender->name}}@else - @endif</text>
                                                @else
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sd-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                ...
                                                <text class="form-control-static" style="margin-top:0px !important;" >@if(isset($user)){{$user->mobile}}@else - @endif</text>
                                                <span class="help-block">  </span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                @if(in_array("phone" , $lockedFields)  || $completionPercentage == 100)
                                                    <text class="form-control-static" style="margin-top:0px !important;" >@if(isset($user->phone)){{$user->phone}}@else - @endif</text>
                                                @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                @if(in_array("province" , $lockedFields)  || $completionPercentage == 100)
                                                    <text class="form-control-static" style="margin-top:0px !important;" >@if(isset($user->province)){{$user->province}}@else - @endif</text>
                                                @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sd-9 col-xs-12">
                                                @if(in_array("city" , $lockedFields)  || $completionPercentage == 100)
                                                    <text class="form-control-static" style="margin-top:0px !important;" >@if(isset($user->city)){{$user->city}}@else - @endif</text>
                                                @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                @if(in_array("address" , $lockedFields)  || $completionPercentage == 100)
                                                    <text class="form-control-static" style="margin-top:0px !important;" >@if(isset($user->address)){{$user->address}}@else - @endif</text>
                                                @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sd-9 col-xs-12">
                                                @if(in_array("postalCode" , $lockedFields)  || $completionPercentage == 100)
                                                    <text class="form-control-static" style="margin-top:0px !important;" >@if(isset($user->postalCode)){{$user->postalCode}}@else - @endif</text>
                                                @else
                                ...
                                <div class="form-body margin-top-30">
                                    <div class="col-lg-4 col-md-4 col-sd-4 col-xs-12">
                                        <div class="form-group" style="padding: 0px 5px 5px 5px;">
                                            ...
                                            @if(in_array("major_id" , $lockedFields)  || $completionPercentage == 100)
                                                <text class="form-control-static" style="margin-top:0px !important;" >@if(isset($user->major_id)){{$user->major->name}}@else - @endif</text>
                                            @else
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sd-4 col-xs-12">
                                        <div class="form-group" style="padding: 0px 5px 5px 5px;">
                                            ...
                                            @if($completionPercentage == 100)
                                                <text class="form-control-static" style="margin-top:0px !important;" >@if(isset($user->grade_id)){{$user->grade->displayName}}@else - @endif</text>
                                            @else
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sd-4 col-xs-12">
                                        <div class="form-group" style="padding: 0px 5px 5px 5px;">
                                            ...
                                            @if(in_array("school" , $lockedFields)  || $completionPercentage == 100)
                                                <text class="form-control-static" style="margin-top:0px !important;" >@if(isset($user->school)){{$user->school}}@else - @endif</text>
                                            @else
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sd-12 col-xs-12">
                                        ...
                                        <div class="form-group {{ $errors->has('file') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sd-9 col-xs-12">
                                                ...
                                                <strong>@if ($errors->has('file')){{ $errors->first('file') }} @else   فرمت های مجاز: jpg,jpeg,png,pdf,zip,rar @endif</strong>
                                            </span>
                                            </div>
                                        ...
                                        <ul>
                                            ...
                                            @forelse($orderFiles as $orderFile)
                                                ...
                                                <li><a target="_blank"  href="{{action("HomeController@download" , ["content"=>"فایل سفارش","fileName"=>$orderFile->file ])}}">{{$orderFile->file}}</a></li>
                                            @empty
