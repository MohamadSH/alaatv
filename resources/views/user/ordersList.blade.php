...
@section('content')
                ...
                <div class = "m-portlet__body">
                    <div class = "tab-content">
                                        ...
                                        <div class = "table-responsive">
                                            ...
                                            <table class = "table m-table m-table--head-bg-success table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>مبلغ(تومان)</th>
                                                    <th class = "d-none d-md-table-cell d-lg-table-cell">پرداخت شده(تومان)</th>
                                                ...
                                                @foreach($orders as $orderKey=>$order)
                                                    <tr>
                                                        ...
                                                        <td class = "d-none d-md-table-cell d-lg-table-cell text-center">
                                                            ...
                                                            @elseif(isset($order->paymentstatus->id) && $order->paymentstatus->id == config("constants.PAYMENT_STATUS_UNPAID"))
                                                                ...
                                                                @if(isset($order->orderstatus->id) &&
                                                                    ...
                                                                    <button type = "button" class = "btn btn-sm m-btn--pill m-btn--air btn-accent btnOnlinePayment" data-order-id = "{{$order->id}}" data-transaction-id = "-" data-cost = "{{$order->debt}}">
                                                                        پرداخت
                                                                    </button>
                                                                @endif
                                                            @elseif(
                                                        ...
                                                        <td class = "text-center">
                                                            <a onclick = "event.preventDefault();" data-order-key = "{{ $orderKey  }}" class = "btn btn-outline-accent m-btn m-btn--icon btn-lg m-btn--icon-only m-btn--pill m-btn--air btnViewOrderDetailes">
                                            ...
                                            <!--begin::Modal-->
                                            <div id = "orderDetailesModal" class = "modal fade" tabindex = "-1" {{--role="dialog"--}}{{--aria-labelledby="exampleModalLabel"--}}{{--aria-hidden="true"--}}data-backdrop = "static" data-keyboard = "false">
                                                                            ...
                                                                            <div class = "alert alert-success" role = "alert">
                                                                                <table class = "table table-sm m-table">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class = "orderDetailes-usedBonSum"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>تعداد بن اضافه شده به شما از این سفارش:</td>
                                                                                        <td class = "orderDetailes-addedBonSum"></td>
                                                                                    </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </div>
                        ...
                        <div class = "tab-pane" id = "user-paymentsList" role = "tabpanel">
                            ...
                            <div class = "m-accordion m-accordion--bordered" id = "m_accordion_transaction" role = "tablist">
                            @foreach($transactions as $key=>$transactionArray)
                                <!--begin::Item-->
                                    <div class = "m-accordion__item m-accordion__item--success11">
                                        <div class = "m-accordion__item-head collapsed" role = "tab" id = "m_accordion_transaction_item_{{ $key }}_head" data-toggle = "collapse" href = "#m_accordion_transaction_item_{{ $key }}_body" aria-expanded = "false">
                                        ...
                                        <div class = "m-accordion__item-body collapse" id = "m_accordion_transaction_item_{{ $key }}_body" role = "tabpanel" aria-labelledby = "m_accordion_transaction_item_{{ $key }}_head" data-parent = "#m_accordion_transaction">
    ...
    <!--begin::Modal-->
    <div id = "onlinePaymentModal" class = "modal fade" tabindex = "-1" {{--role="dialog"--}}{{--aria-labelledby="exampleModalLabel"--}}{{--aria-hidden="true"--}}data-backdrop = "static" data-keyboard = "false">
        <div class = "modal-dialog modal-lg" role = "document">
            <div class = "modal-content">
                <div class = "modal-header">
                    <h5 class = "modal-title" id = "exampleModalLabel">
