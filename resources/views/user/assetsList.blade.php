                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="dashboard-stat2 ">
                            ...
                            <div class="progress-info" style="text-align: justify ; color: #768086;">
                                ابتدا نرم افزار ADM رو باز کنید، از تو منوی نرم افزار browser یا همون مرورگر رو انتخاب
                                کنید.
                                بعد بزنید
                                <a href="https://k96.ir">k96.ir</a>
                                و ادامه ی راه شبیه کامپیوتر است.
                                فقط دقت کنید با گوشی اگه می خواهید با ADM دانلود کنید با مرورگر دیگه سایت رو باز نکنید و
                                حتما از مرورگر خود ADM استفاده کنید.
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="mt-element-list">
                                                <div class="mt-list-head list-simple font-white bg-red-flamingo-opacity">
                                                    <div class="list-head-title-container">
                                                        <h4 class="list-title"
                                                            style="line-height: inherit">{{$productPamphlets["productName"]}}</h4>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-6" style="margin-bottom: 10px">
                                            <div class="mt-element-list">
                                                <div class="mt-list-head list-simple font-white bg-blue"
                                                    ...
                                                    <div class="list-head-title-container">
                                                        <h4 class="list-title"
                                                            style="line-height: inherit">{{$productVideos["productName"]}}</h4>
                                                    </div>
                                                </div>
                                                <div class="mt-list-container list-simple scroller"
                                                     style="height: 200px">
