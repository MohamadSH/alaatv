                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if(isset($userEventReport->comment) && strlen($userEventReport->comment)>0)
                                                ...
                                                <text class="form-control-static bold"
                                                      style="font-size: medium ; color:green;text-align: justify"> {{$userEventReport->comment}} </text>
                                            @else
                                ...
                                @else
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <div class="form-group {{ $errors->has('rank') ? ' has-error' : '' }}">
                                                        <div class="input-icon"><i class="fa fa-pencil"
                                                                                   aria-hidden="true"></i>
                                                            <input id="rank" class="form-control placeholder-no-fix"
                                                                   type="text" value="{{old("rank")}}" name="rank"
                                                                   placeholder="رتبه شما(الزامی)"/>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group {{ $errors->has('participationCode') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="input-icon"><i class="fa fa-pencil"
                                                                                   aria-hidden="true"></i>
                                                            <input id="participationCode"
                                                                   class="form-control placeholder-no-fix" type="text"
                                                                   value="{{old("participationCode")}}"
                                                                   name="participationCode"
                                                                   placeholder="شماره داوطلبی شما"/>
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <label class="control-label" for="reportFile">فایل
                                                        کارنامه(الزامی)</label>
                                        ...
                                        <div class="row margin-top-20">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="icheck-list">
                                                            <label class="font-red bold">
                                                                ...
                                                                انتشار رتبه خود را در سایت می دهم </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="custom-alerts alert alert-info fade in"
                                                     style="text-align: justify ; background-color: #d9edf7 ; color:#31708f">
                                                    <strong>توضیح: </strong> با زدن تیک بالا شما به ما اجازه می دهید تا
                                                    رتبه ی شما را در سایت آلاء اعلام کنیم. اگر تمایلی به این کار ندارید
                                                    می توانید این تیک را نزنید. بدیهی است که با زدن تیک فوق ، درج شماره
                                                    داوطلبی الزامی خواهد بود .
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                                ...
                                                @if(!isset(Auth::user()->firstName))
                                                    <div class="col-md-6">
                                                        <div class="form-group {{ $errors->has('firstName') ? ' has-error' : '' }}">
                                                            <label for="firstName" class="control-label">نام:<span
                                                ...
                                                @if(!isset(Auth::user()->major->id))
                                                    <div class="col-md-6">
                                                        <div class="form-group {{ $errors->has('major_id') ? ' has-error' : '' }}">
                                                            <label for="major_id" class="control-label">رشته:<span
                                                                        class="required" aria-required="true"> * </span></label>
