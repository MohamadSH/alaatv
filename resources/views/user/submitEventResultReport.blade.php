...
@section("title")
    <title>تخته خاک|کارنامه سراسری 96</title>
@endsection
                                            ...
                                            <div class="row margin-top-20">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="icheck-list">
                                                                <label class="font-red bold">
                                                                    <input name="enableReportPublish" type="checkbox" class="icheck" data-checkbox="icheckbox_flat-green"> اجازه انتشار رتبه خود را در سایت می دهم </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div  class="custom-alerts alert alert-info fade in" style="text-align: justify ; background-color: #d9edf7 ; color:#31708f">
                                                        <strong>توضیح: </strong> با زدن تیک بالا شما به ما اجازه می دهید تا رتبه ی شما را در سایت تخته خاک اعلام کنیم. اگر تمایلی به این کار ندارید می توانید این تیک را نزنید. بدیهی است که با زدن تیک فوق ، درج شماره داوطلبی الزامی خواهد بود .
                                                    </div>
                                                </div>
                                            </div>
                                        <hr>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group {{ $errors->has('firstName') ? ' has-error' : '' }}">
                                                                <label for="firstName" class="control-label">نام:<span class="required" aria-required="true"> * </span></label>
                                                                <div class="input-icon"><i class="fa fa-pencil" aria-hidden="true"></i>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group {{ $errors->has('lastName') ? ' has-error' : '' }}">
                                                                <label for="firstName" class="control-label">نام خانوادگی:<span class="required" aria-required="true"> * </span></label>
                                                                <div class="input-icon"><i class="fa fa-pencil" aria-hidden="true"></i>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group {{ $errors->has('major_id') ? ' has-error' : '' }}">
                                                            <label for="major_id" class="control-label">رشته:<span class="required" aria-required="true"> * </span></label>
