        ...
        <div class="col-md-12">
            <div class="portlet light">
                <div class="portlet-body">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12 col-md-12" >
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            ...
                                            <input name="sinceDate" id="sinceDateAlt" type="text" class="form-control hidden" >
                                        </div>
                                        <label class="control-label" style="float: right;">تا تاریخ</label>
                                        <div class="col-md-3 col-xs-12">
                                            <input id="tillDate" type="text" class="form-control" >
                                            <input name="tillDate" id="tillDateAlt" type="text" class="form-control hidden" >
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-12 col-md-12 col-sd-12">
                                        ...
                                        <img class="hidden" id="employeeTimeSheet-portlet-loading" src="{{Config::get("constants.FILTER_LOADING_GIF")}}" alt="loading" width="5%" >

                                    </div>
                                </div>
                                <div class="form-group" >
                                    <div class="col-lg-12 col-md-12 col-sd-12">
                                        <h5 class="bold">جمع کل اضافه کاری در بازه انتخاب شده:  <span class="font-blue" dir="ltr" id="sumWorkSheet"></span></h5>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sd-12">
                                        <h5 class="bold">جمع کل ساعت کاری در بازه انتخاب شده:  <span class="font-blue" dir="ltr" id="sumRealWorkTime"></span></h5>
                                    </div>
                                </div>
                            </div>
                            {!! Form::close() !!}
                    ...
                    <div id="deleteEmployeetimesheetConfirmationModal" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" data-dismiss="modal"  class="btn green" onclick="removeEmployeetimesheet()">بله</button>
                        </div>
                    </div>
                    {{--@endpermission--}}
