<div class="col-md-12">
    <div class="form-group">
        ...
        <div class="col-md-8">
            <button type="submit" class="btn btn-success btn-sm  pull-right"><i class="fa fa-check"></i> ذخیره اطلاعات</button>
        </div>
        @else
...
<div class="col-md-5 col-sm-5">
        <div class="form-group">
            ...
            @else
                <label class=" col-md-2 col-sm-2 control-label" for="userBeginTime"  style="text-align: center">شروع شیفت:</label>
