            ...
            <div class="col-lg-4 col-md-6">
                <div class="c-body">
                    ...
                    <div class="c-section" style="text-align: right">
                        ...
                        <p>
                            @if(isset($wSetting->branches->main->address->city)){{$wSetting->branches->main->address->city}} ، @endif @if(isset($wSetting->branches->main->address->street)) {{$wSetting->branches->main->address->street}}
                            <br>
                            @endif
                            @if(isset($wSetting->branches->main->address->avenue)){{$wSetting->branches->main->address->avenue}}
                            <br>
                            @endif
                            @if(isset($wSetting->branches->main->address->extra)){{$wSetting->branches->main->address->extra}} ، @endif @if(isset($wSetting->branches->main->address->plateNumber)){{$wSetting->branches->main->address->plateNumber}}@endif
                        </p>
                    </div>
                    <div class="c-section" style="text-align: right;direction: ltr">
                        ...
                        <p dir="rtl">
                            {{$contact->number}}@if(strlen($contact->description)>0) -  {{$contact->description}}@endif
                        </p>
                        @endforeach
                    </div>
            ...
            <div class="col-md-6">
                <div class="c-contact">
                    <div class="c-content-title-1">
                        ...
                        <p class="c-font-lowercase">شما می توانید برای ارتباط با ما به آدرس دبیرستان مراجعه نموده و یا با شماره تلفن دبیرستان تماس حاصل فرمایید. همچنین می توانید از طریق فرم زیر پیام ، نظر و یا پیشنهاد خود را برای ما ارسال نمایید</p>
                    </div>
