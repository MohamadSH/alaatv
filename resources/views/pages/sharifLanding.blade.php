                                ...
                                <div class="row">
                                    <div class="col text-center">
                                        <h3 class="text-center">
                                            <a href="{{ action("Web\ShopPageController") }}" class="m-link"><span
                                                    class="m--font-primary">👈دبیرستان دانشگاه صنعتی شریف در سال 1383 تاسیس و زیر نظر دانشگاه صنعتی شریف فعالیت خود را آغاز کرد. فعالیت های آموزشی آلاء با نظارت دبیرستان دانشگاه شریف انجام می شود.👉</span></a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
