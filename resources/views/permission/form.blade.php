...
@else
    ...
    <div class = "col-md-8 col-md-offset-2">
        <p>
            ...
            <span class="form-control-feedback" id = "permissionNameAlert">
                <strong></strong>
            </span>
        </p>
        ...
        <p>
            ...
            <span class="form-control-feedback" id = "permissionDisplayNameAlert">
                <strong></strong>
            </span>
        </p>
    </div>
    ...
    <div class = "col-md-8 col-md-offset-2">
        <p>
            ...
            <span class="form-control-feedback" id = "permissionDescriptionAlert">
                <strong></strong>
            </span>
        </p>
    </div>
