...
@foreach($permissions as $permission)
    <tr>
        <th></th>
        <td>@if(isset($permission->name) && strlen($permission->name)>0 ) {{ $permission->name }}  @else
        ...
        <td>
            <div class = "btn-group">
                ...
                <ul class = "dropdown-menu" role = "menu">
                    ...
                    @endpermission @permission((config('constants.REMOVE_PERMISSION_ACCESS')))
                    <li>
                ...
                <!-- static -->@permission((config('constants.REMOVE_PERMISSION_ACCESS')))
                <!--begin::Modal-->
