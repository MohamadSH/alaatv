...
<div class = "form-body">
    ...
    <div class = "form-group ">
        <div class = "row">
            ...
            <div class = "col-md-2 {{ $errors->has('orderstatus_id') ? ' has-error' : '' }}">
            ...
            <div class = "col-md-3 {{ $errors->has('paymentstatus_id') ? ' has-error' : '' }}">
    ...
    <div class = "form-group {{ $errors->has('managerDescription') ? ' has-error' : '' }}">
        <div class = "row">
    ...
    <div class = "form-group {{ $errors->has('customerDescription') ? ' has-error' : '' }}">
        <div class = "row">
