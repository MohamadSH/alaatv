    ...
    <tr>
        ...
        <td>
            <div class="btn-group">
                ...
                <a target="_blank" class="btn btn-success" href="{{action("OrderController@edit" , $order)}}"><i class="fa fa-pencil"></i> اصلاح </a>
                @endpermission
        ...
        <td>@if($order->successfulTransactions->isEmpty())
            ...
            @else
                ...
                @foreach($order->successfulTransactions as $successfulTransaction)
                    <a target="_blank" href="{{action("TransactionController@edit" ,$successfulTransaction )}}" class="btn btn-xs blue-sharp btn-outline  sbold">اصلاح</a>
                    @if($successfulTransaction->getGrandParent() !== false)<a target="_blank" href="{{action("TransactionController@edit" ,$successfulTransaction->getGrandParent() )}}" class="btn btn-xs blue-sharp btn-outline  sbold">رفتن به تراکنش والد</a>@endif
        ...
        <td>@if($order->pendingTransactions->isEmpty())
            ...
            @else
                ...
                @foreach($order->pendingTransactions as $pendingTransaction)
                    <a target="_blank" href="{{action("TransactionController@edit" ,$pendingTransaction )}}" class="btn btn-xs blue-sharp btn-outline  sbold">اصلاح</a>
        ...
        <td>@if($order->unpaidTransactions->isEmpty())
            ...
            @else
                ...
                @foreach($order->unpaidTransactions as $unpaid)
                    <a target="_blank" href="{{action("TransactionController@edit" ,$unpaid )}}" class="btn btn-xs blue-sharp btn-outline  sbold">اصلاح</a>
