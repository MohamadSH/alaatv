                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase"> اصلاح محصول سفارش  @if(!isset($orderproduct->order->user->firstName) && !isset($orderproduct->order->user->lastName)) کاربر ناشناس @else @if(isset($orderproduct->order->user->firstName)){{$orderproduct->order->user->firstName}} @endif @if(isset($orderproduct->order->user->lastName)) {{$orderproduct->order->user->lastName}} @endif @endif</span>
                        </div>
                        <div class="actions">
                            <div class="btn-group">
                                <a class="btn btn-sm dark dropdown-toggle" href="{{action("OrderController@edit" , $orderproduct->order)}}" > بازگشت
                                    <i class="fa fa-angle-left"></i>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <h4 class="bold " style="padding-bottom: 2%"><i class="fa fa-plus-square-o" aria-hidden="true"></i> افزودن خدمات</h4>
