        ...
        <div class="col-md-12">
                ...
                <div class="portlet-title tabbable-line">
                    <div class="caption caption-md">
                        ...
                        <span class="caption-subject font-blue-madison bold uppercase">@if(strcmp($pageMode , "takeExam") == 0) شرکت در آزمون MBTI @elseif(isset($mbtiAnswer)) مشاهده پاسخنامه MBTI  @if(!isset($mbtiAnswer->user->firstName) && !isset($mbtiAnswer->user->lastName)) کاربر ناشناس @else @if(isset($mbtiAnswer->user->firstName)) {{$mbtiAnswer->user->firstName}} @endif @if(isset($mbtiAnswer->user->lastName)) {{$mbtiAnswer->user->lastName}} @endif @endif @endif</span>
                    </div>
                </div>
                        ...
                        @else
                            ...
                            <div class="row margin-top-10">
                                ...
                                <div class="col-md-6 alert alert-danger" id="numberOfQuestionsMessage" style="text-align: center" >
                                    <strong> شما به <span id="answeredQuestionsCount"></span> سؤال از {{Config::get('constants.MBTI_NUMBER_OF_QUESTIONS')}} سؤال پاسخ داده اید </strong></div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 ">
                                    ...
                                    <div class="portlet box blue-hoki">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-question fa-3x" aria-hidden="true"></i>سؤالات آزمون</div>
                                        </div>
                                        <div class="portlet-body">
                                                            ...
                                                            <td>{{$key}} - {{$question}}
                                                                <div class="mt-radio-inline">
                                                                    <label class="mt-radio">
                                                                        <input class="multiChoice" type="radio" name="question{{$key}}" value="{{(($key-1)*3) + 1}}" /> ابدا اینطور نیستم
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="mt-radio">
                                                                        <input class="multiChoice" type="radio" name="question{{$key}}" value="{{(($key-1)*3) + 2}}" /> تا اندازه ای اینطور هستم
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="mt-radio">
                                                                        <input class="multiChoice" type="radio" name="question{{$key}}" value="{{(($key++-1)*3) + 3}}" /> کاملا اینطور هستم
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
