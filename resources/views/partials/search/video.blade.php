            ...
            @foreach($items as $content)
                <div class="cbp-item">
                    <div class="cbp-caption">
                        <div class="cbp-caption-defaultWrap">
                            <img src="{{$content->thumbnail}}"
                                 alt="@if(isset($content->name[0])){{$content->name}} @endif"></div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                                    <a href="{{action("ContentController@show" , $content)}}"
                                       class="cbp-l-caption-buttonLeft btn red uppercase ">تماشای فیلم</a>
                    ...
                    <div class="cbp-l-grid-projects-title text-center" style="font-size: small">
                        <a href="{{action("ContentController@show" , $content)}}">
                            @if(isset($content->name[0])){{$content->name}}@else <span
