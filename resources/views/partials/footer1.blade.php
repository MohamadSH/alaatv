...
{{--                    <li class="m-nav__item">
                    ...
                    <li class="m-nav__item">
                        <a onclick='window.open("https://trustseal.enamad.ir/Verify.aspx?id=125806&amp;p=gCsnIb3IATIJnVIY", "Popup","toolbar=no, location=no, statusbar=no, menubar=no, scrollbars=1, resizable=0, width=580, height=600, top=30")'  data-toggle="m-tooltip" title="نماد اعتماد الکترونیکی" data-placement="top">
                            <img class="lazy-image" src="https://cdn.alaatv.com/loder.jpg?w=1&h=1" data-src="/acm/image/enamad.png" alt="enamad.ir" style='cursor:pointer' data-name="enamad" width="56" height="46">
                        </a>
                    </li>
