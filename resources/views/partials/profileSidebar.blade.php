...
<div class="portlet light profile-sidebar-portlet ">
    ...
    <div class="profile-userpic">
        ...
        @if(isset($withPhotoUpload) && $withPhotoUpload)
            <div class="row text-center margin-top-10">
                {!! Form::open(['action' => ['UserController@update' , Auth::user()]  , 'id'=>'profilePhotoAjaxForm' ]) !!}
    ...
    @if(isset($withRegisterationDate) && $withRegisterationDate)
        <div class="profile-usertitle">
            <div class="profile-usertitle-name">@if(!isset($user->firstName) && !isset($user->lastName)) کاربر
                ناشناس @else @if(isset($user->firstName)) {{$user->firstName}} @endif @if(isset($user->lastName)){{$user->lastName}} @endif @endif</div>
            ...
            @if(!$user->hasVerifiedMobile() )
                <div class="margin-top-20 profile-desc-link">
                    <div class="form-group form-md-line-input">
                        ...
                        <fieldset
                                class="hasRequestedVerificationCode {{(is_null($mobileVerificationCode))?"hidden":""}}">
