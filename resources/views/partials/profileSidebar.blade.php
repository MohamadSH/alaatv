            ...
            <div class = "m-portlet__head-caption">
                <div class = "m-portlet__head-action">
                    ...
                    @if(isset($withPhotoUpload) && $withPhotoUpload)
                        ...
                        <button type="submit" id="uploadProfilePhotoAjaxSubmit" class = "btn btn-sm m-btn--pill m-btn--gradient-from-info m-btn--gradient-to-warning submitProfilePic" style = "display: none;">
                            ثبت
                        </button>
        ...
        <div class = "m-portlet__body">
            <div class = "m-widget19">
                <div class = "m-widget19__pic m-portlet-fit--top m-portlet-fit--sides" style = "min-height-: 286px">
                    ...
                    <input type = "file" id = "UserProfilePhoto" accept = ".jpg,.gif,.png">
