...
{{--                {!! Form::submit('بارگذاری', ['class' => 'btn blue' , 'id'=>'uploadProfilePhotoAjaxSubmit' , 'style'=>'display:none' ]) !!}--}}
                ...
                <button type="button"
                        id="btnEditUserPhoto"
                        class="btn btn-sm m-btn--pill btn-info btnEditProfilePic"
                        data-toggle="m-tooltip"
                        {{--data-placement="left"--}}
                        data-original-title="حجم عکس حداکثر 500 کیلوبایت و فرمت آن jpg یا png باشد">
                    ویرایش
                </button>
    ...
    <div class="m-portlet__body">
        <div class="m-widget19">
            <div class="m-widget19__pic m-portlet-fit--top m-portlet-fit--sides" style="min-height-: 286px">
                ...
                <img @if(!isset($user->photo))  src="{{ route('image', ['category'=>'1','w'=>'150' , 'h'=>'150' ,  'filename' => $user->photo ]) }}"
                     @else
                     src="./assets/app/media/img/users/user-avatar.png"
                     @endif
                     class="imgUserProfileImage" id="profilePhoto" alt="عکس پروفایل">
...
{{--                                                                    {!! Form::file('photo' , ['id'=>'profilePhotoFile' , 'data-action'=>action("Web\UserController@updateProfile")]) !!}--}}
                    ...
                    <a href="javascript:" class="close fileinput-exists" data-dismiss="fileinput"
                       id="profilePhotoAjaxFileInputClose"> </a>
                </div>
                <img src="/img/loading-spinner-default.gif" style="width: 15px; display: none"
                     id="profilePhotoAjaxLoadingSpinner">
                {!! Form::close() !!}
            </div>
            ...
            {{--<div class="row">--}}
                ...
                {{--<div class="col-md-4">--}}
                    {{--<div class="easy-pie-chart">--}}
                        {{--@if(isset($userCompletion))--}}
                            {{--<div class="number @if($userCompletion < 50) bounce @elseif($userCompletion >= 50 && $userCompletion < 90) transactions @elseif((int)$userCompletion >= 90) visits @endif"--}}
                                 {{--data-percent="{{ $userCompletion }}">--}}
