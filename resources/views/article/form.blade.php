                    ...
                    <div class = "col-md-6 left">
                        <div class = "fileinput fileinput-new" data-provides = "fileinput">
                            <div class = "fileinput-new thumbnail" style = "width: 200px; height: 150px;">
                                <img src = "{{isset($article) ? route('image', [ 'category'=>'8','w'=>'140' , 'h'=>'140' , 'filename' =>  $article->image ]) : "../assets/pages/media/works/img1.jpg"}}" alt = "عکس مقاله @if(isset($article->title[0])) {{$article->title}} @endif"/>
                            </div>
