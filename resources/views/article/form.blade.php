<div class="portlet">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-file-text"></i>@if(isset($article))اصلاح@elseایجاد@endif مقاله
        </div>
        <div class="actions btn-set">
            <button type="submit" class="btn btn-success">
                <i class="fa fa-check"></i> @if(isset($article))اصلاح@elseذخیره@endif </button>
            <a href = "{{action("Web\HomeController@adminContent")}}" type = "button" name = "back"
                ...
                <div class="form-body">
                    <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="progress" style="width: 100%; text-align: right; float: right;">
                                <div id="progressbar_title" class="progress-bar"
                    ...
                    <div class="form-group {{ $errors->has('brief') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="progress" style="width: 100%; text-align: right; float: right;">
                                <div id="progressbar_brief" class="progress-bar"
                                     style="text-align: right; float: right;"></div>
                            </div>
                            @if ($errors->has('brief'))
                                <span class="help-block">
                    ...
                    <div class="col-md-6 left">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;"><img
                                        src="{{isset($article) ? route('image', [ 'category'=>'8','w'=>'140' , 'h'=>'140' , 'filename' =>  $article->image ]) : "../assets/pages/media/works/img1.jpg"}}"
                                        alt="عکس مقاله @if(isset($article->title[0])) {{$article->title}} @endif"/>
                            </div>
                            ...
                            <div>
                                ...
                                <a href="javascript:" class="btn red fileinput-exists" id="articleImage-remove"
