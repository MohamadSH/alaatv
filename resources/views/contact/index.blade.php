                            ...
                            <tbody>
                                @foreach($contacts as $contact)
                                    <tr>
                                        ...
                                        <td>@if(isset($contact->relative->id)){{$contact->relative->displayName}} @else <span class="label label-sm label-info"> نا مشخص </span> @endif</td>
                                        <td>
                                            <div class="form-group">
                                                    <div class="col-md-4">
                                                        <a class="btn" href="{{action("ContactController@edit", $contact)}}"><i class="fa fa-pencil"></i> اصلاح </a>
                                                    </div>
                                                    <div class="col-md-1">
