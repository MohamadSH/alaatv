        ...
        <div class="col-md-6">
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn btn-sm dark dropdown-toggle" href="{{action("ContactController@index", ["user" => $contact->user])}}" > بازگشت
                                <i class="fa fa-angle-left"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="addPhone" class="modal fade" tabindex="-1" data-width="500" data-backdrop="static">
                            ...
                            <div class="modal-footer">
                                <div class="form-group">
                                    <div class="col-md-4">
                                        <button type="button" data-dismiss="modal" class="btn btn-outline dark" id="numberPhone-close">بستن</button>
                                        <button type="button" data-dismiss="modal"  class="btn green" id="numberPhone-submit">ذخیره</button>
