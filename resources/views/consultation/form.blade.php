            ...
            <div class="col-md-9">
                <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <div>
                        ...
                        <a href="javascript:;" class="btn red fileinput-exists" id="consultationThumbnail-remove" data-dismiss="fileinput"> حذف </a>
                    </div>
                </div>
                <div class="clearfix margin-top-10">
...
<div class="col-md-6">
    <div class="fileinput fileinput-new" id="thumbnail-div" data-provides="fileinput">
        ...
        <div class="clearfix margin-top-10">
            <span class="label label-danger">توجه</span><strong id="thumbnailAlert">فرمت های مجاز: jpg , png - حداکثر حجم مجاز: ۲۰۰KB</strong>
        </div>
    </div>
</div>
<div class="col-md-12">
