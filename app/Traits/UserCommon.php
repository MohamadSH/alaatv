...
trait UserCommon
{
    ...
    {
        return \App\Transaction::whereIn("order_id", $orders->pluck("id"))->whereDoesntHave("parents")->where("transactionstatus_id",
        ...
        $rules = [
            ...
            'mobile' => [
                ...
                \Illuminate\Validation\Rule::unique('users')->where(function ($query) use ($data) {
                    $query->where('nationalCode', array_get($data, "nationalCode"))->where('deleted_at', null);
                }),
            ],
            ...
            'nationalCode' => [
                ...
                \Illuminate\Validation\Rule::unique('users')->where(function ($query) use ($data) {
                    $query->where('mobile', array_get($data, "mobile"))->where('deleted_at', null);
                }),
            ],
