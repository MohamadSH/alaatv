...
use App\Traits\{APIRequestCommon, CharacterCommon, FileCommon, Helper, MetaCommon, ProductCommon, RequestCommon, SearchCommon};
use App\User;
...
class ContentController extends Controller
{
    ...
    */
    ...
    private function getContentInformation(Content $content): array
    {
        ...
        return Cache::tags('set')->remember($key, config("constants.CACHE_600"), function () use ($content) {
