...
class SanatisharifmergeController extends Controller
{
    ...
    {
        try {
            $sanatisharifRecords = Sanatisharifmerge::whereNull("videoid")->whereNull("pamphletid")->whereNotNull("departmentlessonid")->where("departmentlessonTransferred",
                0)->get();
            ...
            foreach ($sanatisharifRecords as $sanatisharifRecord) {
                ...
                $name = $this->determineContentSetName($sanatisharifRecord->departmentlessonid, $sanatisharifRecord->lessonname, $sanatisharifRecord->depname,
                ...
                $teacherNameArray = $this->determineTeacherName($sanatisharifRecord->teacherfirstname, $sanatisharifRecord->teacherlastname,
    ...
    private function getDepLessonTags($lId = null, $dId = null)
    {
        ...
        return Cache::rememberForever($key, function () use ($lId, $dId) {
            ...
            if (isset($lId) && isset($dId)) {
                ...
                $oldContent = Sanatisharifmerge::where('lessonid', '=', $lId)->where('depid', '=', $dId)->first();
                if (isset($oldContent)) {
                    $tag2 = $this->lessonMultiplexer($lId, $oldContent->lessonname);
                    $tag3 = $this->determineTeacherName($oldContent->teacherfirstname, $oldContent->teacherlastname, $oldContent->departmentlessonid, 1);
