                    ...
                    switch ($contentType) {
                        case "v" :
                            ...
                            if (((!isset($sanatisharifRecord->videolink) || strlen($sanatisharifRecord->videolink) == 0)
                                ...
                                } else if (isset($sanatisharifRecord->videolinktakhtesefid))
                            ...
                            if (isset($sanatisharifRecord->thumbnail) && strlen($sanatisharifRecord->thumbnail) > 0) {
                                ...
                                else if (isset($sanatisharifRecord->videolinkhq) && strlen($sanatisharifRecord->videolinkhq) > 0)
                                    $filePath = $sanatisharifRecord->videolinkhq;
                                else if (isset($sanatisharifRecord->videolink240p) && strlen($sanatisharifRecord->videolink240p) > 0)
