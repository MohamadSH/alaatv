...
class ConstantProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        try {
            ...
            $contentsets = Contentset::whereIn("id", $contentsetArary)
                                     ->get();
                    ...
                    case "konkoor" :
                        $lessons = collect([
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 195)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 195)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 195)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                                                                                                                                     ->sortBy("pivot.order")
                                               ...
                                               [
                                                   ...
                                                   "author"      => "هامون سبطی",
                                                   "pic"         => $contentsets->where("id", 170)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 170)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 170)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 37)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 37)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 37)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 179)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 179)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 179)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "پیمان طلوعی",
                                                   "pic"         => $contentsets->where("id", 187)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 187)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 187)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 183)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 183)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 183)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 189)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 189)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 189)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 186)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 186)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 186)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 188)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 188)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 188)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "محمد صادق ثابتی",
                                                   "pic"         => $contentsets->where("id", 180)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 180)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 180)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 191)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 191)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 191)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "رضا شامیزاده",
                                                   "pic"         => $contentsets->where("id", 114)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 114)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 114)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "رضا شامیزاده",
                                                   "pic"         => $contentsets->where("id", 112)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 112)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 112)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "وحید کبریایی",
                                                   "pic"         => $contentsets->where("id", 137)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 137)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 137)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 121)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 121)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 121)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "محسن آهویی",
                                                   "pic"         => $contentsets->where("id", 175)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 175)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 175)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   "displayName" => "زیست کنکور",
                                                   "author"      => "محمد پازوکی",
                                                   "pic"         => $contentsets->where("id", 50)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 50)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 50)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "مهدی امینی راد",
                                                   "pic"         => $contentsets->where("id", 152)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 152)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 152)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                    ...
                    case "yazdahom" :
                        $lessons = collect([
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 218)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 218)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 218)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "جلال موقاری",
                                                   "pic"         => $contentsets->where("id", 204)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 204)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 204)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "فرشید داداشی",
                                                   "pic"         => $contentsets->where("id", 181)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 181)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 181)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 194)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 194)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 194)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "پیمان طلوعی",
                                                   "pic"         => $contentsets->where("id", 193)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 193)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 193)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "محمد صادق ثابتی",
                                                   "pic"         => $contentsets->where("id", 171)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 171)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 171)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 178)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 178)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 178)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "مهدی صنیعی تهرانی",
                                                   "pic"         => $contentsets->where("id", 182)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 182)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 182)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "علی صدری",
                                                   "pic"         => $contentsets->where("id", 169)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 169)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 169)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "ناصر حشمتی",
                                                   "pic"         => $contentsets->where("id", 192)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 192)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 192)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                    ...
                    case "dahom" :
                        $lessons = collect([
                                               [
                                                   ...
                                                   "author"      => "جلال موقاری",
                                                   "pic"         => $contentsets->where("id", 203)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 203)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 203)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 215)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 215)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 215)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "مهدی ناصر شریعت",
                                                   "pic"         => $contentsets->where("id", 185)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 185)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 185)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "مهدی امینی راد",
                                                   "pic"         => $contentsets->where("id", 190)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 190)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 190)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 153)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 153)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 153)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 172)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 172)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 172)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "جلال موقاری",
                                                   "pic"         => $contentsets->where("id", 177)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 177)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 177)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "فرشید داداشی",
                                                   "pic"         => $contentsets->where("id", 173)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 173)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 173)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "علی اکبر عزتی",
                                                   "pic"         => $contentsets->where("id", 168)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 168)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 168)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "مهدی امینی راد",
                                                   "pic"         => $contentsets->where("id", 184)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 184)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 184)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   "displayName" => "عربی",
                                                   "author"      => "ناصر حشمتی",
                                                   "pic"         => $contentsets->where("id", 174)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 174)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 174)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                    ...
                    case "hamayesh" :
                        $lessons = collect([
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 163)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 163)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 163)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   "displayName" => "گسسته",
                                                   "author"      => "سروش معینی",
                                                   "pic"         => $contentsets->where("id", 157)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 157)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 157)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   "displayName" => "فیزیک",
                                                   "author"      => "نادریان",
                                                   "pic"         => $contentsets->where("id", 159)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 159)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 159)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "مسعود حدادی",
                                                   "pic"         => $contentsets->where("id", 160)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 160)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 160)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "سیروس نصیری",
                                                   "pic"         => $contentsets->where("id", 162)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 162)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 162)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "سیروس نصیری",
                                                   "pic"         => $contentsets->where("id", 164)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 164)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 164)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   "displayName" => "عربی",
                                                   "author"      => "عمار تاج بخش",
                                                   "pic"         => $contentsets->where("id", 155)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 155)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 155)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 158)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 158)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 158)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                    ...
                    case "jadid":
                        $lessons = collect([
                                               [
                                                   ...
                                                   "author"      => "کازرانیان",
                                                   "pic"         => $contentsets->where("id", 202)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 202)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 202)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 208)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 208)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 208)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "محمد صادق ثابتی",
                                                   "pic"         => $contentsets->where("id", 214)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 214)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 214)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "محمد صادق ثابتی",
                                                   "pic"         => $contentsets->where("id", 217)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 217)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 217)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "pic"         => $contentsets->where("id", 216)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 216)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 216)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   ...
                                                   "author"      => "محمد علی امینی راد",
                                                   "pic"         => $contentsets->where("id", 220)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 220)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 220)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
                                               ...
                                               [
                                                   "displayName" => "صفر تا صد ریاضی تجربی کنکور",
                                                   "author"      => "مهدی امینی راد",
                                                   "pic"         => $contentsets->where("id", 221)
                                                                                ->first()->photo,
                                                   "content_id"  => ($contentsets->where("id", 221)
                                                                                 ->first()->contents->where("enable", 1)
                                                                                                    ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                     ->timezone('Asia/Tehran'))
                                                                                                    ->isNotEmpty()) ? $contentsets->where("id", 221)
                                                                                                                                  ->first()->contents->where("contenttype_id", Config::get("constants.CONTENT_TYPE_VIDEO"))
                                                                                                                                                     ->where("enable", 1)
                                                                                                                                                     ->where('validSince', '<', Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())
                                                                                                                                                                                      ->timezone('Asia/Tehran'))
