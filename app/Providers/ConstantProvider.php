...
use App\{
    Contentset, Contenttype, Product, Productfiletype, Verificationmessagestatus, Wallettype
};
use Illuminate\{
    Database\QueryException, Support\Facades\Config, Support\Facades\View, Support\ServiceProvider
};
