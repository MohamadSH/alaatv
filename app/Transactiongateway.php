 ...
 *
 * @property int $id
 * @property string|null $name نام سیستمی درگاه
 * @property string|null $displayName نام قابل نمایش درگاه
 * @property string|null $description توضیح درباره درگاه
 * @property string|null $merchantNumber شماره مرچنت درگاه
 * @property string|null $certificatePrivateKeyFile فایل گواهی اس اس ال برای کلید خصوصی امضا دیجیتال
 * @property string|null $certificatePrivateKeyPassword رمز عبور برای کلید خصوصی امضا دیجیتال
 * @property string|null $merchantPassword رمز فروشنده
 * @property int $enable فعال بودن یا نبودن درگاه
 * @property int $order ترتیب - در صورت نیاز به استفاده
 * @property int|null $bank_id آیدی مشخص کننده بانک درگاه
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Transactiongateway whereCertificatePrivateKeyPassword($value)
