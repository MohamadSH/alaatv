 ...
 * Generated for Laravel 5.7.25 on 2019-02-05 17:56:16.
 *
...
namespace Zarinpal\Laravel\Facade {
    ...
    class Zarinpal
    {
         ...
         * @static
         */
        public static function request($callbackURL, $Amount, $Description, $Email = null, $Mobile = null, $additionalData = null)
        {
            return \Zarinpal\Zarinpal::request($callbackURL, $Amount, $Description, $Email, $Mobile, $additionalData);
        }
        ...
        {
            return \Zarinpal\Zarinpal::verify($amount, $authority);
        }
        ...
        {
            return \Zarinpal\Zarinpal::redirectUrl();
        }
        ...
        {
            return \Zarinpal\Zarinpal::enableSandbox();
        }
         ...
         * @static
         */
        public static function isZarinGate()
        {
            return \Zarinpal\Zarinpal::isZarinGate();
        }
