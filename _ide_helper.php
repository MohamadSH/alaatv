 ...
 * Generated for Laravel 5.6.39 on 2018-11-02 15:05:41.
 *
...
namespace Illuminate\Support\Facades {
     ...
     * @method static \Illuminate\Support\ServiceProvider register(\Illuminate\Support\ServiceProvider | string
     *         $provider, array $options = [], bool $force = false)
     ...
     *
     *
     * @method static int handle(\Symfony\Component\Console\Input\InputInterface $input,
     ...
     * @method static \Symfony\Component\HttpFoundation\Response|null onceBasic(string $field = 'email', array
     *         $extraConditions = [])
     ...
     * @method static mixed remember(string $key, \DateTimeInterface | \DateInterval | float | int $minutes, \Closure
     *         $callback)
     ...
     * @method static \Illuminate\Contracts\Auth\Access\Gate forUser(\Illuminate\Contracts\Auth\Authenticatable | mixed
     *         $user)
     ...
     * @method static string transChoice(string $key, int | array | \Countable $number, array $replace = [], string
     *         $locale = null)
     * @method static string getLocale()
     * @method static void setLocale(string $locale)
     * @method static string|array|null get(string $key, array $replace = [], string $locale = null, bool $fallback =
     *         true)
     ...
     * @method static void send(string | array | \Illuminate\Contracts\Mail\Mailable $view, array $data = [], \Closure
     *         | string $callback = null)
     * @method static array failures()
     * @method static mixed queue(string | array | \Illuminate\Contracts\Mail\Mailable $view, string $queue = null)
     * @method static mixed later(\DateTimeInterface | \DateInterval | int $delay, string | array |
     *         \Illuminate\Contracts\Mail\Mailable $view, string $queue = null)
     ...
     * @method static mixed later(\DateTimeInterface | \DateInterval | int $delay, string | object $job, $data = '',
     *         string $queue = null)
     * @method static mixed laterOn(string $queue, \DateTimeInterface | \DateInterval | int $delay, string | object
     *         $job, $data = '')
     ...
     * @method static \Illuminate\Http\RedirectResponse guest(string $path, int $status = 302, array $headers = [],
     *         bool $secure = null)
     * @method static intended(string $default = '/', int $status = 302, array $headers = [], bool $secure = null)
     * @method static \Illuminate\Http\RedirectResponse to(string $path, int $status = 302, array $headers = [], bool
     *         $secure = null)
     ...
     * @method static \Illuminate\Http\RedirectResponse route(string $route, array $parameters = [], int $status = 302,
     *         array $headers = [])
     * @method static \Illuminate\Http\RedirectResponse action(string $action, array $parameters = [], int $status =
     *         302, array $headers = [])
     ...
     *         = [])
     * @method static \Illuminate\Http\JsonResponse json(string | array $data = [], int $status = 200, array $headers =
     *         [], int $options = 0)
     * @method static \Illuminate\Http\JsonResponse jsonp(string $callback, string | array $data = [], int $status =
     *         200, array $headers = [], int $options = 0)
     * @method static \Symfony\Component\HttpFoundation\StreamedResponse stream(\Closure $callback, int $status = 200,
     *         array $headers = [])
     * @method static \Symfony\Component\HttpFoundation\StreamedResponse streamDownload(\Closure $callback, string |
     *         null $name = null, array $headers = [], string | null $disposition = 'attachment')
     * @method static \Symfony\Component\HttpFoundation\BinaryFileResponse download(\SplFileInfo | string $file, string
     *         | null $name = null, array $headers = [], string | null $disposition = 'attachment')
     * @method static \Illuminate\Http\RedirectResponse redirectTo(string $path, int $status = 302, array $headers =
     *         [], bool | null $secure = null)
     * @method static \Illuminate\Http\RedirectResponse redirectToRoute(string $route, array $parameters = [], int
     *         $status = 302, array $headers = [])
     * @method static \Illuminate\Http\RedirectResponse redirectToAction(string $action, array $parameters = [], int
     *         $status = 302, array $headers = [])
     * @method static \Illuminate\Http\RedirectResponse redirectGuest(string $path, int $status = 302, array $headers =
     *         [], bool | null $secure = null)
     * @method static \Illuminate\Http\RedirectResponse redirectToIntended(string $default = '/', int $status = 302,
     *         array $headers = [], bool | null $secure = null)
     ...
     * @method static \Illuminate\Routing\Route match(array | string $methods, string $uri, \Closure | array | string |
     *         null $action = null)
     * @method static \Illuminate\Routing\RouteRegistrar prefix(string $prefix)
     * @method static \Illuminate\Routing\RouteRegistrar where(array $where)
     * @method static \Illuminate\Routing\PendingResourceRegistration resource(string $name, string $controller, array
     *         $options = [])
     * @method static \Illuminate\Routing\PendingResourceRegistration apiResource(string $name, string $controller,
     *         array $options = [])
     ...
     * @method static \Illuminate\Routing\Router|\Illuminate\Routing\RouteRegistrar group(array | \Closure | string
     *         $attributes, \Closure | string $routes)
     ...
     * @method static string signedRoute(string $name, array $parameters = [], \DateTimeInterface | int $expiration =
     *         null)
     ...
     *
     *
     * @method static \Illuminate\Contracts\Validation\Validator make(array $data, array $rules, array $messages = [],
...
namespace Zarinpal\Laravel\Facade {
    ...
    class Zarinpal
    {
         ...
         * @param string $Mobile
         *
         * @return array|\Zarinpal\@redirect
         * @static
         */
        public static function request($callbackURL, $Amount, $Description, $Email = null, $Mobile = null)
        {
            return \Zarinpal\Zarinpal::request($callbackURL, $Amount, $Description, $Email, $Mobile);
        }
         ...
         * @static
         */
        public static function verify($status, $amount, $authority)
        {
            return \Zarinpal\Zarinpal::verify($status, $amount, $authority);
        }
        ...
        {
            return \Zarinpal\Zarinpal::redirect();
        }
        ...
        public static function getDriver()
        {
            return \Zarinpal\Zarinpal::getDriver();
        }

        /**
         * Added by mohamad.shahrokhi@gmail.com
         * Get unverified transactions
         *
         * @return array
         * @static
         */
        public static function unverifiedTransactions()
        {
            return \Zarinpal\Zarinpal::unverifiedTransactions();
        }

        /**
         * verify that the bill is paid or not with extra info
         * by checking authority, amount and status.
         *
         * @param $status
         * @param $amount
         ...
         * @static
         */
        public static function verifyWithExtra($amount, $authority)
        {
            return \Zarinpal\Zarinpal::verifyWithExtra($amount, $authority);
        }
...
namespace {
    ...
    class Zarinpal extends \Zarinpal\Laravel\Facade\Zarinpal
    {
    }
