 ...
 * Generated for Laravel 5.8.35 on 2019-09-22 06:41:16.
 *
...
namespace Zarinpal\Laravel\Facade { 
    ...
    class Zarinpal {
        ...
        {
                        /** @var \Zarinpal\Zarinpal $instance */
                        return $instance->request($callbackURL, $Amount, $Description, $Email, $Mobile, $additionalData);
        }
        ...
        {
                        /** @var \Zarinpal\Zarinpal $instance */
                        return $instance->verify($amount, $authority);
        }
